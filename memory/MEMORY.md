...
> Ultima actualizacion: 2026-05-17 (sesion 42 — integración BOE API Datos Abiertos)
> Sesion 42 (2026-05-17): BoeApiClient + CitationEnricher + tabla boe_cache UPSERT 30d. Verifier extiende vigencia env-gated. Refactor multi-source: LegalSource Protocol + plugins BoeApiSource/BopvApiSource/StaticUrlSource + Dispatcher. norms.yaml extendido con source_id/source_norm_id (defaults: boe). 5 normas añadidas: Concierto Económico Euskadi (Ley 12/2002 BOE), Convenio Navarra (Ley 28/1990 BOE), NF IRPF Bizkaia 13/2013 (static_url), NF IS Bizkaia 11/2013 (static_url), DLeg 1/2009 Canarias (static_url). Tests: 172 PASS (+47 sesion 42: 16 boe_client + 16 enricher + 15 sources). API BOPV verificada con curl real (api.euskadi.eus/bopv/administrative-acts).
> Ultima actualizacion previa: 2026-05-17 (sesion 41 cerrada — caso TributAI + refactor data-driven legal registry)
> Sesion 41 FINAL (2026-05-13 a 05-17): caso TributAI vs Impuestify factura EEUU. 4 bugs: 99 (citation verifier falso positivo Ley 37/1992 LIVA), 100 (purge cache borra RAG 84K vectors — re-ingest 488 docs 12h), 101 (RAG filter CCAA excluye Estatal/AEAT, IVA es estatal no cedido), 102 (anti-patron hardcode normativo refactorizado a data-driven). Frontend UX nuevo: DirectAnswerCard verde, ProTipCard dorada, CopyableQuote, banner amber legible, sources block. Verificado contra BOE: Impuestify SUPERA a TributAI en rigor (Arts. 69-70 LIVA vs Art. 21 erroneo de competencia). Arquitectura legal nueva: `backend/data/legal/*.yaml` + `backend/app/services/legal/` (Repository+Protocol+Pydantic, mantenible sin Python). 13 commits hoy. 3126 tests PASS (123 nuevos sesion 41). Backlog tech debt: migrar a Turso SQL >200 leyes, Admin UI YAML, sync BOE, versioning anual, replicar patron CCAA/modelos.
> Sesion 41 inicio (2026-05-13): superar TributAI — citation verifier whitelist + system prompt B2B/B2C + texto factura + Pro tip + proactive profile hint.
