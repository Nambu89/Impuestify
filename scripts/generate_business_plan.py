...
def build_document():
    ...
    add_styled_table(doc,
        ...
        [
            ...
            ['Calculadoras especializadas', '13+ (IRPF, IVA, RETA, ISD, IPSI, deducciones, Mod.303, Mod.130, casillas, perfil fiscal, SUELDO NETO)'],
            ...
            ['Plan Creator', '49 EUR/mes (YouTubers, streamers, influencers)'],
    ...
    add_styled_table(doc,
        ...
        [
            ...
            ['600+ deducciones', '21 territorios cubiertos, XSD Modelo 100 AEAT', 'Amplitud'],
