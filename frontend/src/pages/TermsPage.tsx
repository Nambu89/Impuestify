        ...
        <div className="legal-page">
            <div className="legal-container">
                ...
                <p className="last-updated">
                    Última actualización: 23 de abril de 2026 | Versión 1.1
                </p>
                ...
                <section>
                    ...
                    <p>
                        Al acceder y utilizar Impuestify (&quot;el Servicio&quot;), usted acepta
                        estar sujeto a estos Términos y Condiciones (&quot;Términos&quot;).
                    </p>
                    <p>
                        <strong>Si no está de acuerdo</strong>: No utilice el Servicio.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Impuestify es un <strong>asistente fiscal conversacional</strong> basado en
                        inteligencia artificial que proporciona:
                    </p>
                    <ul>
                    ...
                    <div className="alert alert-warning">
                        ...
                        <ul>
                            <li>
                                <strong>NO es un asesor fiscal profesional</strong>
                            </li>
                ...
                <section>
                    ...
                    <div className="alert alert-info">
                        ...
                        <p>
                            Las respuestas de Impuestify son <strong>ORIENTATIVAS</strong>. El
                            contenido NO constituye asesoramiento fiscal, legal o financiero
                            profesional. SIEMPRE consulte con un asesor fiscal cualificado antes de
                            actuar.
                        </p>
                    </div>
                    ...
                    <p>
                        Usted es el único responsable de las decisiones tomadas basándose en
                    ...
                    <p>
                        <strong>Mitigaciones aplicadas</strong>: RAG, citación de fuentes,
                        moderación de contenido. Ver{' '}
                        <Link to="/ai-transparency">Transparencia IA</Link>.
                    </p>

                    <h3>3.3 Precisión de la Información</h3>
                    <p>
                        <strong>NO GARANTIZAMOS</strong>: Exactitud completa de cálculos,
                        actualización en tiempo real de normativa, ni aplicabilidad a su caso
                        particular.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Usted es responsable de mantener la confidencialidad de su contraseña, todas
                        las actividades bajo su cuenta, y notificar inmediatamente cualquier uso no
                        autorizado.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        <strong>Violación</strong>: Podemos suspender o terminar su cuenta.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        Impuestify o sus licenciantes. Se otorga licencia de uso personal no
                        comercial.
                    </p>
                    ...
                    <p>
                        ...
                        Nos otorga licencia limitada para procesar sus datos con el fin de prestar
                        el Servicio.
                    </p>
                    <p>
                        Ver: <Link to="/privacy-policy">Política de Privacidad</Link>
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Consulte nuestra <Link to="/privacy-policy">Política de Privacidad</Link>{' '}
                        completa.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        pérdidas económicas, errores u omisiones de la IA, pérdida de datos, ni
                        daños indirectos o consecuenciales.
                    </p>
                    <p>
                        <strong>Responsabilidad máxima</strong>: Importe pagado por el Servicio en
                        los últimos 12 meses.
                    </p>

                    <h3>8.3 Jurisdicción</h3>
                    <p>
                        Nada en estos Términos limita derechos del consumidor bajo ley aplicable
                        (UE/España).
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        Servicio, cambiar precios y actualizar funcionalidades.
                    </p>
                    <p>
                        <strong>Notificación</strong>: Cambios sustanciales se notificarán con 30
                        días de antelación.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        de rechazar y cerrar cuenta. Cambios menores se publican en web. El uso
                        continuado tras cambios implica aceptación de nuevos Términos.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Puede cancelar su cuenta en cualquier momento desde Configuración o enviando
                        email a <a href="mailto:support@impuestify.com">support@impuestify.com</a>.
                    </p>

                    <h3>11.2 Por Nuestra Parte</h3>
                    <p>
                        Podemos suspender o terminar su cuenta si viola estos Términos, usa el
                        Servicio para actividades ilegales o abusa del sistema.
                    </p>

                    <h3>11.3 Efectos de la Terminación</h3>
                    <p>
                        Tras terminación: su cuenta se cierra y los datos se eliminan según la{' '}
                        <Link to="/data-retention">Política de Retención de Datos</Link>.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        tendrán jurisdicción exclusiva. Antes de acudir a tribunales, contacte{' '}
                        <a href="mailto:support@impuestify.com">support@impuestify.com</a> para
                ...
                <section>
                    ...
                    <ul>
                        <li>
                            <strong>Independencia de Cláusulas</strong>: Si alguna disposición es
                            inválida, las demás permanecen en vigor.
                        </li>
                        <li>
                            <strong>Renuncia</strong>: Fallo en ejercer derecho no constituye
                            renuncia.
                        </li>
                        <li>
                            <strong>Cesión</strong>: No puede ceder estos Términos sin nuestro
                            consentimiento.
                        </li>
                        <li>
                            <strong>Acuerdo Completo</strong>: Estos Términos junto con la Política
                            de Privacidad constituyen el acuerdo completo.
                        </li>
                    </ul>
                </section>
                ...
                <section>
                    <h2>14. Contacto</h2>
                    <p>
                        <strong>Preguntas sobre Terminos</strong>:{' '}
                ...
                <section>
                    <h2>15. Idioma</h2>
                    <p>
                        Estos Términos se proporcionan en español. En caso de conflicto con
                        traducciones, prevalece la versión en español.
                    </p>
                </section>
                ...
                <div className="legal-cta">
                    <p>
                        ...
                        la <Link to="/privacy-policy">Política de Privacidad</Link> y la información
                        sobre <Link to="/ai-transparency">Transparencia IA</Link>.
                    </p>
                </div>
            </div>
        </div>
