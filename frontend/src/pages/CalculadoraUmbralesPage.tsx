...
export default function CalculadoraUmbralesPage() {
    useSEO({
        ...
        description:
            'Comprueba si a tu empresa le aplica el PGC normal o el abreviado según activo, cifra de negocios y plantilla en los dos últimos ejercicios.',
        canonical: '/calculadora-umbrales',
        keywords:
            'umbrales contables, PGC normal abreviado, plan general contabilidad, balance abreviado, PYMES contabilidad',
        schema: {
    ...
    const renderBars = (title: string, thresholds: Record<string, ThresholdDetail> | undefined) => {
                    ...
                    return (
                        <div key={key} className="calc-umb-bar-item">
                            <div className="calc-umb-bar-label">
                                ...
                                <strong>
                                    {isEmployees ? fmt(detail.valor) : fmtEur(detail.valor)} /{' '}
                                    {isEmployees ? fmt(detail.limite) : fmtEur(detail.limite)}
                                </strong>
                            </div>
            ...
            <div className="calc-umb-container">
                ...
                <div className="calc-umb-header">
                    ...
                    <div>
                        ...
                        <p>
                            Qué PGC te aplica, si puedes llevar balance abreviado y si estás
                            obligado a auditar.
                        </p>
                    </div>
                </div>
                        ...
                        {result ? (
                            <>
                                <div className="calc-umb-badge-wrap">
                                    ...
                                    <span className="calc-umb-badge-label">
                                        {result.pgc_aplicable}
                                    </span>
                                </div>
                                ...
                                <div className="calc-umb-summary">
                                    ...
                                    <div className="calc-umb-summary-item">
                                        ...
                                        <strong
                                            className={
                                                result.auditoria_obligatoria ? 'audit-si' : 'si'
                                            }
                                        >
                                ...
                                {renderBars(
                                    ...
                                    result.umbrales_clasificacion,
                                )}
                                {renderBars(
                                    'Umbrales de auditoría (Art. 263 LSC)',
                                    result.umbrales_auditoria,
                                )}
                                ...
                                <div className="calc-umb-cta">
                                    ...
                                    <a href="/contact" className="calc-umb-cta-btn">
                            ...
                            <div className="calc-umb-placeholder">
                                <Building2 size={48} />
                                <p>
                                    Rellena los datos de los dos últimos ejercicios y pulsa
                                    "Clasificar empresa".
                                </p>
                            </div>
                        )}
