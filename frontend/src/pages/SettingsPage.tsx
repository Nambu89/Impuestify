...
export default function SettingsPage() {
    ...
    useEffect(() => {
        if (!fiscal.loading && fiscal.profile) {
            ...
            if (
                (fiscal.profile.intereses ?? 0) > 0 ||
                (fiscal.profile.dividendos ?? 0) > 0 ||
                (fiscal.profile.ganancias_fondos ?? 0) > 0
            ) {
                setShowAhorro(true)
            }
            ...
            if (
                (fiscal.profile.aportaciones_plan_pensiones ?? 0) > 0 ||
            ...
            if (
                fiscal.profile.epigrafe_iae ||
                fiscal.profile.regimen_iva ||
                fiscal.profile.metodo_estimacion_irpf
            ) {
    ...
    useEffect(() => {
        ...
        if (requestedRole) {
            ...
            setMessage({
                type: 'success',
                text: `Plan actualizado. Ahora puedes seleccionar el perfil de ${requestedRole}.`,
            })
        }
    }, [])
    ...
    const handleToggleEmailAlerts = async () => {
        ...
        try {
            const data = await apiRequest<{ enabled: boolean }>(
                '/api/deadlines/email-alerts/toggle',
                { method: 'POST' },
            )
    ...
    const isFromConversation = (key: string) => fiscal.fieldMeta[key]?.source === 'conversation'
    ...
    const handleMfaVerify = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                setMessage({
                    type: 'success',
                    text: 'Autenticación en dos pasos activada correctamente',
                })
            }
        } catch (err: any) {
    ...
    const ConversationBadge = ({ field }: { field: string }) =>
        isFromConversation(field) ? (
            <span
                ...
                title="Detectado automáticamente en una conversación"
            >
                ...
                <div className="settings-container">
                        ...
                        <>
                            ...
                            <section className="settings-section">
                                ...
                                <p className="section-description">
                                    Protege tu cuenta con un segundo factor de autenticación. Cada
                                    vez que inicies sesión necesitarás introducir un código temporal
                                    generado por tu aplicación de autenticación (Google
                                    ...
                                    <div className="mfa-status-block">
                                        ...
                                        >
                                            {mfa.loading ? (
                                                ...
                                                <>
                                                    <KeyRound size={16} /> Activar autenticación en
                                                    dos pasos
                                                </>
                                            )}
                                        </button>
                                    ...
                                    <div className="mfa-setup">
                                        ...
                                        <div className="mfa-secret-block">
                                            <span className="mfa-secret-label">
                                                ¿No puedes escanear el QR? Introduce este código
                                                manualmente:
                                            </span>
                                        ...
                                        >
                                            <input
                                                ...
                                                value={mfaCode}
                                                onChange={(e) =>
                                                    handleMfaCodeChange(e.target.value)
                                                }
                                            ...
                                            <div className="mfa-form-actions">
                                                ...
                                                >
                                                    {mfa.loading ? (
                                                        ...
                                                        <>
                                                            <CheckCircle size={16} /> Verificar y
                                                            activar
                                                        </>
                                                    )}
                                                </button>
                                ...
                                {mfaStep === 'backup_codes' && (
                                    <div className="mfa-backup">
                                        ...
                                        <p className="mfa-backup-desc">
                                            ...
                                            Podrás usarlos para acceder a tu cuenta si pierdes
                                        ...
                                        <div className="mfa-backup-grid">
                                            {mfaBackupCodes.map((code, i) => (
                                                <code key={i} className="mfa-backup-code">
                                                    {code}
                                                </code>
                                            ))}
                                        </div>
                                ...
                                {mfaStep === 'disable' && (
                                    <div className="mfa-setup">
                                        <p className="mfa-status-desc">
                                            Para desactivar el 2FA, introduce el código actual de tu
                    ...
                    {activeTab === 'fiscal' && (
                        <section className="settings-section">
                            ...
                            <p className="section-description">
                                Estos datos son <strong>voluntarios</strong> y permiten calcular tu
                                IRPF de forma precisa. Si mencionas datos fiscales en una
                                conversación, se rellenarán automáticamente aquí.
                            </p>

                            {fiscal.loading ? (
                                <div className="fiscal-loading">
                                    <Loader size={24} className="animate-spin" /> Cargando perfil
                                    fiscal...
                                </div>
                            ) : (
                                <form
                                    onSubmit={handleSaveFiscalProfile}
                                ...
                                >
                                    ...
                                    <div className="form-row">
                                        <div className="form-group">
                                            <label>
                                                Comunidad Autónoma{' '}
                                                <ConversationBadge field="ccaa_residencia" />
                                            </label>
                                            <select
                                                className="form-input"
                                                value={fiscalForm.ccaa_residencia || ''}
                                                onChange={(e) =>
                                                    updateFiscal(
                                                        'ccaa_residencia',
                                                        e.target.value || null,
                                    ...
                                    <div className="form-row">
                                        <div className="form-group">
                                            ...
                                            <select
                                                className="form-input"
                                                value={fiscalForm.situacion_laboral || ''}
                                                onChange={(e) =>
                                                    updateFiscal(
                                                        'situacion_laboral',
                                                        e.target.value || null,
                                    ...
                                    <div className="form-group fiscal-roles-group">
                                        <label className="fiscal-roles-label">
                                            Roles adicionales (selecciona todos los que apliquen)
                                        </label>
                                        <div className="fiscal-roles-grid">
                                            {[
                                                {
                                                    value: 'creador_contenido',
                                                    label: 'Creador de contenido / Influencer',
                                                },
                                                {
                                                    value: 'inversor',
                                                    label: 'Inversor (acciones, fondos, cripto)',
                                                },
                                                {
                                                    value: 'propietario_alquiler',
                                                    label: 'Propietario de inmuebles en alquiler',
                                                },
                                                {
                                                    value: 'pluriactividad',
                                                    label: 'Pluriactividad (asalariado + autónomo)',
                                                },
                                            ].map(({ value, label }) => {
                                                ...
                                                return (
                                                    <label
                                                        key={value}
                                                        className="fiscal-role-checkbox"
                                                    >
                                                        <input
                                                            type="checkbox"
                                                            checked={checked}
                                        ...
                                        <div className="form-group">
                                            <label className="checkbox-label">
                                                <input
                                                    type="checkbox"
                                                    checked={
                                                        fiscalForm.tributacion_conjunta || false
                                                    }
                                                    onChange={(e) =>
                                                        updateFiscal(
                                            ...
                                            <span className="form-hint">
                                                Permite declarar con tu unidad familiar
                                            </span>
                                        </div>
                                        {fiscalForm.tributacion_conjunta && (
                                            <div className="form-group">
                                                ...
                                                <select
                                                    className="form-input"
                                                    value={
                                                        fiscalForm.tipo_unidad_familiar ||
                                                        'matrimonio'
                                                    }
                                                    onChange={(e) =>
                                                        updateFiscal(
                                                ...
                                                >
                                                    <option value="matrimonio">
                                                        Matrimonio (reducción 3.400 EUR)
                                                    </option>
                                    ...
                                    <div className="form-row">
                                        <div className="form-group">
                                            <label>
                                                ...
                                                <ConversationBadge field="ingresos_trabajo" />
                                            </label>
                                    ...
                                    >
                                        Si tienes varios pagadores (empleadores), puedes detallarlos
                                        aquí para un cálculo más preciso.
                                    </p>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (
                                                    n > 1 &&
                                                    (!fiscalForm.pagadores ||
                                                        fiscalForm.pagadores.length === 0)
                                                ) {
                                                    updateFiscal(
                                                        'pagadores',
                                                        Array.from({ length: n }, () => ({
                                        ...
                                        <span className="form-hint">
                                            Con 2+ pagadores el límite de obligación de declarar
                                            baja a 15.876 EUR
                                        </span>
                                    </div>
                                    ...
                                    {(fiscalForm.num_pagadores || 1) > 1 && (
                                        <MultiPagadorForm
                                            ...
                                            onChange={(pagadores) =>
                                                updateFiscal('pagadores', pagadores)
                                            }
                                        />
                                    )}

                                    {/* --- Situación familiar (MPYF) --- */}
                                    <h3 className="fiscal-section-title">
                                        Situación familiar (MPYF)
                                    </h3>
                                    ...
                                    <div className="form-group">
                                        ...
                                        {childYears.map((year, i) => (
                                            <div key={i} className="child-year-row">
                                                ...
                                                <input
                                                    type="number"
                                                    className="form-input child-year-input"
                                                    placeholder="Año nacimiento"
                                                    min="1900"
                                                    max={new Date().getFullYear()}
                                                    value={year}
                                                    onChange={(e) =>
                                                        updateChildYear(i, e.target.value)
                                                    }
                                                />
                                                <button
                                                    type="button"
                                                    className="btn-icon-remove"
                                                    onClick={() => removeChildYear(i)}
                                                >
                                                    <Trash2 size={14} />
                                                </button>
                                            </div>
                                        ...
                                        <div className="form-group">
                                            <label className="checkbox-label">
                                                <input
                                                    type="checkbox"
                                                    checked={
                                                        fiscalForm.custodia_compartida || false
                                                    }
                                                    onChange={(e) =>
                                                        updateFiscal(
                                                            'custodia_compartida',
                                    ...
                                    <button
                                        ...
                                        onClick={() => setShowAhorro(!showAhorro)}
                                    >
                                        {showAhorro ? (
                                            <ChevronDown size={18} />
                                        ) : (
                                    ...
                                    <button
                                        type="button"
                                        className="collapsible-header"
                                        onClick={() => setShowInmuebles(!showInmuebles)}
                                    >
                                        {showInmuebles ? (
                                            <ChevronDown size={18} />
                                        ) : (
                                    ...
                                    {showInmuebles && (
                                        <div className="collapsible-content">
                                            <h4 className="fiscal-subsection-title">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-with-suffix">
                                                        <input
                                                            ...
                                                            placeholder="0"
                                                            value={
                                                                fiscalForm.valor_adquisicion_inmueble ??
                                                                ''
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                            ...
                                            <h4 className="fiscal-subsection-title">
                                                Como inquilino (vivienda habitual)
                                            </h4>
                                            <div className="form-row">
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-with-suffix">
                                                        <input
                                                            ...
                                                            placeholder="0"
                                                            value={
                                                                fiscalForm.alquiler_pagado_anual ??
                                                                ''
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                    ...
                                                    <span className="form-hint">
                                                        Necesario para deducciones autonómicas por
                                                        alquiler
                                                    </span>
                                                </div>
                                                <div className="form-group">
                                                    <label className="checkbox-label">
                                                        <input
                                                            type="checkbox"
                                                            checked={
                                                                fiscalForm.alquiler_habitual_pre2015 ||
                                                                false
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                    ...
                                                    <span className="form-hint">
                                                        Régimen transitorio estatal: deducción
                                                        10,05% (máx. 9.040 EUR)
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="form-row">
                                                <div className="form-group">
                                                    <label>
                                                        Valor catastral segundas viviendas
                                                    </label>
                                                    <div className="input-with-suffix">
                                                        <input
                                                            type="number"
                                                            ...
                                                            placeholder="0"
                                                            value={
                                                                fiscalForm.valor_catastral_segundas_viviendas ??
                                                                ''
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                    ...
                                                    <span className="form-hint">
                                                        Viviendas no alquiladas ni habitual. Imputa
                                                        renta del 1,1%-2%
                                                    </span>
                                                </div>
                                                <div className="form-group">
                                                    <label className="checkbox-label">
                                                        <input
                                                            type="checkbox"
                                                            checked={
                                                                fiscalForm.valor_catastral_revisado_post1994 ??
                                                                true
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                    ...
                                                    <span className="form-hint">
                                                        Si no fue revisado se aplica el 2% en lugar
                                                        del 1,1%
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="collapsible-content">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-with-suffix">
                                                        <input
                                                            ...
                                                            min="0"
                                                            value={
                                                                fiscalForm.aportaciones_plan_pensiones ??
                                                                ''
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                    ...
                                                    <span className="form-hint">
                                                        Max. 1.500 EUR/año (reduce base imponible
                                                        general)
                                                    </span>
                                                </div>
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-with-suffix">
                                                        <input
                                                            ...
                                                            min="0"
                                                            value={
                                                                fiscalForm.aportaciones_plan_pensiones_empresa ??
                                                                ''
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                    ...
                                                    <span className="form-hint">
                                                        Límite conjunto con propias: 8.500 EUR
                                                    </span>
                                                </div>
                                            </div>

                                            <h4 className="fiscal-subsection-title">
                                                Vivienda habitual (hipoteca anterior a 2013)
                                            </h4>
                                            <div className="form-row">
                                                <div className="form-group">
                                                    <label className="checkbox-label">
                                                        <input
                                                            type="checkbox"
                                                            checked={
                                                                fiscalForm.hipoteca_pre2013 || false
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                                    'hipoteca_pre2013',
                                                    ...
                                                    <span className="form-hint">
                                                        Deducción 15% sobre máx. 9.040 EUR/año
                                                    </span>
                                                </div>
                                            </div>
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <div className="input-with-suffix">
                                                            <input
                                                                ...
                                                                min="0"
                                                                value={
                                                                    fiscalForm.capital_amortizado_hipoteca ??
                                                                    ''
                                                                }
                                                                onChange={(e) =>
                                                                    updateFiscal(
                                            ...
                                            <div className="form-row">
                                                <div className="form-group">
                                                    ...
                                                    <span className="form-hint">
                                                        Deducción por maternidad: 1.200 EUR/hijo
                                                        menor de 3 años
                                                    </span>
                                                </div>
                                                {fiscalForm.madre_trabajadora_ss && (
                                                    <div className="form-group">
                                                        ...
                                                        <div className="input-with-suffix">
                                                            <input
                                                                ...
                                                                min="0"
                                                                value={
                                                                    fiscalForm.gastos_guarderia_anual ??
                                                                    ''
                                                                }
                                                                onChange={(e) =>
                                                                    updateFiscal(
                                                        ...
                                                        <span className="form-hint">
                                                            Hasta 1.000 EUR adicionales por hijo en
                                                ...
                                                <div className="form-group">
                                                    <label className="checkbox-label">
                                                        <input
                                                            type="checkbox"
                                                            checked={
                                                                fiscalForm.familia_numerosa || false
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                                    'familia_numerosa',
                                                ...
                                                {fiscalForm.familia_numerosa && (
                                                    <div className="form-group">
                                                        ...
                                                        <select
                                                            className="form-input"
                                                            value={
                                                                fiscalForm.tipo_familia_numerosa ||
                                                                'general'
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                        ...
                                                        >
                                                            <option value="general">
                                                                General (3-4 hijos) — 1.200 EUR
                                                            </option>
                                                            <option value="especial">
                                                                Especial (5+ hijos) — 2.400 EUR
                                                            </option>
                                                        </select>
                                                    </div>
                                                )}
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-with-suffix">
                                                        <input
                                                            ...
                                                            min="0"
                                                            value={
                                                                fiscalForm.donativos_ley_49_2002 ??
                                                                ''
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                    ...
                                                    <span className="form-hint">
                                                        ONGs, fundaciones... 80% primeros 250 EUR,
                                                        40% resto
                                                    </span>
                                                </div>
                                                    ...
                                                    <div className="form-group">
                                                        <label className="checkbox-label">
                                                            <input
                                                                type="checkbox"
                                                                checked={
                                                                    fiscalForm.donativo_recurrente ||
                                                                    false
                                                                }
                                                                onChange={(e) =>
                                                                    updateFiscal(
                                                            ...
                                                            />
                                                            Donante recurrente (3+ años a la misma
                                                            entidad)
                                                        </label>
                                                        <span className="form-hint">
                                                            Sube al 45% el exceso sobre 250 EUR
                                                        </span>
                                                    </div>
                                                )}
                                            </div>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-with-suffix">
                                                        <input
                                                            ...
                                                            min="0"
                                                            value={
                                                                fiscalForm.retenciones_trabajo ?? ''
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                                                    'retenciones_trabajo',
                                                    ...
                                                    <span className="form-hint">
                                                        Total retenido en nómina por tu empresa
                                                    </span>
                                                </div>
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-with-suffix">
                                                        <input
                                                            ...
                                                            min="0"
                                                            value={
                                                                fiscalForm.retenciones_alquiler ??
                                                                ''
                                                            }
                                                            onChange={(e) =>
                                                                updateFiscal(
                                            ...
                                            <div className="form-row">
                                                <div className="form-group">
                                                    <label>
                                                        Retenciones sobre capital mobiliario
                                                    </label>
                                                    <div className="input-with-suffix">
                                                        <input
                                                            type="number"
                                                    ...
                                                    <span className="form-hint">
                                                        19% retenido por bancos sobre intereses y
                                                        dividendos
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    {(subscription.planType === 'autonomo' ||
                                        subscription.isOwner) && (
                                        <>
                                            <button
                                                type="button"
                                                className="collapsible-header"
                                                onClick={() => setShowAutonomo(!showAutonomo)}
                                            >
                                                {showAutonomo ? (
                                                    <ChevronDown size={18} />
                                                ) : (
                                            ...
                                            {showAutonomo && (
                                                <div className="collapsible-content">
                                                    ...
                                                    >
                                                        Estos datos permiten personalizar el cálculo
                                                        del Modelo 303, 130 y cuota de autónomos.
                                                    </p>
                                                    ...
                                                    <div className="form-row">
                                                        <div className="form-group">
                                                            ...
                                                            <input
                                                                type="text"
                                                                className="form-input"
                                                                placeholder="Ej: 861, 749.1"
                                                                value={
                                                                    fiscalForm.epigrafe_iae || ''
                                                                }
                                                                onChange={(e) =>
                                                                    updateFiscal(
                                                                        'epigrafe_iae',
                                                    ...
                                                    <div className="form-row">
                                                        <div className="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                className="form-input"
                                                                value={
                                                                    fiscalForm.fecha_alta_autonomo ||
                                                                    ''
                                                                }
                                                                onChange={(e) =>
                                                                    updateFiscal(
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <select
                                                                className="form-input"
                                                                value={
                                                                    fiscalForm.metodo_estimacion_irpf ||
                                                                    ''
                                                                }
                                                                onChange={(e) =>
                                                                    updateFiscal(
                                                    ...
                                                    <div className="form-row">
                                                        <div className="form-group">
                                                            ...
                                                            >
                                                                ...
                                                                <option value="recargo_equivalencia">
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <select
                                                                className="form-input"
                                                                value={
                                                                    fiscalForm.tipo_retencion_facturas ??
                                                                    ''
                                                                }
                                                                onChange={(e) =>
                                                                    updateFiscal(
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <div className="input-with-suffix">
                                                                <input
                                                                    ...
                                                                    placeholder="0"
                                                                    value={
                                                                        fiscalForm.rendimientos_netos_mensuales ??
                                                                        ''
                                                                    }
                                                                    onChange={(e) =>
                                                                        updateFiscal(
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <div className="input-with-suffix">
                                                                <input
                                                                    ...
                                                                    placeholder="0"
                                                                    value={
                                                                        fiscalForm.base_cotizacion_reta ??
                                                                        ''
                                                                    }
                                                                    onChange={(e) =>
                                                                        updateFiscal(
                                                        ...
                                                        {fiscalForm.territorio_foral && (
                                                            <div className="form-group">
                                                                ...
                                                                <select
                                                                    className="form-input"
                                                                    value={
                                                                        fiscalForm.territorio_historico ||
                                                                        ''
                                                                    }
                                                                    onChange={(e) =>
                                                                        updateFiscal(
                                                    ...
                                                    <div className="form-row">
                                                        <div className="form-group">
                                                            ...
                                                            <small className="field-hint">
                                                                Deducción del 60% en IRPF +
                                                                bonificación 50% cuota SS + IPSI en
                                                                lugar de IVA
                                                            </small>
                                                        </div>
                                                    </div>
                        ...
                        <section className="settings-section">
                            ...
                            {subscription.loading ? (
                                ...
                                <div className="subscription-status">
                                    ...
                                    <p className="section-description">
                                        No tienes una suscripción activa. Suscríbete para acceder a
                                        todas las funcionalidades de Impuestify.
                                    </p>
                                    <button
                        ...
                        <>
                            <section className="settings-section">
                                ...
                                <p className="section-description">
                                    ...
                                    (RGPD), tienes derecho a acceder, rectificar y eliminar tus
                                    datos personales.
                                </p>
                                ...
                                <div className="gdpr-action">
                                    <div className="gdpr-action-info">
                                        ...
                                        <p>
                                            Descarga una copia de todos tus datos personales en
                                            formato JSON (Art. 15 RGPD - Derecho de Acceso)
                                        </p>
                                    </div>
                                    <button
                            ...
                            <section className="settings-section danger-zone">
                                ...
                                <p className="section-description danger-text">
                                    Las acciones en esta sección son <strong>irreversibles</strong>.
                                ...
                                <div className="gdpr-action">
                                    <div className="gdpr-action-info">
                                        ...
                                        <p>
                                            ...
                                            asociados (Art. 17 RGPD - Derecho de Supresión)
                                        </p>
                    ...
                    {activeTab === 'notifications' && (
                        <>
                            <section className="settings-section">
                                ...
                                <p className="section-description">
                                    Recibe alertas en tu dispositivo cuando se acerquen plazos
                                    fiscales importantes. Compatible con Chrome, Firefox, Edge y
                                    Safari 16.4+.
                                </p>
                                ...
                                {!push.isSupported ? (
                                    ...
                                    <>
                                        ...
                                        <div className="notification-status-row">
                                            <span className="notification-status-label">
                                                Estado:
                                            </span>
                                            {push.permission === 'denied' ? (
                                                <span className="notification-status notification-status--blocked">
                                                    <BellOff size={14} /> Bloqueadas por el
                                                    navegador
                                                </span>
                                            ) : push.isSubscribed ? (
                                        ...
                                        {push.permission === 'denied' && (
                                            <div className="notification-hint">
                                                <AlertCircle size={16} />
                                                <span>
                                                    Las notificaciones estan bloqueadas en este
                                                    navegador. Ve a los ajustes del navegador y
                                        ...
                                        <div className="gdpr-action">
                                            <div className="gdpr-action-info">
                                                ...
                                                <p>
                                                    Recibe una notificacion antes de que venza cada
                                                    plazo fiscal relevante para tu perfil.
                                                </p>
                                            </div>
                                            {push.isSubscribed ? (
                                                <button
                                                ...
                                                <button
                                                    ...
                                                    disabled={
                                                        push.loading || push.permission === 'denied'
                                                    }
                                                >
                                                    {push.loading ? (
                                                        <>
                                        ...
                                        {push.isSubscribed && (
                                            <div className="notification-prefs">
                                                ...
                                                >
                                                    Elige con cuánta antelación quieres recibir la
                                                    alerta.
                                                </p>
                                                <div className="notification-days-grid">
                                                    {([15, 5, 1] as const).map((day) => {
                                                        ...
                                                        return (
                                                            <label
                                                                key={day}
                                                                className="checkbox-label notification-day-label"
                                                            >
                                                                <input
                                                                    type="checkbox"
                                                                    checked={checked}
                            ...
                            >
                                ...
                                <p className="section-description">
                                    Recibe un email recordatorio 30 días antes de cada plazo fiscal
                                    importante.
                                </p>
                                ...
                                <div className="gdpr-action">
                                    <div className="gdpr-action-info">
                                        ...
                                        <p>
                                            Te enviaremos un email a <strong>{user?.email}</strong>{' '}
                                            cuando se acerque un plazo fiscal relevante para tu
                                            perfil.
                                        </p>
                                    </div>
                                    <button
                                ...
                                {emailAlertsEnabled && (
                                    ...
                                    >
                                        <CheckCircle size={16} />
                                        <span>
                                            Las alertas por email están activas. Recibirás un
                                            recordatorio 30 días antes de cada plazo.
                                        </span>
                                    </div>
                                )}
                            </section>
            ...
            {showUpgradeModal && fiscal.planUpgradeNeeded && (
                <UpgradePlanModal
                    ...
                    onClose={() => {
                        ...
                        setFiscalForm((prev) => ({
                            ...prev,
                            situacion_laboral: lastSavedSituacion,
                        }))
                    }}
                />
            )}
