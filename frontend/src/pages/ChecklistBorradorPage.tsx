...
const CHECKLIST_ITEMS: ChecklistItem[] = [
    {
        ...
        description:
            'Verifica domicilio fiscal, estado civil y fecha de nacimiento. Si te mudaste de comunidad autónoma en 2025, la CCAA correcta es la de tu residencia el 31 de diciembre.',
        porQueImporta:
            'El domicilio fiscal determina qué deducciones autonómicas puedes aplicar. Un dato erróneo puede costarte cientos de euros en deducciones perdidas o en liquidaciones de la AEAT.',
    ...
    },
    {
        ...
        description:
            'Comprueba que aparecen todos los hijos, ascendientes a cargo y situaciones de discapacidad. Los nacimientos y adopciones de 2025 deben estar incluidos.',
        porQueImporta:
            'Los mínimos familiares reducen directamente la base imponible. Un hijo no registrado supone perder entre 2.400 y 4.500 EUR de mínimo, dependiendo de su edad y orden.',
    ...
    },
    {
        ...
        description:
            'Si te mudaste en 2025, asegúrate de que el borrador refleja la comunidad autónoma donde residías el 31 de diciembre de 2025, no donde vives ahora.',
        porQueImporta:
            'La CCAA incorrecta genera una cuota autonómica equivocada y puede impedir que apliques deducciones como la de alquiler de vivienda habitual o nacimiento de hijos.',
    },
    {
        id: 4,
        icon: Briefcase,
        ...
        description:
            'Verifica que aparecen todos tus pagadores: empresa principal, segunda empresa, SEPE (desempleo), mutualidades, prestaciones por maternidad o paternidad.',
        porQueImporta:
            'Tener dos o más pagadores puede obligarte a declarar aunque los ingresos totales sean inferiores a 22.000 EUR. Omitir un pagador es causa frecuente de requerimientos de la AEAT.',
    ...
    },
    {
        ...
        description:
            'Además de la deducción estatal transitoria (contratos anteriores al 1 de enero de 2015, hasta el 15% de lo pagado con límite de 9.040 EUR), comprueba si tu comunidad tiene deducción autonómica por alquiler de vivienda habitual.',
        porQueImporta:
            'La AEAT casi nunca pre-rellena las deducciones autonómicas. Esta es la mayor fuente de dinero no reclamado en la declaración de la renta.',
    ...
    },
    {
        ...
        description:
            'Incluye donativos a fundaciones, ONG, partidos políticos y sindicatos. Los primeros 250 EUR deducen al 80% y el resto al 40% (o 45% si llevas tres años donando al mismo organismo).',
        porQueImporta:
            'Las ONG informan a la AEAT pero no siempre constan en el borrador. Un donativo de 250 EUR puede suponer 200 EUR de ahorro fiscal que pierdes si no lo incluyes.',
    ...
    },
    {
        ...
        description:
            'Comprueba que constan tus aportaciones a planes de pensiones individuales o de empleo. El límite general es 1.500 EUR, ampliable hasta 8.500 EUR si el plan es de empresa.',
        porQueImporta:
            'Las aportaciones reducen la base imponible general, no la cuota. En los tramos altos, el ahorro puede superar el 45% del importe aportado.',
    ...
    },
    {
        ...
        description:
            'Las madres trabajadoras con hijos menores de tres años tienen derecho a hasta 1.200 EUR por cada hijo. Si el niño estuvo en guardería, puedes añadir hasta 1.000 EUR adicionales por gastos de custodia.',
        porQueImporta:
            'Es frecuente que el borrador incluya los 1.200 EUR pero omita los 1.000 EUR de guardería. Muchas madres pierden esta cantidad simplemente por no comprobarlo.',
    ...
    },
    {
        ...
        description:
            'Las familias numerosas generales tienen derecho a 1.200 EUR de deducción y las de categoría especial a 2.400 EUR. Verifica también si corresponde la deducción por cónyuge con discapacidad.',
        porQueImporta:
            'Este importe se deduce de la cuota líquida, no de la base imponible, por lo que el ahorro es íntegro. La AEAT suele incluirlo si hay certificado vigente, pero conviene confirmarlo.',
    ...
    },
    {
        ...
        description:
            'Las cuotas sindicales y las cuotas de colegiación obligatoria son gasto deducible de los rendimientos del trabajo. El límite para cuotas de colegios es de 500 EUR anuales.',
        porQueImporta:
            'El borrador suele omitirlas aunque el pagador las declare. Son gastos que el contribuyente puede añadir manualmente en la casilla correspondiente sin necesidad de justificante adicional.',
    ...
    },
    {
        ...
        description:
            'Además de la deducción por maternidad, muchas comunidades autónomas tienen deducciones propias por gastos de escuela infantil (0-3 años). Consulta la tabla de tu CCAA.',
        porQueImporta:
            'Madrid, Cataluña, Galicia, Andalucía y otras CCAA tienen deducciones propias de hasta el 30% de los gastos de guardería que no se incluyen en el borrador estatal.',
    },
    {
        id: 12,
        icon: Home,
        ...
        description:
            'Si compraste tu vivienda habitual antes del 1 de enero de 2013 y venías aplicando la deducción, puedes seguir haciéndolo con carácter transitorio. El límite es el 15% de lo pagado hasta 9.040 EUR anuales.',
        porQueImporta:
            'El borrador suele incluirla si la aplicaste el año anterior, pero verifica el importe. Si refinanciaste la hipoteca, podría haberse perdido el derecho a la deducción transitoria.',
    ...
    },
    {
        ...
        description:
            'Las obras de mejora de la eficiencia energética del hogar tienen deducciones del 20%, 40% o 60% según el tipo de reforma. La compra de vehículo eléctrico también puede tener deducción autonómica.',
        porQueImporta:
            'Son deducciones temporales creadas en los últimos años. Muchos contribuyentes no las conocen o no saben que deben incluirse en la declaración, no en el borrador automático.',
    ...
    },
    {
        ...
        description:
            'Verifica que constan todas las ventas de fondos de inversión, acciones, criptomonedas, inmuebles o cualquier otro activo. Las pérdidas patrimoniales compensan ganancias y reducen el impuesto.',
        porQueImporta:
            'La AEAT tiene datos de entidades financieras españolas pero puede no tener información completa de exchanges de cripto o activos en el extranjero. La omisión genera sanciones graves.',
    ...
    },
    {
        ...
        description:
            'Si tienes una segunda vivienda que no es tu residencia habitual y no está arrendada, debes imputar una renta del 1,1% o 2% del valor catastral. Verifica que la referencia catastral y el importe son correctos.',
        porQueImporta:
            'Los errores en referencias catastrales o la omisión de inmuebles heredados son causa frecuente de liquidaciones complementarias. La AEAT cruza datos con el Catastro.',
    },
]
...
export default function ChecklistBorradorPage() {
    ...
    useSEO({
        ...
        description:
            'Lista con 15 comprobaciones habituales antes de confirmar el borrador: CCAA, situación familiar, retenciones, vivienda, deducciones autonómicas.',
        canonical: '/checklist-borrador',
        keywords:
            'checklist borrador renta 2026, revisar borrador AEAT, errores declaración renta, confirmar borrador',
        og: { type: 'article' },
        schema: [
            {
                ...
                description:
                    '15 puntos que debes comprobar antes de confirmar tu declaración de la renta',
                step: [
                    {
                        '@type': 'HowToStep',
                        position: 1,
            ...
            },
            {
                ...
                itemListElement: [
                    ...
                    },
                    {
                        '@type': 'ListItem',
                        position: 2,
                        name: 'Checklist Borrador Renta',
                        item: 'https://impuestify.com/checklist-borrador',
                    },
                ],
            },
        ],
                ...
                <FadeContent direction="up" duration={600}>
                    <div className="checklist-hero-inner">
                        ...
                        <div className="checklist-hero-stat">
                            ...
                            Los españoles pierden 9.000 millones de euros al año por confirmar el
                ...
                <aside className="checklist-sidebar">
                    <div className="checklist-progress-card">
                        ...
                        <div className="checklist-sidebar-cta">
                            <p>
                                Deja que Impuestify te apunte las deducciones que se te suelen
                                escapar.
                            </p>
                                    ...
                                    >
                                        <div className="checklist-item-header">
                                            ...
                                            <div className="checklist-item-content">
                                                <div className="checklist-item-num">
                                                    Punto {item.id}
                                                </div>
                                                <h2 className="checklist-item-title">
                                                    {item.title}
                                                </h2>
                                        ...
                                        {isExpanded && (
                                            ...
                                            >
                                                <div className="checklist-item-detail-label">
                                                    Por qué importa
                                                </div>
                    ...
                    <FadeContent direction="up" duration={500} delay={200}>
                        <div className="checklist-infobox">
                            ...
                            <div>
                                ...
                                <p>
                                    Los españoles pierden aproximadamente 9.000 millones de euros al
                                    año por confirmar el borrador de la renta sin revisarlo. La
                                    mayoría de las deducciones autonómicas no aparecen en el
                                    borrador y deben añadirse manualmente.
                                    <br />
                                    <span className="checklist-infobox-source">
                                        Fuente: GESTHA (Sindicato de Técnicos del Ministerio de
                                        Hacienda)
                                    </span>
                                </p>
                            </div>
                    ...
                    <FadeContent direction="up" duration={500} delay={300}>
                        <div className="checklist-cta-box">
                            ...
                            <p className="checklist-cta-sub">
                                Revisamos tu situación, señalamos las deducciones autonómicas
                                aplicables y te acompañamos punto por punto antes de que confirmes
                                el borrador.
                            </p>
                            <div className="checklist-cta-actions">
                                <Link
                                    to="/guia-fiscal"
                                    className="checklist-btn-primary checklist-btn-lg"
                                >
                                ...
                                <Link
                                    to="/register"
                                    className="checklist-btn-secondary checklist-btn-lg"
                                >
                                    Crear cuenta gratis
                                </Link>
                            </div>
