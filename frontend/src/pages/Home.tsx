...
const CREATOR_CARDS = [
    {
        ...
        description:
            'IVA intracomunitario + Modelo 349 automático. Cada plataforma tiene su régimen: lo calculamos sin que tengas que estudiarlo.',
    },
    {
        icon: FileText,
        title: 'Epígrafe IAE correcto',
        description:
            'Consulta DGT V0773-22: identifica el epígrafe 961.1, 961.2 o 843 que corresponde a tu actividad. Evita sanciones por epígrafe incorrecto.',
    },
    {
        icon: Shield,
        title: 'Royalties al 24%',
        description:
            'Retención correcta sobre royalties de plataformas digitales, no el 15% genérico. Ahorra en la declaración aplicando el tipo correcto.',
    },
    {
        icon: Map,
        title: '21 territorios',
        description:
            'El único asistente que cubre País Vasco y Navarra (régimen foral) + Canarias (IGIC) + Ceuta y Melilla (IPSI). Sin excepciones.',
    },
]
...
export default function Home() {
    ...
    useSEO({
        ...
        description:
            'Simulador de IRPF con los tramos de tu CCAA, base de deducciones autonómicas y guías para autónomos y creadores. 21 territorios cubiertos.',
        canonical: '/',
        keywords:
            'asistente fiscal IA, impuestos España, IRPF, declaración renta, deducciones autónomo, creadores contenido',
        schema: {
            ...
            offers: [
                {
                    ...
                    price: '5',
                    priceCurrency: 'EUR',
                    description: 'Para asalariados y pensionistas',
                },
                {
                    '@type': 'Offer',
                    name: 'Creador',
                    price: '49',
                    priceCurrency: 'EUR',
                    description: 'Para YouTubers, TikTokers, streamers',
                },
                {
                    '@type': 'Offer',
                    name: 'Autónomo',
        ...
        <div className="home">
                ...
                <div className="container">
                    ...
                    <FadeContent delay={200} duration={600}>
                        <p className="hero-subtitle">
                            Haz la renta, lleva la contabilidad de tu actividad como autónomo,
                            calcula el Impuesto sobre Sociedades o contesta un requerimiento de
                            Hacienda. Todo desde la misma web. Funciona con IA, cubre las 17
                            comunidades autónomas (con los cuatro territorios forales incluidos) y
                            las ciudades autónomas de Ceuta y Melilla, y cada respuesta te enseña el
                ...
                <div className="container">
                    <FadeContent delay={0} duration={500}>
                        ...
                        <p className="section-subtitle">
                            Sirve para particulares, autónomos, creadores y sociedades. Esto es lo
                            que tienes dentro desde el primer minuto.
                        </p>
                    </FadeContent>
                    ...
                    <div className="what-it-does-grid">
                        <FadeContent delay={80} duration={400}>
                            ...
                            >
                                ...
                                <h3>Haz tu renta</h3>
                                <p>
                                    Calcula el IRPF con los tramos de tu comunidad o de tu
                                    territorio foral. Te dice si sale a pagar o a devolver y qué
                                    deducciones autonómicas puedes meter.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                        ...
                        <FadeContent delay={130} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    Modelo 200 para tu SL o tu SA. Régimen común, los cuatro
                                    forales, ZEC de Canarias y Ceuta/Melilla. También te calcula los
                        ...
                        <FadeContent delay={180} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    303, 130, 131, 308, 349, 720 y 721. En Gipuzkoa usa el 300, en
                                    Navarra el F69, en Canarias el 420 (IGIC) y en Ceuta/Melilla el
                                    IPSI. Todos con borrador en PDF.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                        ...
                        <FadeContent delay={230} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    ISD con la normativa de cada comunidad, incluidas las
                                    bonificaciones forales y las de Ceuta y Melilla.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                        ...
                        <FadeContent delay={280} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    Si Hacienda te manda una liquidación, una sanción o un
                                    requerimiento, DefensIA lee el documento y te redacta el
                                    recurso: reposición, TEAR (abreviado o general) o alegaciones.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                        ...
                        <FadeContent delay={330} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    Subes tus facturas, las clasifica al Plan General Contable y te
                                    monta los libros Diario, Mayor, Balance y Pérdidas y Ganancias.
                                    Los exportas listos para el Registro Mercantil.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                        ...
                        <FadeContent delay={380} duration={400}>
                            ...
                            >
                                ...
                                <h3>Chat fiscal</h3>
                                <p>
                                    Le preguntas como si hablaras con un asesor. Lo que te contesta
                                    viene de más de 460 documentos oficiales (AEAT, BOE,
                                    Diputaciones Forales), y siempre te pone la cita al artículo de
                                    la ley.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                        ...
                        <FadeContent delay={430} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    Sueldo neto, retenciones de IRPF, umbrales contables, qué
                                    modelos tienes que presentar, si estás obligado a declarar y
                                    checklist del borrador. Sin registrarte.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                    </div>
                    ...
                    <FadeContent delay={500} duration={500}>
                        <div className="what-it-does-footer">
                            <p>
                                <strong>Lo que no hace Impuestify:</strong> no presenta modelos ante
                                la AEAT en tu nombre, no gestiona nóminas, TC1/TC2 ni contratos
                                laborales, y no sustituye a un asesor fiscal o a un abogado
                                colegiado. Antes de presentar un modelo o un escrito oficial,
                                pásaselo a un profesional.
                            </p>
                        </div>
                    </FadeContent>
                </div>
                ...
                <div className="container">
                    <FadeContent delay={0} duration={500}>
                        <h2 className="section-title">
                            Deducciones que no sabías que podías aplicarte
                        </h2>
                        <p className="section-subtitle">
                            Muchos contribuyentes pagan de más porque ni se enteran de que tienen
                            derecho a una deducción autonómica.
                        </p>
                    </FadeContent>
                    <FadeContent delay={100} duration={600}>
                        <div className="savings-grid">
                            <div className="savings-card">
                                ...
                                <span className="savings-card__label">
                                    Ahorro medio que aparece por usuario
                                </span>
                                <span className="savings-card__detail">
                                    En deducciones autonómicas que no se habían aplicado
                                </span>
                            </div>
                            <div className="savings-card">
                                <span className="savings-card__amount">
                                ...
                                <span className="savings-card__label">
                                    Tiempo medio de una consulta
                                </span>
                                <span className="savings-card__detail">
                                    Una asesoría tradicional tarda unos 45 minutos
                                </span>
                            </div>
                            <div className="savings-card">
                                <span className="savings-card__amount">
                                ...
                                <span className="savings-card__label">
                                    Una asesoría cobra entre 150 y 300 EUR al mes
                                </span>
                                <span className="savings-card__detail">
                                    Con Impuestify pagas hasta un 97% menos
                                </span>
                            </div>
                        </div>
                    </FadeContent>
            ...
            <section className="coverage">
                <div className="container">
                    <FadeContent delay={0} duration={500}>
                        <h2 className="section-title">
                            Todas las comunidades, también las forales
                        </h2>
                        <p className="section-subtitle">
                            Mapa fiscal de España: régimen común, País Vasco, Navarra, Canarias y
                            Ceuta/Melilla
                        </p>
                    </FadeContent>
                    <FadeContent delay={100} duration={600}>
                    ...
                    <FadeContent delay={200} duration={500}>
                        <p className="coverage-note">
                            Somos el único asistente fiscal con IA que integra las normativas
                            forales del País Vasco y Navarra, con sus deducciones propias que no
                            existen en el régimen común.{' '}
            ...
            <section className="comparison">
                <div className="container">
                    <FadeContent delay={0} duration={500}>
                        <h2 className="section-title">
                            Por qué nuestra IA no se inventa las respuestas
                        </h2>
                    </FadeContent>
                    <div className="comparison-grid">
                        <FadeContent delay={100} duration={500}>
                            <div className="comparison-col comparison-generic">
                                ...
                                <ul className="comparison-list">
                                    <li>
                                        <X size={16} className="comparison-icon-no" /> Chatbot
                                        genérico sin fuentes verificadas
                                    </li>
                                    <li>
                                        <X size={16} className="comparison-icon-no" /> Sin análisis
                                        de documentos
                                    </li>
                                    <li>
                                        <X size={16} className="comparison-icon-no" /> Sin cobertura
                                        de territorios forales
                                    </li>
                                    <li>
                                        <X size={16} className="comparison-icon-no" /> Respuestas
                                        genéricas sin personalización
                                    </li>
                                    <li>
                                        <X size={16} className="comparison-icon-no" /> Sin
                        ...
                        <FadeContent delay={200} duration={500}>
                            <SpotlightCard
                                className="comparison-col comparison-impuestify"
                                spotlightColor="rgba(26, 86, 219, 0.12)"
                            >
                                ...
                                <ul className="comparison-list">
                                    <li>
                                        <CheckCircle size={16} className="comparison-icon-yes" />{' '}
                                        Agentes distintos para renta, nóminas, AEAT y contabilidad
                                    </li>
                                    <li>
                                        <CheckCircle size={16} className="comparison-icon-yes" />{' '}
                                        Cada respuesta cita el artículo concreto de la ley
                                    </li>
                                    <li>
                                        <CheckCircle size={16} className="comparison-icon-yes" /> 17
                                        CCAA (con los 4 forales) + Ceuta y Melilla
                                    </li>
                                    <li>
                                        <CheckCircle size={16} className="comparison-icon-yes" />{' '}
                                        Más de mil deducciones autonómicas y forales
                                    </li>
                                    <li>
                                        <CheckCircle size={16} className="comparison-icon-yes" />{' '}
                                        Protección frente a inyección de prompts y filtrado de datos
                                        personales
                                    </li>
                                </ul>
                            </SpotlightCard>
                    ...
                    <div className="features-grid">
                        <FadeContent delay={100} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    Un agente se ocupa de lo fiscal, otro de las nóminas, otro de
                                    las notificaciones de la AEAT y otro de tus documentos. Así cada
                                    pregunta va al que realmente sabe del tema.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                        <FadeContent delay={200} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    AEAT, BOE, las cuatro Diputaciones Forales y boletines
                                    autonómicos. Cuando el asistente te responde, te enseña
                                    exactamente de dónde ha sacado la respuesta.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                        <FadeContent delay={300} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    Filtramos DNIs, IBANs, teléfonos y correos antes de que lleguen
                                    al modelo. Bloqueamos intentos de manipulación del asistente.
                                    Todo bajo RGPD y servidores en la UE.
                                </p>
                            </SpotlightCard>
                        </FadeContent>
                        <FadeContent delay={400} duration={400}>
                            ...
                            >
                                ...
                                <p>
                                    Cuánto te queda limpio al mes. Te enseña el desglose: IRPF, IVA,
                        ...
                        <FadeContent delay={500} duration={400}>
                            <a href="/calculadora-retenciones" style={{ textDecoration: 'none' }}>
                                ...
                                >
                                    ...
                                    <p>
                                        ¿Cuánto te están quitando de IRPF cada mes? Te lo calcula
                                        con el mismo algoritmo que usa la AEAT.
                                    </p>
                                </SpotlightCard>
                            </a>
                        </FadeContent>
                        <FadeContent delay={600} duration={400}>
                            <a href="/calculadora-umbrales" style={{ textDecoration: 'none' }}>
                                ...
                                >
                                    ...
                                    <p>
                                        ¿Tu empresa va con PGC Normal o con PYMES? ¿Necesita
                                        auditoría? Te lo dice según los umbrales de la Ley de
                        ...
                        <FadeContent delay={700} duration={400}>
                            <a href="/modelos-obligatorios" style={{ textDecoration: 'none' }}>
                                ...
                                >
                                    ...
                                    <p>
                                        Según tu perfil, tu comunidad y tu actividad, te decimos qué
                                        modelos tienes que presentar y cuándo vencen.
                                    </p>
                                </SpotlightCard>
                            </a>
                        </FadeContent>
                        <FadeContent delay={800} duration={400}>
                            <a href="/farmacias" style={{ textDecoration: 'none' }}>
                                ...
                                >
                                    ...
                                    <h3>Farmacias</h3>
                                    <p>
                                        Recargo de equivalencia aplicado automático, fondo de
                                        comercio, deducciones propias de farmacéuticos titulares.
                                        Pensado para el día a día de una oficina de farmacia.
                                    </p>
                                </SpotlightCard>
                            </a>
                        </FadeContent>
                    ...
                    <FadeContent delay={0} duration={500}>
                        <div className="creators-promo__header">
                            ...
                            <h2 className="creators-promo__title">
                                ...
                                <br />
                                <span className="creators-promo__title-accent">
                                    Hacienda ya sabe cuánto ganas
                                </span>
                            </h2>
                            <p className="creators-promo__subtitle">
                                Desde enero 2026, las plataformas reportan tus ingresos a la AEAT
                                (DAC7). Impuestify te ayuda a declarar correctamente y evitar
                                sanciones.
                            </p>
                        </div>
                    </FadeContent>
                            ...
                            {CREATOR_CARDS.map((card, i) => {
                                ...
                                return (
                                    <div key={i} className="creators-promo__card">
                                        ...
                                        <p className="creators-promo__card-desc">
                                            {card.description}
                                        </p>
                                    </div>
                                )
                    ...
                    <FadeContent delay={0} duration={500}>
                        <div className="guide-promo__inner">
                            ...
                            <div className="guide-promo__content">
                                <h3 className="guide-promo__title">
                                    ¿Primera vez haciendo la declaración de la renta?
                                </h3>
                                <p className="guide-promo__desc">
                                    Nuestra guía fiscal interactiva te lleva paso a paso por los 7
                                    apartados del IRPF. Sin jerga fiscal. Sin errores.
                                </p>
                            </div>
                        ...
                        <div className="pricing-grid">
                            ...
                            <div className="pricing-card">
                                ...
                                <ul className="pricing-features">
                                    ...
                                    <li>
                                        <CheckCircle size={18} />
                                        <span>Motor de 128 deducciones personalizadas</span>
                                    </li>
                                    <li>
                                        <CheckCircle size={18} />
                                        <span>Cobertura completa: 17 CCAA + forales</span>
                                    </li>
                                    <li>
                                        <CheckCircle size={18} />
                                        <span>Análisis de nóminas y notificaciones AEAT</span>
                                    </li>
                                    <li>
                                        <CheckCircle size={18} />
                                        <span>Informe IRPF exportable en PDF</span>
                                    </li>
                                    <li>
                                        <CheckCircle size={18} />
                                        <span>Criptomonedas, trading y apuestas (FIFO)</span>
                                    </li>
                                </ul>
                                <Link
                                    to="/register"
                            ...
                            <div className="pricing-card pricing-card--creator">
                                ...
                                <ul className="pricing-features">
                                    <li>
                                        <CheckCircle size={18} className="pricing-check--creator" />
                                        <span>Todo lo del plan Particular</span>
                                    </li>
                                    <li>
                                        <CheckCircle size={18} className="pricing-check--creator" />
                                        <span>
                                            Simulador IRPF con royalties y derechos de autor
                                        </span>
                                    </li>
                                    <li>
                                        <CheckCircle size={18} className="pricing-check--creator" />
                                        <span>IVA por plataforma (YouTube, TikTok, Twitch)</span>
                                    </li>
                                    <li>
                                        <CheckCircle size={18} className="pricing-check--creator" />
                                        <span>Epígrafe IAE para creadores</span>
                                    </li>
                                    <li>
                                        <CheckCircle size={18} className="pricing-check--creator" />
                                        <span>Modelo 349 — operaciones intracomunitarias</span>
                                    </li>
                                    <li>
                                        <CheckCircle size={18} className="pricing-check--creator" />
                                        <span>Asistente IA especializado en creadores</span>
                                    </li>
                                </ul>
                                <Link
                                    to="/subscribe"
                                    className="btn btn-lg pricing-cta pricing-cta--creator"
                                >
                                    <CreditCard size={20} />
                            ...
                            <div className="pricing-card pricing-card--autonomo">
                                <div className="pricing-header">
                                    ...
                                    <div>
                                        ...
                                        <p className="pricing-plan-desc">
                                            Para profesionales por cuenta propia
                                        </p>
                                    </div>
                                </div>
                                <div className="pricing-amount">
                                    <span className="pricing-currency">EUR</span>
                                    <span className="pricing-value pricing-value--autonomo">
                                        39
                                    </span>
                                    <span className="pricing-period">
                                        /mes <small>IVA incl.</small>
                                    </span>
                                </div>
                                <ul className="pricing-features">
                                    <li>
                                        <CheckCircle
                                            size={18}
                                            className="pricing-check--autonomo"
                                        />
                                        <span>Todo lo del plan Particular</span>
                                    </li>
                                    <li>
                                        <CheckCircle
                                            ...
                                            className="pricing-check--autonomo"
                                        />
                                        <span>Modelos 303, 130, 131, 390</span>
                                    </li>
                                    <li>
                                        <CheckCircle
                                            size={18}
                                            className="pricing-check--autonomo"
                                        />
                                        <span>Clasificador de facturas con IA</span>
                                    </li>
                                    <li>
                                        <CheckCircle
                                            size={18}
                                            className="pricing-check--autonomo"
                                        />
                                        <span>Contabilidad PGC y libros oficiales</span>
                                    </li>
                                    <li>
                                        <CheckCircle
                                            size={18}
                                            className="pricing-check--autonomo"
                                        />
                                        <span>Calculadora sueldo neto autónomo</span>
                                    </li>
                                    <li>
                                        <CheckCircle
                                            size={18}
                                            className="pricing-check--autonomo"
                                        />
                                        <span>Gastos deducibles por actividad</span>
                                    </li>
                                </ul>
                                <Link
                                    to="/subscribe"
                                    className="btn btn-lg pricing-cta pricing-cta--autonomo"
                                >
                                    <CreditCard size={20} />
            ...
            <footer className="home-footer">
                <div className="container">
                    <p className="home-footer__desc">
                        Impuestify es un asistente fiscal con inteligencia artificial para
                        particulares, autónomos y creadores de contenido en España. Cubre los 21
                        territorios fiscales con más de 600 deducciones, simulador IRPF y guía
