...
export default function Modelo200Page() {
    ...
    useSEO({
        ...
        description:
            'Calcula la cuota del Impuesto sobre Sociedades con ajustes extracontables, compensación de BINs, tipo reducido de pymes y deducciones por I+D+i.',
        canonical: '/modelo-200',
        keywords:
            'modelo 200, impuesto sociedades, IS, pyme, SL, simulador, deducciones I+D, BINs, modelo 202',
        schema: {
            ...
            operatingSystem: 'Web',
            description:
                'Calcula la cuota del Impuesto sobre Sociedades aplicando ajustes extracontables, compensaci\u00f3n de BINs, deducciones por I+D+i y bonificaciones por territorio.',
        },
    })
    ...
    const triggerEstimate = useCallback(() => {
        ...
        const input: ISEstimateInput = {
            workspace_id:
                state.workspace_id && state.workspace_id !== '_manual'
                    ? state.workspace_id
                    : undefined,
        ...
        <div className="m200-page">
            ...
            <div className="m200-container">
                <div className="m200-header">
                    ...
                    <p>
                        Estima la cuota del IS a partir de tu resultado contable y los ajustes
                ...
                {state.step === 0 && (
                    <div className="m200-card">
                        <h2>
                            <Building2 size={20} /> Datos de la entidad
                        </h2>
                        ...
                        <div className="m200-field">
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    ...
                                    if (e.target.value !== 'Ceuta' && e.target.value !== 'Melilla')
                                        setField('rentas_ceuta_melilla', 0)
                                }}
                            >
                        ...
                        {isCanarias && (
                            <div className="m200-field">
                                ...
                                <span className="m200-field__help">
                                    Tipo reducido del 4% para entidades ZEC (Art. 44 Ley 19/1994)
                                </span>
                            </div>
                        )}
                        ...
                        <div className="m200-field">
                            <label className="m200-field__label">
                                Facturaci&oacute;n anual aproximada
                            </label>
                            ...
                            <span className="m200-field__help">
                                Determina si aplican tipos reducidos para micropymes (&lt; 1M) o
                                pymes (&lt; 10M)
                            </span>
                        </div>
                ...
                {state.step === 1 && (
                    <div className="m200-card">
                        <h2>
                            <FileText size={20} /> Resultado contable
                        </h2>

                        {prefilling && (
                            <div className="m200-loading">
                                <Loader2 size={20} className="spin" /> Cargando datos del
                                workspace...
                            </div>
                        )}
                        ...
                        {!isManual && prefillData && !prefilling && (
                            <>
                                <div className="m200-prefill-info">
                                    <Info size={16} />
                                    Datos precargados de{' '}
                                    <strong>{prefillData.workspace_name}</strong> &mdash;{' '}
                                    {prefillData.num_facturas} facturas, per&iacute;odo{' '}
                                    {prefillData.periodo_cubierto}. Puedes editarlos.
                                </div>
                                ...
                                <div className="m200-field">
                                    <label className="m200-field__label">
                                        Ingresos de explotaci&oacute;n
                                    </label>
                                    <div className="m200-field__input-wrap">
                                        <input
                                            type="number"
                        ...
                        {isManual && !prefilling && (
                            <>
                                ...
                                <div className="m200-calculated">
                                    <span className="m200-calculated__label">
                                        Resultado contable
                                    </span>
                                    <span className="m200-calculated__value">
                                        {fmtEur(calculatedRC)}
                                    </span>
                                </div>
                            </>
                        ...
                        <div className="m200-field">
                            <label className="m200-field__label">
                                Amortizaci&oacute;n fiscal (si difiere de contable)
                            </label>
                            <div className="m200-field__input-wrap">
                                <input
                                    type="number"
                            ...
                            <span className="m200-field__help">
                                Si es mayor que la contable, genera un ajuste negativo (diferencia
                ...
                {state.step === 2 && (
                    <div className="m200-card">
                        <h2>
                            <FileText size={20} /> Ajustes y deducciones
                        </h2>
                            ...
                            <label className="m200-field__label">
                                ...
                                <span className="m200-tooltip">
                                    ...
                                    <span className="m200-tooltip__content">
                                        Art. 15 LIS: multas/sanciones, donativos no acogidos a Ley
                                        49/2002, liberalidades, gastos con operaciones vinculadas no
                                        valorados a mercado, p&eacute;rdidas de juego, gastos
                                        financieros no deducibles (Art. 16 LIS).
                                    </span>
                                </span>
                            </label>
                            <div className="m200-field__input-wrap">
                        ...
                        <div className="m200-field">
                            ...
                            <div className="m200-field__input-wrap">
                                <input
                                    ...
                                    onChange={(e) =>
                                        setField('bins_pendientes', parseFloat(e.target.value) || 0)
                                    }
                                    min={0}
                                    step={100}
                                    inputMode="decimal"
                            ...
                            <span className="m200-field__help">
                                BINs de ejercicios anteriores pendientes de compensar (l&iacute;mite
                                70% de BI previa, 100% hasta 1M)
                            </span>
                        </div>
                        ...
                        <div className="m200-field">
                            ...
                            <div className="m200-field__input-wrap">
                                <input
                                    ...
                                    onChange={(e) =>
                                        setField('gasto_id', parseFloat(e.target.value) || 0)
                                    }
                                    min={0}
                                    step={100}
                                    inputMode="decimal"
                            ...
                            <span className="m200-field__help">
                                Deducci&oacute;n del 25% (42% si supera media de los 2 a&ntilde;os
                                anteriores)
                            </span>
                        </div>
                        ...
                        <div className="m200-field">
                            <label className="m200-field__label">
                                Gasto en innovaci&oacute;n tecnol&oacute;gica
                            </label>
                            <div className="m200-field__input-wrap">
                                <input
                                    type="number"
                                    ...
                                    onChange={(e) =>
                                        setField('gasto_it', parseFloat(e.target.value) || 0)
                                    }
                                    min={0}
                                    step={100}
                                    inputMode="decimal"
                        ...
                        <div className="m200-field">
                            <label className="m200-field__label">
                                Reserva de capitalizaci&oacute;n (incremento fondos propios)
                            </label>
                            <div className="m200-field__input-wrap">
                                <input
                                    type="number"
                                    ...
                                    onChange={(e) =>
                                        setField('incremento_ffpp', parseFloat(e.target.value) || 0)
                                    }
                                    min={0}
                                    step={100}
                                    inputMode="decimal"
                            ...
                            <span className="m200-field__help">
                                Reducci&oacute;n del 10% del incremento de fondos propios (Art. 25
                                LIS)
                            </span>
                        </div>
                        ...
                        <div className="m200-field">
                            ...
                            <div className="m200-field__input-wrap">
                                <input
                                    ...
                                    onChange={(e) =>
                                        setField('donativos', parseFloat(e.target.value) || 0)
                                    }
                                    min={0}
                                    step={100}
                                    inputMode="decimal"
                            ...
                            <span className="m200-field__help">
                                Deducci&oacute;n del 40% (l&iacute;mite 15% de BI)
                            </span>
                        </div>

                        <div className="m200-field">
                            <label className="m200-field__label">
                                Empleados con discapacidad &ge;33%
                            </label>
                            <input
                                type="number"
                                className="m200-field__input"
                            ...
                            />
                            <span className="m200-field__help">
                                Deducci&oacute;n de 9.000 EUR por contrato
                            </span>
                        </div>

                        <div className="m200-field">
                            <label className="m200-field__label">
                                Empleados con discapacidad &ge;65%
                            </label>
                            <input
                                type="number"
                                className="m200-field__input"
                            ...
                            />
                            <span className="m200-field__help">
                                Deducci&oacute;n de 12.000 EUR por contrato
                            </span>
                        </div>
                        ...
                        {isCanarias && (
                            <div className="m200-field">
                                <label className="m200-field__label">
                                    Dotaci&oacute;n RIC (Reserva para Inversiones en Canarias)
                                </label>
                                <div className="m200-field__input-wrap">
                                    <input
                                        type="number"
                                ...
                                <span className="m200-field__help">
                                    Reducci&oacute;n de hasta el 90% del beneficio no distribuido
                                    (Art. 27 Ley 19/1994)
                                </span>
                            </div>
                        )}
                        ...
                        {isCeutaMelilla && (
                            <div className="m200-field">
                                ...
                                <span className="m200-field__help">
                                    Bonificaci&oacute;n del 50% sobre la parte de cuota
                                    correspondiente
                                </span>
                            </div>
                        )}
                        ...
                        <div className="m200-field">
                            <label className="m200-field__label">
                                Pagos fraccionados ya realizados (Modelo 202)
                            </label>
                            <div className="m200-field__input-wrap">
                                <input
                                    type="number"
                    ...
                    <div className="m200-result-grid">
                        ...
                        {result && (
                            <div className="m200-estimator-sticky">
                                <div
                                    className={`estimator-bar ${result.tipo === 'a_devolver' ? 'estimator-bar--refund' : 'estimator-bar--payment'} ${estimating ? 'estimator-bar--loading' : ''}`}
                                >
                                    {estimating ? (
                                        ...
                                        <>
                                            ...
                                            <div className="estimator-bar__content">
                                                ...
                                                <span className="estimator-bar__amount">
                                                    ...
                                                    <span className="estimator-bar__currency">
                                                        {' '}
                                                        EUR
                                                    </span>
                                                </span>
                        ...
                        {estimating && !result && (
                            <div className="m200-loading">
                                <Loader2 size={20} className="spin" /> Calculando Impuesto sobre
                                Sociedades...
                            </div>
                        )}
