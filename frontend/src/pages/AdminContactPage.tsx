...
export default function AdminContactPage() {
    ...
    const fetchItems = useCallback(async () => {
        ...
        try {
            ...
            setMessage({
                type: 'error',
                text: err.message || 'Error al cargar solicitudes de contacto',
            })
        } finally {
            setLoading(false)
        }
    ...
    const handleMarkResponded = async (item: ContactRequest) => {
        ...
        try {
            ...
            setMessage({
                type: 'success',
                text: `Solicitud de ${item.email} marcada como respondida`,
            })
            await fetchItems()
                                        ...
                                        {items.map((item) => (
                                            ...
                                            >
                                                <div className="acp-card__top">
                                                    ...
                                                    <span
                                                        className={`acp-status-badge acp-status--${item.status}`}
                                                    >
                                                        {item.status === 'pending'
                                                            ? 'Pendiente'
                                                            : 'Respondido'}
                                                ...
                                                {item.subject && (
                                                    <p className="acp-card__subject">
                                                        {item.subject}
                                                    </p>
                                                )}
                                                <p className="acp-card__preview">
                                                    {truncate(item.message)}
                                                </p>
                                                <div className="acp-card__footer">
                                                    <span className="acp-date">
                                            ...
                                            <tbody>
                                                {items.map((item) => (
                                                    <tr
                                                        ...
                                                        onClick={() => setSelectedItem(item)}
                                                    >
                                                        <td className="acp-cell-email">
                                                            {item.email}
                                                        </td>
                                                        <td>{item.name || '-'}</td>
                                                        <td className="acp-cell-subject">
                                                            {item.subject || '-'}
                                                        </td>
                                                        <td className="acp-cell-message">
                                ...
                                <div className="acp-detail__body">
                                    ...
                                    {selectedItem.name && (
                                        <div className="acp-detail__row">
                                            ...
                                            <span className="acp-detail__value">
                                                {selectedItem.name}
                                            </span>
                                        </div>
                                    )}
                                    ...
                                    <div className="acp-detail__row">
                                        ...
                                        <span
                                            className={`acp-status-badge acp-status--${selectedItem.status}`}
                                        >
