...
export default function M390CalculatorPage() {
    ...
    const [trimestres, setTrimestres] = useState<Trimestre303[]>([
        emptyTrimestre(),
        emptyTrimestre(),
        emptyTrimestre(),
        emptyTrimestre(),
                ...
                <div className={`m130-layout ${hasResult ? 'm130-layout--split' : ''}`}>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="m130-fields-card">
                                ...
                                <div className="m130-field">
                                    ...
                                    <input
                                        ...
                                        value={year}
                                        onChange={(e) =>
                                            setYear(parseInt(e.target.value) || currentYear - 1)
                                        }
                                    />
                                    <p className="m130-field-hint">
                                        El M390 de 2025 se presenta en enero de 2026.
                                    </p>
                                </div>
                                <div className="m130-field">
                                    <label className="m130-label" htmlFor="ccaa">
                                        Comunidad Autonoma
                                    </label>
                                    <select
                                        id="ccaa"
                                ...
                                <div className="m130-field">
                                    ...
                                    <div className="m130-input-row">
                                        ...
                                        <input
                                            ...
                                            value={volumen || ''}
                                            onChange={(e) =>
                                                setVolumen(parseFloat(e.target.value) || 0)
                                            }
                                        />
                                        <span className="m130-input-suffix">EUR</span>
                                    </div>
                                    <p className="m130-field-hint">
                                        Determina la periodicidad obligatoria del 303 del ejercicio
                                        siguiente.
                                    </p>
                                </div>
                                <div className="m130-field">
                                    <label className="m130-label" htmlFor="regimen">
                                        Regimen de IVA
                                    </label>
                                    <select
                                        id="regimen"
                                ...
                                <div className="m130-ceuta-row">
                                    <label className="m130-toggle-label" htmlFor="redeme">
                                        <input
                                            ...
                                            checked={enRedeme}
                                            onChange={(e) => setEnRedeme(e.target.checked)}
                                        />
                                        <span className="m130-toggle-track" />
                                        <span className="m130-toggle-text">
                                            Inscrito en REDEME (devolucion mensual)
                                        </span>
                                    </label>
                                </div>
                                <div className="m130-ceuta-row">
                                    <label className="m130-toggle-label" htmlFor="grupo">
                                        <input
                                            ...
                                            className="m130-toggle-input"
                                            checked={enGrupoIva}
                                            onChange={(e) => setEnGrupoIva(e.target.checked)}
                                        />
                                        <span className="m130-toggle-track" />
                                        <span className="m130-toggle-text">
                                            Grupo de IVA (Art. 163 quinquies LIVA)
                                        </span>
                                    </label>
                                </div>
                                <div className="m130-ceuta-row">
                                    <label className="m130-toggle-label" htmlFor="sii">
                                        <input
                                            ...
                                            type="checkbox"
                                            className="m130-toggle-input"
                                            checked={siiVoluntario}
                                            onChange={(e) => setSiiVoluntario(e.target.checked)}
                                        />
                                        <span className="m130-toggle-track" />
                                        <span className="m130-toggle-text">
                                            SII voluntario (Suministro Inmediato de Informacion)
                                        </span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="m130-fields-card">
                                <h2 className="m130-fields-title">
                                    Datos de los 4 trimestres (opcional)
                                </h2>
                                <div className="m130-ceuta-row">
                                    <label className="m130-toggle-label" htmlFor="incluirT">
                                        <input
                                            ...
                                            type="checkbox"
                                            className="m130-toggle-input"
                                            checked={incluirTrimestres}
                                            onChange={(e) => setIncluirTrimestres(e.target.checked)}
                                        />
                                        <span className="m130-toggle-track" />
                                        <span className="m130-toggle-text">
                                            Incluir resumen de los 4 trimestres
                                        </span>
                                    </label>
                                </div>
                    ...
                    {hasResult && (
                        <section className="m130-result-panel" aria-live="polite">
                            <div
                                className={`m130-result-card ${result.obligado ? 'm130-result-card--pagar' : 'm130-result-card--zero'}`}
                            >
                                ...
                                {result.variante_territorial && (
                                    <div className="m130-result-sub">
                                        Variante: {result.variante_territorial}
                                    </div>
                                )}
                            </div>

                            {result.resumen_anual &&
                                Object.keys(result.resumen_anual).length > 0 && (
                                    <div className="m130-casillas-card">
                                        ...
                                        <table className="m130-casillas-table">
                                            ...
                                            <tbody>
                                                {Object.entries(result.resumen_anual).map(
                                                    ([k, v]) => (
