...
export default function CalculadoraRetencionesPage() {
    useSEO({
        ...
        description:
            'Calcula el tipo de retención de tu nómina en 2026 siguiendo el algoritmo de la AEAT. Válido para asalariados y para autónomos con retención.',
        canonical: '/calculadora-retenciones',
        keywords:
            'calculadora retenciones IRPF 2026, retención nómina, tipo retención, algoritmo AEAT, calcular IRPF',
        schema: [
            {
            ...
            },
            {
                ...
                itemListElement: [
                    ...
                    },
                    {
                        '@type': 'ListItem',
                        position: 2,
                        name: 'Calculadora Retenciones IRPF',
                        item: 'https://impuestify.com/calculadora-retenciones',
                    },
                ],
            },
        ],
    ...
    const addHijo = () => {
        setDescendientes([
            ...descendientes,
            { ano_nacimiento: 2020, por_entero: false, discapacidad: 'sin' },
        ])
    }
                ...
                <div className="calc-ret-grid">
                    ...
                    <div className="calc-ret-form">
                        <div className="calc-ret-section">
                            ...
                            <div className="calc-ret-row">
                                <div>
                                    ...
                                    <select
                                        value={numPagas}
                                        onChange={(e) => setNumPagas(e.target.value)}
                                        className="calc-ret-select"
                                    >
                            ...
                            <div className="calc-ret-radio-group">
                                <label className="calc-ret-radio-option">
                                    ...
                                    <div className="calc-ret-radio-content">
                                        <span className="calc-ret-radio-label">
                                            Soltero/a, viudo/a, divorciado/a o separado/a sin hijos
                                            a cargo exclusivo; o casado/a con cónyuge con rentas
                                            superiores a 1.500 EUR/año
                                        </span>
                                        <span className="calc-ret-radio-help">
                                            La opción más común. Aplica si no tienes hijos a tu
                                            cargo exclusivo o tu cónyuge tiene ingresos propios.
                                        </span>
                                    </div>
                                </label>
                                <label className="calc-ret-radio-option">
                                    ...
                                    <div className="calc-ret-radio-content">
                                        <span className="calc-ret-radio-label">
                                            Soltero/a, viudo/a, divorciado/a o separado/a con hijos
                                            menores de 18 años que conviven exclusivamente contigo
                                        </span>
                                        <span className="calc-ret-radio-help">
                                            Custodia exclusiva de al menos un hijo. Los hijos deben
                                            vivir únicamente contigo.
                                        </span>
                                    </div>
                                </label>
                                <label className="calc-ret-radio-option">
                                    ...
                                    <div className="calc-ret-radio-content">
                                        <span className="calc-ret-radio-label">
                                            Casado/a y no separado/a legalmente, cónyuge sin rentas
                                            o con rentas inferiores a 1.500 EUR/año
                                        </span>
                                        <span className="calc-ret-radio-help">
                                            Tu cónyuge no trabaja o tiene ingresos muy bajos (menos
                                            de 1.500 EUR brutos anuales).
                                        </span>
                                    </div>
                                </label>
                            </div>
                            <p className="calc-ret-radio-footer">
                                <Info size={13} /> Según Modelo 145 de la AEAT
                            </p>
                            ...
                            <input
                                ...
                                min="0"
                            />
                            <p className="calc-ret-field-help">
                                Cheque restaurante, transporte, seguro médico, guardería (Edenred,
                                Sodexo, etc.). Importe exento anual.
                            </p>
                        </div>
                        ...
                        <div className="calc-ret-section">
                            <div className="calc-ret-section-header">
                                <h3>Hijos a cargo</h3>
                                <button onClick={addHijo} className="calc-ret-add-btn">
                                    <Plus size={16} /> Añadir hijo
                                </button>
                            </div>
                            ...
                            {descendientes.length === 0 && (
                                <p className="calc-ret-hint">Sin hijos a cargo</p>
                            )}
                        </div>
                            ...
                            <div className="calc-ret-section">
                                ...
                                <div className="calc-ret-checks">
                                    <label className="calc-ret-checkbox">
                                        <input
                                            type="checkbox"
                                            checked={ceutaMelilla}
                                            onChange={(e) => setCeutaMelilla(e.target.checked)}
                                        />
                                    ...
                                    <label className="calc-ret-checkbox">
                                        <input
                                            type="checkbox"
                                            checked={hipoteca}
                                            onChange={(e) => setHipoteca(e.target.checked)}
                                        />
                    ...
                    <div className="calc-ret-result">
                        {result ? (
                            <>
                                <div
                                    className={`calc-ret-big-number ${result.exento ? 'exento' : ''}`}
                                >
                                    <span className="calc-ret-percentage">
                                    ...
                                    <table className="calc-ret-table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{fmt(result.retribucion_bruta)} EUR</td>
                                            </tr>
                                            <tr>
                                                <td>Cotizaciones Seguridad Social</td>
                                                <td>-{fmt(result.cotizaciones_ss)} EUR</td>
                                            </tr>
                                            <tr>
                                                <td>Gastos deducibles totales</td>
                                                <td>-{fmt(result.gastos_deducibles)} EUR</td>
                                            </tr>
                                            <tr>
                                                <td>Rendimiento neto reducido</td>
                                                <td>{fmt(result.rendimiento_neto_reducido)} EUR</td>
                                            </tr>
                                            <tr>
                                                <td>Mínimo personal y familiar</td>
                                                <td>{fmt(result.minimo_personal_familiar)} EUR</td>
                                            </tr>
                                            <tr>
                                                <td>Base para retención</td>
                                                <td>{fmt(result.base_retencion)} EUR</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </details>
                                ...
                                <div className="calc-ret-cta">
                                    <p>
                                        ¿Te sale a devolver o a pagar en la renta? Hazlo con la Guía
                                        Fiscal.
                                    </p>
                                    <a href="/guia-fiscal" className="calc-ret-cta-btn">
                                        Ir a la Guía Fiscal
                                    </a>
                                </div>
                            </>
