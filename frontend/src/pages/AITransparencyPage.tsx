        ...
        <div className="legal-page">
            <div className="legal-container">
                ...
                <div className="alert alert-info">
                    <strong>
                        <AlertTriangle size={16} className="inline-icon" /> Lo que debes saber
                    </strong>
                    <p>
                        Impuestify responde a tus consultas mediante un sistema de IA. La IA se
                        equivoca y NO reemplaza al asesor fiscal.
                    </p>
                </div>
                ...
                <section>
                    ...
                    <p>
                        Impuestify es un asistente conversacional.{' '}
                        <strong>No toma decisiones automatizadas</strong>
                ...
                <section>
                    ...
                    <div className="two-column">
                        <div>
                            <h3>
                                <CheckCircle size={16} className="inline-icon" /> Sí puede
                            </h3>
                            <ul>
                        ...
                        <div>
                            <h3>
                                <XCircle size={16} className="inline-icon" /> No puede
                            </h3>
                            <ul>
                ...
                <section>
                    ...
                    <div className="alert alert-warning">
                        <strong>
                            <AlertTriangle size={16} className="inline-icon" /> Alucinaciones
                        </strong>
                        <p>La IA puede soltar un dato que suena impecable y resulta falso.</p>
                        <p>
                            <strong>Cómo lo mitigamos</strong>: RAG con fuentes documentadas, citas
                            y avisos visibles.
                        </p>
                    </div>
                    ...
                    <div className="alert alert-warning">
                        <strong>
                            <AlertTriangle size={16} className="inline-icon" /> Información caducada
                        </strong>
                        <p>La normativa fiscal cambia sin avisar.</p>
                        <p>
                            <strong>Cómo lo mitigamos</strong>: búsqueda web en tiempo real y fecha
                            visible en cada respuesta.
                        </p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <p className="highlight">
                        ...
                        <strong>Tú siempre debes</strong>:
                    </p>
                    <ul>
                ...
                <section>
                    ...
                    <p>
                        ...
                        <a href="mailto:report@impuestify.com">report@impuestify.com</a>
                    </p>
                </section>

                <div className="legal-cta">
                    <p>
                        Dudas sobre transparencia: escríbenos a{' '}
                        <a href="mailto:report@impuestify.com">report@impuestify.com</a>.
                    </p>
                </div>
            </div>
