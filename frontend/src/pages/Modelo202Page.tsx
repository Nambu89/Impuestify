...
export default function Modelo202Page() {
    ...
    useSEO({
        ...
        description:
            'Calcula los pagos fraccionados del Impuesto sobre Sociedades por el Art. 40.2 (sobre cuota del ejercicio anterior) o por el Art. 40.3 (sobre base imponible del ejercicio).',
    ...
    const canCalc =
        territorio &&
        (modalidad === 'art40_2' ? cuotaIntegra > 0 : bi3m > 0 || bi9m > 0 || bi11m > 0)
        ...
        <div className="m202-page">
            ...
            <div className="m202-container">
                ...
                <div className="m202-header">
                    ...
                    <p>
                        Estima los tres pagos a cuenta (abril, octubre y diciembre) bajo las
                        modalidades del Art. 40.2 y Art. 40.3 LIS.
                    </p>
                </div>

                <div className="m202-card">
                    <h2>
                        <Calculator size={18} /> Configuraci&oacute;n
                    </h2>
                    ...
                    {modalidad === 'art40_2' && (
                        <>
                            <div className="m202-field">
                                <label className="m202-field__label">
                                    Cuota &iacute;ntegra del &uacute;ltimo ejercicio
                                </label>
                                <div className="m202-field__input-wrap">
                                    <input
                                        ...
                                        value={cuotaIntegra || ''}
                                        onChange={(e) => {
                                            setCuotaIntegra(parseFloat(e.target.value) || 0)
                                            setCalculated(false)
                                        }}
                                        min={0}
                                        step={100}
                            ...
                            <div className="m202-field">
                                ...
                                <div className="m202-field__input-wrap">
                                    <input
                                        ...
                                        value={deducciones || ''}
                                        onChange={(e) => {
                                            setDeducciones(parseFloat(e.target.value) || 0)
                                            setCalculated(false)
                                        }}
                                        min={0}
                                        step={100}
                            ...
                            <div className="m202-field">
                                ...
                                <div className="m202-field__input-wrap">
                                    <input
                                        ...
                                        value={tipoGravamen || ''}
                                        onChange={(e) => {
                                            setTipoGravamen(parseFloat(e.target.value) || 0)
                                            setCalculated(false)
                                        }}
                                        min={0}
                                        max={100}
                                ...
                                <span className="m202-field__help">
                                    General: 25%. Pymes reducido: 23%. Nueva creaci&oacute;n: 15%.
                                </span>
                            </div>

                            <div className="m202-field">
                                <label className="m202-field__label">
                                    Base imponible acumulada 3 primeros meses
                                </label>
                                <div className="m202-field__input-wrap">
                                    <input
                                        type="number"
                                        ...
                                        value={bi3m || ''}
                                        onChange={(e) => {
                                            setBi3m(parseFloat(e.target.value) || 0)
                                            setCalculated(false)
                                        }}
                                        min={0}
                                        step={100}
                                ...
                                <span className="m202-field__help">
                                    Pago de abril (1P): base ene-mar
                                </span>
                            </div>

                            <div className="m202-field">
                                <label className="m202-field__label">
                                    Base imponible acumulada 9 primeros meses
                                </label>
                                <div className="m202-field__input-wrap">
                                    <input
                                        type="number"
                                        ...
                                        value={bi9m || ''}
                                        onChange={(e) => {
                                            setBi9m(parseFloat(e.target.value) || 0)
                                            setCalculated(false)
                                        }}
                                        min={0}
                                        step={100}
                                ...
                                <span className="m202-field__help">
                                    Pago de octubre (2P): base ene-sep
                                </span>
                            </div>

                            <div className="m202-field">
                                <label className="m202-field__label">
                                    Base imponible acumulada 11 primeros meses
                                </label>
                                <div className="m202-field__input-wrap">
                                    <input
                                        type="number"
                                        ...
                                        value={bi11m || ''}
                                        onChange={(e) => {
                                            setBi11m(parseFloat(e.target.value) || 0)
                                            setCalculated(false)
                                        }}
                                        min={0}
                                        step={100}
                                ...
                                <span className="m202-field__help">
                                    Pago de diciembre (3P): base ene-nov
                                </span>
                            </div>
                        </>
                    )}

                    <button className="m202-submit" onClick={handleCalc} disabled={!canCalc}>
                ...
                {calculated && modalidad === 'art40_2' && result40_2 && (
                    <div className="m202-result">
                        ...
                        <p className="m202-disclaimer">
                            Estimaci&oacute;n orientativa. Bajo el Art. 40.2 LIS los tres pagos son
                            iguales (18% sobre la base de c&aacute;lculo del &uacute;ltimo ejercicio
                            cerrado). Revisa los importes con tu asesor antes de presentar cada
                            modelo.
                        </p>
                    </div>
                )}
                ...
                {calculated && modalidad === 'art40_3' && result40_3 && (
                    <div className="m202-result">
                        ...
                        <div className="m202-result-row">
                            <span className="m202-result-label">
                                3P &mdash; Diciembre (ene-nov)
                            </span>
                        ...
                        <p className="m202-disclaimer">
                            Estimaci&oacute;n orientativa. Art. 40.3 LIS: porcentaje = 5/7 del tipo
                            de gravamen. Obligatorio para entidades con INCN &gt; 6M EUR en el
                            ejercicio anterior. Contrasta las bases acumuladas con tu asesor antes
                            de presentar cada pago.
                        </p>
                    </div>
                )}
            </div>
