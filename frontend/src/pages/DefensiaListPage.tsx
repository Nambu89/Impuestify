    ...
    return (
        <div className="defensia-list-page">
            ...
            <header className="defensia-list-header">
                ...
                <button type="button" className="defensia-list-crear-btn" onClick={handleCrear}>
            ...
            {!loading && !error && expedientes.length === 0 && (
                <div className="defensia-list-empty">
                    ...
                    <p>
                        Abre uno cuando recibas una comprobación, un requerimiento o una sanción de
                        Hacienda y quieras estudiar la respuesta.
                    </p>
                    <button type="button" className="defensia-list-crear-btn" onClick={handleCrear}>
                        <Plus size={18} aria-hidden="true" />
                        Crear expediente
