...
function regimeLabel(r: RegimenFiscal): string {
    switch (r) {
        case 'foral_vasco':
            return 'Régimen foral vasco'
        case 'foral_navarra':
            return 'Régimen foral Navarra'
        case 'ceuta_melilla':
            return 'Ceuta / Melilla (con deducción 60%)'
        case 'canarias':
            return 'Canarias (IGIC)'
        default:
...
export default function NetSalaryPage() {
    useSEO({
        ...
        description:
            'Calcula lo que te queda en la mano tras IRPF, IVA o IGIC y cuota de autónomos. Soporta régimen común, Canarias, Ceuta, Melilla y País Vasco.',
        canonical: '/calculadora-neto',
        keywords:
            'calculadora neto autónomo 2026, sueldo neto autónomo, cuota autónomo, IRPF autónomo, IVA autónomo',
        schema: [
            {
            ...
            },
            {
                ...
                itemListElement: [
                    ...
                    },
                    {
                        '@type': 'ListItem',
                        position: 2,
                        name: 'Calculadora Sueldo Neto Autónomo',
                        item: 'https://impuestify.com/calculadora-neto',
                    },
                ],
            },
        ],
    ...
    const indirectOptions =
        regime === 'canarias'
            ...
            : regime === 'ceuta_melilla'
              ...
              : IVA_OPTIONS
    const indirectName =
        regime === 'canarias' ? 'IGIC' : regime === 'ceuta_melilla' ? 'IPSI' : 'IVA'
    ...
    const handleCcaaChange = useCallback((value: string) => {
        ...
        setInput((prev) => ({
            ...
            tipo_iva:
                newRegime === deriveRegime(prev.comunidad_autonoma || '') ? prev.tipo_iva : null,
        }))
    }, [])
            ...
            <main className="ns-main">
                ...
                <div className="ns-hero">
                    ...
                    <p className="ns-subtitle">
                        Tu sueldo neto real de autónomo, calculado con la cuota que te toca este
                        año.
                    </p>
                </div>
                ...
                <div className={`ns-layout ${showResult ? 'ns-layout--split' : ''}`}>
                    ...
                    <section className="ns-inputs-panel">
                        ...
                        <div className="ns-field">
                            ...
                            {ccaa && (
                                <p className="ns-field-hint ns-field-hint--info">
                                    {regimeLabel(regime)} · Impuesto indirecto:{' '}
                                    <strong>{indirectName}</strong>
                                    {regime === 'foral_vasco' &&
                                        ' · escala foral 7 tramos (marginal 49%)'}
                                    {regime === 'foral_navarra' &&
                                        ' · escala foral 11 tramos (marginal 52,8%)'}
                                    {regime === 'ceuta_melilla' &&
                                        ' · deducción 60% sobre cuota IRPF'}
                                </p>
                            )}
                            {!ccaa && (
                                <p className="ns-field-hint">
                                    Selecciona tu CCAA para aplicar el IRPF correcto (común, foral,
                                    Canarias o Ceuta/Melilla).
                                </p>
                            )}
                        </div>
                                ...
                                <div className="ns-advanced-body">
                                    ...
                                    <div className="ns-field">
                                        ...
                                        <p className="ns-field-hint">
                                            ...
                                            {indirectName === 'IGIC' &&
                                                'Canarias — General 7% | Reducido 3% | Cero 0% | Incrementado 9,5% | Especial 13,5%'}
                                            {indirectName === 'IPSI' &&
                                                'Ceuta/Melilla — Servicios 4% (general) | Bienes 0,5% a 10% según producto'}
                                        </p>
                                    </div>
                                    ...
                                    <div className="ns-field">
                                        <label className="ns-toggle-label">
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    handleTarifaPlana(e.target.checked)
                                                }
                                            />
                                            <span className="ns-toggle-track" />
                                            <span className="ns-toggle-text">
                                                Tarifa plana de nuevo autónomo (80 EUR/mes)
                                            </span>
                                        </label>
                                        {input.tarifa_plana && (
                                            <p className="ns-field-hint ns-field-hint--info">
                                                Cuota fija de 80 EUR/mes durante 12 meses, ampliable
                                                a 24 si tus ingresos netos son inferiores al SMI.
                                                Requisitos: no haber sido autónomo en los 2 años
                                                anteriores y no ser autónomo societario (RDL
                                                13/2022).
                                            </p>
                                        )}
                                    </div>
                                    ...
                                    <div className="ns-field">
                                        ...
                                        />
                                        <p className="ns-field-hint">
                                            Material, suministros, vehículo, formación, etc.
                                        </p>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="ns-disclaimer">
                            <Info size={14} />
                            <span>
                                Estimación orientativa sobre IRPF general. Para el cálculo exacto
                                con tu CCAA y deducciones, usa la{' '}
                                <a href="/guia-fiscal" className="ns-link">
                                    Guía Fiscal
                                </a>
                                .
                            </span>
                                ...
                                <>
                                    ...
                                    <div className="ns-net-card">
                                        ...
                                        <div className="ns-net-annual">
                                            {formatEur(result.neto_anual)} EUR al año (tras IRPF, SS
                                            y gastos)
                                        </div>
                                        <div className="ns-net-pct">
                                            {formatPct(result.porcentaje_neto)}% de tu facturación
                                            bruta
                                        </div>
                                    </div>
                                    ...
                                    {result.regimen_fiscal && (
                                        <div className="ns-regime-chips">
                                            <span
                                                className={`ns-chip ns-chip--regime ns-chip--${result.regimen_fiscal}`}
                                            >
                                                <MapPin size={12} />
                                            ...
                                            {result.impuesto_indirecto && (
                                                <span className="ns-chip ns-chip--indirect">
                                                    {result.impuesto_indirecto}{' '}
                                                    {formatPct(result.tipo_impuesto_indirecto || 0)}
                                                    %
                                                </span>
                                            )}
                                            {result.deduccion_ceuta_melilla &&
                                                result.deduccion_ceuta_melilla > 0 && (
                                                    <span className="ns-chip ns-chip--deduction">
                                                        Deducción 60%: -
                                                        {formatEur(result.deduccion_ceuta_melilla)}{' '}
                                                        EUR/año
                                                    </span>
                                                )}
                                        </div>
                                    ...
                                    {result.ahorro_retencion_vs_irpf < 0 && (
                                        <div className="ns-reserve-warning">
                                            ...
                                            <span>
                                                ...
                                                <strong>
                                                    {formatEur(
                                                        Math.abs(result.ahorro_retencion_vs_irpf) /
                                                            12,
                                                    )}{' '}
                                                    EUR/mes
                                                </strong>{' '}
                                                para la declaración de la renta — tus retenciones no
                                                cubren el IRPF estimado.
                                            </span>
                                        </div>
                                    )}
                                    ...
                                    <div className="ns-breakdown-card">
                                        ...
                                        {result.iva_a_pagar_hacienda > 0 && (
                                            <BreakdownBar
                                                ...
                                                pct={
                                                    (result.iva_a_pagar_hacienda /
                                                        result.facturacion_bruta) *
                                                    100
                                                }
                                        ...
                                        <BreakdownBar
                                            ...
                                            pct={
                                                (result.cuota_autonomo / result.facturacion_bruta) *
                                                100
                                            }
                                    ...
                                    {result.ahorro_retencion_vs_irpf !== 0 && (
                                        <div
                                            className={`ns-info-card ${result.ahorro_retencion_vs_irpf > 0 ? 'ns-info-card--devolucion' : 'ns-info-card--pago'}`}
                                        >
                                            <Info size={16} />
                                            <div>
                                                <p>
                                                    ...
                                                    <strong>
                                                        {formatEur(
                                                            result.retencion_irpf_factura * 12,
                                                        )}{' '}
                                                        EUR al año
                                                    </strong>{' '}
                                                    a través de las retenciones de tus facturas,
                                                    pero tu IRPF real estimado es{' '}
                                                    <strong>
                                                        {formatEur(result.irpf_estimado_anual)} EUR
                                                    </strong>
                                                    .
                                                </p>
                                                {result.ahorro_retencion_vs_irpf > 0 ? (
                                                    <p className="ns-info-highlight ns-info-highlight--green">
                                                        Te devolverían aprox.{' '}
                                                        {formatEur(result.ahorro_retencion_vs_irpf)}{' '}
                                                        EUR en la declaración de la renta.
                                                    </p>
                                                ) : (
                                                    <p className="ns-info-highlight ns-info-highlight--red">
                                                        Tendrías que pagar aprox.{' '}
                                                        {formatEur(
                                                            Math.abs(
                                                                result.ahorro_retencion_vs_irpf,
                                                            ),
                                                        )}{' '}
                                                        EUR adicionales en la declaración de la
                                                        renta.
                                                    </p>
                                                )}
                                            </div>
