        ...
        return (
            <div className="shared-page">
                <div className="shared-error">
                    ...
                    <a href="/" className="shared-cta-btn">
                        Ir a Impuestify
                    </a>
                </div>
            </div>
        ...
        <div className="shared-page">
            <div className="shared-container">
                ...
                <div className="shared-header">
                    ...
                    <a href="/register" className="shared-cta-btn-sm">
                        Prueba Impuestify
                    </a>
                </div>
                ...
                <div className="shared-meta">
                    <span>
                        <Eye size={14} /> {data.view_count} visualizaciones
                    </span>
                ...
                <div className="shared-cta">
                    ...
                    <p>
                        Impuestify es tu asistente fiscal con IA. Cubre los 21 territorios de
                        España.
                    </p>
                    <a href="/register" className="shared-cta-btn">
                        Empieza a usar Impuestify
                    </a>
                </div>
                ...
                <div className="shared-footer">
                    <p>
                        Conversación compartida por un usuario de Impuestify. La información es
                        orientativa.
                    </p>
                </div>
            </div>
