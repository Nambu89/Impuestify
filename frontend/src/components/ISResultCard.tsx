    ...
    return (
        <div className="is-result">
            <div className="is-result__header">
                ...
                <div className="is-result__regime">{result.territorio}</div>
                <span className="is-result__regime-badge">{result.regimen}</span>
            </div>
            ...
            <div className="is-result__lines">
                ...
                <div className="is-result__line">
                    ...
                    <span className="is-result__line-amount">
                        {fmtEur(result.resultado_contable)}
                    </span>
                </div>
                ...
                <div className="is-result__line">
                    ...
                    <span className="is-result__line-amount">
                        {fmtEur(result.ajustes_positivos)}
                    </span>
                </div>
                <div className="is-result__line">
                    <span className="is-result__line-label">
                    ...
                    <span className="is-result__line-amount">
                        -{fmtEur(result.ajustes_negativos)}
                    </span>
                </div>
                ...
                <div className="is-result__line is-result__line--separator">
                    ...
                    <span className="is-result__line-amount">
                        {fmtEur(result.base_imponible_previa)}
                    </span>
                </div>
                ...
                {result.compensacion_bins > 0 && (
                    <div className="is-result__line is-result__line--sub">
                        ...
                        <span className="is-result__line-amount">
                            -{fmtEur(result.compensacion_bins)}
                        </span>
                    </div>
                )}
                ...
                {result.deducciones_total > 0 && (
                    <>
                        <div className="is-result__line">
                            ...
                            <span className="is-result__line-amount">
                                -{fmtEur(result.deducciones_total)}
                            </span>
                        </div>
                        {result.deducciones_detalle.id > 0 && (
                            <div className="is-result__line is-result__line--sub">
                                ...
                                <span className="is-result__line-amount">
                                    {fmtEur(result.deducciones_detalle.id)}
                                </span>
                            </div>
                        )}
                        {result.deducciones_detalle.it > 0 && (
                            <div className="is-result__line is-result__line--sub">
                                <span className="is-result__line-label">
                                    Innovaci&oacute;n tecnol&oacute;gica
                                </span>
                                <span className="is-result__line-amount">
                                    {fmtEur(result.deducciones_detalle.it)}
                                </span>
                            </div>
                        )}
                        {result.deducciones_detalle.reserva_capitalizacion > 0 && (
                            <div className="is-result__line is-result__line--sub">
                                <span className="is-result__line-label">
                                    Reserva capitalizaci&oacute;n
                                </span>
                                <span className="is-result__line-amount">
                                    {fmtEur(result.deducciones_detalle.reserva_capitalizacion)}
                                </span>
                            </div>
                        )}
                        {result.deducciones_detalle.donativos > 0 && (
                            <div className="is-result__line is-result__line--sub">
                                ...
                                <span className="is-result__line-amount">
                                    {fmtEur(result.deducciones_detalle.donativos)}
                                </span>
                            </div>
                        )}
                        {result.deducciones_detalle.empleo_discapacidad > 0 && (
                            <div className="is-result__line is-result__line--sub">
                                ...
                                <span className="is-result__line-amount">
                                    {fmtEur(result.deducciones_detalle.empleo_discapacidad)}
                                </span>
                            </div>
                        )}
                        {result.deducciones_detalle.ric > 0 && (
                            <div className="is-result__line is-result__line--sub">
                                ...
                                <span className="is-result__line-amount">
                                    {fmtEur(result.deducciones_detalle.ric)}
                                </span>
                            </div>
                        )}
                    </>
                ...
                {result.bonificaciones_total > 0 && (
                    <div className="is-result__line">
                        ...
                        <span className="is-result__line-amount">
                            -{fmtEur(result.bonificaciones_total)}
                        </span>
                    </div>
                )}
                ...
                {result.pagos_fraccionados > 0 && (
                    <div className="is-result__line">
                        ...
                        <span className="is-result__line-amount">
                            -{fmtEur(result.pagos_fraccionados)}
                        </span>
                    </div>
                )}
            ...
            {result.bin_generada > 0 && (
                <div
                    className="is-result__line is-result__line--sub"
                    style={{ paddingTop: '0.5rem' }}
                >
                    <span className="is-result__line-label">
                        BIN generada (compensable en ejercicios futuros)
                    </span>
                ...
                <div className="is-result__pagos202">
                    ...
                    {result.pago_fraccionado_202_art40_2 !== null && (
                        <div className="is-result__pagos202-item">
                            <span className="is-result__pagos202-label">
                                Art. 40.2 (sobre cuota): cada pago
                            </span>
                            <span className="is-result__pagos202-amount">
                                {fmtEur(result.pago_fraccionado_202_art40_2)}
                            </span>
                        </div>
                    )}
                    {result.pago_fraccionado_202_art40_3 !== null && (
                        <div className="is-result__pagos202-item">
                            <span className="is-result__pagos202-label">
                                Art. 40.3 (sobre base): cada pago
                            </span>
                            <span className="is-result__pagos202-amount">
                                {fmtEur(result.pago_fraccionado_202_art40_3)}
                            </span>
                        </div>
                    )}
                    <div
                        className="is-result__pagos202-item"
                        style={{ opacity: 0.5, fontSize: '0.78rem' }}
                    >
                        <span className="is-result__pagos202-label">
                            Plazos: abril, octubre, diciembre
                        </span>
                        <span />
                    </div>
                </div>
            ...
            {/* Disclaimer */}
            <div className="is-result__disclaimer">{result.disclaimer}</div>
        </div>
    )
}
