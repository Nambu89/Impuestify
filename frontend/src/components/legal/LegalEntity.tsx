...
export function LegalEntity({ title, asDataController = false }: Props) {
    ...
    return (
        <section>
            <h2>{sectionTitle}</h2>
            <p>
                En cumplimiento del art&iacute;culo 10 de la Ley 34/2002, de 11 de julio, de
                Servicios de la Sociedad de la Informaci&oacute;n y de Comercio Electr&oacute;nico
                (LSSI-CE), y del art&iacute;culo 13 del Reglamento (UE) 2016/679 (RGPD), se informa
                al usuario de los siguientes datos identificativos del titular del servicio
            ...
            <ul>
                ...
                <li>
                    <strong>Domicilio:</strong> {LEGAL_ENTITY.address}, {LEGAL_ENTITY.cityProvince}{' '}
                    ({LEGAL_ENTITY.pais})
                </li>
                <li>
