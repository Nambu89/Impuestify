        ...
        <div className="pre-export-backdrop" role="dialog" aria-modal="true">
            <div className="pre-export-modal">
                ...
                <div className="pre-export-body">
                    <div className="pre-export-warning">
                        ...
                        <div>
                            ...
                            <p>
                                El escrito que genera DefensIA es orientativo: se apoya en reglas
                                fiscales deterministas y jurisprudencia verificada, pero{' '}
                                <strong>no sustituye asesoramiento profesional</strong>. Antes de
                                presentarlo ante la Administración tributaria, revísalo con un
                                asesor fiscal o con un abogado colegiado.
                            </p>
                        </div>
                    </div>
                ...
                <footer className="pre-export-footer">
                    <button type="button" className="pre-export-cancel" onClick={onClose}>
                        Cancelar
                    </button>
                    <button
                        type="button"
