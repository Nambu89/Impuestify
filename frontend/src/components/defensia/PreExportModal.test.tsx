...
describe('PreExportModal', () => {
    it('checkbox inicialmente unchecked y botón exportar disabled', () => {
        render(
            <PreExportModal open={true} formato="docx" onClose={() => {}} onConfirm={() => {}} />,
        )
    ...
    it('marcar el checkbox habilita el botón exportar', async () => {
        render(<PreExportModal open={true} formato="pdf" onClose={() => {}} onConfirm={() => {}} />)
    ...
    it('click en exportar llama onConfirm con disclaimer=true', async () => {
        ...
        render(
            <PreExportModal open={true} formato="docx" onClose={() => {}} onConfirm={onConfirm} />,
        )
        await userEvent.click(screen.getByRole('checkbox'))
    ...
    it("contiene el texto 'aviso legal' con tildes", () => {
        ...
        expect(screen.getByText(/he leído y entendido/i)).toBeInTheDocument()
    })

    it('cuando open=false no renderiza', () => {
        const { container } = render(
            <PreExportModal open={false} formato="docx" onClose={() => {}} onConfirm={() => {}} />,
        )
