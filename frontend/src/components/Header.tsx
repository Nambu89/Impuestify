                    ...
                    <nav className="nav">
                        ...
                        >
                            ...
                            >
                                ...
                                <ChevronDown
                                    size={14}
                                    className={`nav-chevron${toolsOpen ? ' nav-chevron--up' : ''}`}
                                />
                            </button>
                            <div
                                className="nav-dropdown__menu nav-dropdown__menu--tools"
                                role="menu"
                            >
                                <Link
                                    to="/guia-fiscal"
                        ...
                        {isOwner && (
                            <div className="nav-dropdown">
                                ...
                                <div className="nav-dropdown__menu" role="menu">
                                    ...
                                    <Link to="/admin/users" className="nav-dropdown__item">
                                        Usuarios
                                    </Link>
                                    <Link to="/admin/feedback" className="nav-dropdown__item">
                                        Feedback
                                    </Link>
                                    <Link to="/admin/contact" className="nav-dropdown__item">
                                        Contacto
                                    </Link>
                                    <Link to="/admin/rag-quality" className="nav-dropdown__item">
                                        Calidad RAG
                                    </Link>
                                </div>
                            </div>
            ...
            {mobileMenuOpen && (
                <div className="mobile-nav-overlay" onClick={() => setMobileMenuOpen(false)}>
                    <nav className="mobile-nav" onClick={(e) => e.stopPropagation()}>
                        ...
                        >
                            <span className="mobile-nav__group-label">
                                <Calculator size={20} /> Herramientas
                            </span>
                            <ChevronDown
                                size={18}
                                className={mobileToolsOpen ? 'mobile-nav__chevron--up' : ''}
                            />
                        </button>
                        {mobileToolsOpen && (
