                ...
                <div className="app">
                    <Suspense fallback={<div className="loading-screen">Cargando...</div>}>
                        <Routes>
                            ...
                            <Route
                                path="/modelos-obligatorios"
                                element={<ModelObligationsPage />}
                            />
                            ...
                            />
                            <Route
                                path="/calculadora-umbrales"
                                element={<CalculadoraUmbralesPage />}
                            />
                            ...
                            />
                            <Route
                                path="/calculadora-modelo-131"
                                element={<M131CalculatorPage />}
                            />
                            <Route
                                path="/calculadora-modelo-309"
                                element={<M309CalculatorPage />}
                            />
                            <Route
