...
class TestAuthEndpoints:
    ...
    def test_login_request_format(self):
        ...
        valid_request = {"email": "test@example.com", "password": "SecurePass123"}
    ...
    def test_refresh_request_format(self):
        ...
        valid_request = {"refresh_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."}
...
class TestResponseFormats:
    ...
    def test_auth_response_structure(self):
        ...
        expected_structure = {
            "user": {"id": str, "email": str, "name": str, "is_active": bool},
            "tokens": {
                "access_token": str,
                "refresh_token": str,
                "token_type": str,
