...
class TestComplexityRouterSimple:
    ...
    def test_complexity_classification(self):
        ...
        # Complex query
        complex_result = classify_complexity(
...
class TestAuditLoggerSimple:
    ...
    def test_audit_logger_basic(self):
        ...
        logger.log_login_success(user_id="test-user", ip_address="127.0.0.1")

        logger.log_ai_query(
            user_id="test-user", query_preview="Test query about IVA", ip_address="127.0.0.1"
        )
