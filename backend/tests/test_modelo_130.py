...
async def test_comun_with_retenciones_and_pagos(calc):
    ...
    r = await calc.calculate(
        ...
        retenciones_acumuladas=2000,
        pagos_anteriores=3000,
...
async def test_gipuzkoa_excepcional(calc):
    ...
    r = await calc.calculate(
        ...
        quarter=2,
        regimen="excepcional",
        volumen_operaciones_trimestre=15000,
        retenciones_trimestre_gipuzkoa=50,
    )
...
async def test_bizkaia_excepcional_3rd_year(calc):
    ...
    r = await calc.calculate(
        ...
        anos_actividad=4,
        regimen="excepcional",
        volumen_ventas_penultimo=80000,
...
async def test_navarra_segunda_q2(calc):
    ...
    r = await calc.calculate(
        ...
        quarter=2,
        modalidad="segunda",
        ingresos_acumulados=16000,
        gastos_acumulados=6000,
        retenciones_acumuladas_navarra=500,
        pagos_anteriores_navarra=200,
    )
    rn = 10000
