...
_PATRONES: list[tuple[TipoDocumento, list[re.Pattern]]] = [
    (
        ...
        [
            re.compile(
                r"notificaci[óo]n\s+de\s+resoluci[óo]n\s+con\s+liquidaci[óo]n\s+provisional", re.I
            ),
    ...
    (
        ...
        [
            re.compile(
                r"resoluci[óo]n\s+del\s+tribunal\s+econ[óo]mico[\s\-]administrativo\s+central", re.I
            ),
        ],
    ),
    (
