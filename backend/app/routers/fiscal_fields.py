...
_BASE_SECTIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "fields": [
            {
                "key": "ingresos_trabajo",
                "label": "Ingresos brutos del trabajo (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "ss_empleado",
                "label": "Cotización SS empleado (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "retenciones_trabajo",
                "label": "Retenciones IRPF trabajo (EUR/año)",
                "type": "float",
                "required": False,
            },
        ],
    },
    {
        ...
        "fields": [
            {
                "key": "intereses",
                "label": "Intereses cuentas/depósitos (EUR)",
                "type": "float",
                "required": False,
            },
            {"key": "dividendos", "label": "Dividendos (EUR)", "type": "float", "required": False},
            {
                "key": "ganancias_fondos",
                "label": "Ganancias patrimoniales fondos/acciones (EUR)",
                "type": "float",
                "required": False,
            },
            {
                "key": "retenciones_ahorro",
                "label": "Retenciones sobre ahorro (EUR)",
                "type": "float",
                "required": False,
            },
        ],
    },
    {
        ...
        "fields": [
            {
                "key": "ingresos_alquiler",
                "label": "Ingresos por alquiler (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "valor_adquisicion_inmueble",
                "label": "Valor de adquisición del inmueble (EUR)",
                "type": "float",
                "required": False,
            },
            {
                "key": "retenciones_alquiler",
                "label": "Retenciones sobre alquiler (EUR)",
                "type": "float",
                "required": False,
            },
        ],
        ...
        "fields": [
            {
                ...
                "label": "Número de descendientes a cargo",
                "type": "int",
                "required": False,
            },
            {
                "key": "anios_nacimiento_desc",
                "label": "Años de nacimiento de los descendientes",
                "type": "list_int",
                "required": False,
            },
            {
                "key": "custodia_compartida",
                "label": "Custodia compartida",
                "type": "bool",
                "required": False,
            },
            {
                "key": "num_ascendientes_65",
                "label": "Ascendientes mayores de 65 años a cargo",
                "type": "int",
                "required": False,
            },
            {
                "key": "num_ascendientes_75",
                "label": "Ascendientes mayores de 75 años a cargo",
                "type": "int",
                "required": False,
            },
            {
                "key": "discapacidad_contribuyente",
                "label": "Grado de discapacidad del contribuyente (%)",
                "type": "int",
                "required": False,
            },
            {
            ...
            },
            {
                ...
                "label": "Nacimiento o adopción en el último año",
                "type": "bool",
                "required": False,
            },
            {
                "key": "adopcion_internacional",
                "label": "Adopción internacional",
                "type": "bool",
                "required": False,
            },
            {
                "key": "acogimiento_familiar",
                "label": "Acogimiento familiar",
                "type": "bool",
                "required": False,
            },
            {
            ...
            },
            {
                ...
                "label": "Hijos en edad escolar (3-16 años)",
                "type": "bool",
                "required": False,
            },
            {
                "key": "gastos_guarderia",
                "label": "Gastos de guardería o centro de educación infantil",
                "type": "bool",
                "required": False,
            },
            {
                "key": "ambos_progenitores_trabajan",
                "label": "Ambos progenitores trabajan y cotizan a SS",
                "type": "bool",
                "required": False,
            },
            {
                "key": "hijos_estudios_universitarios",
                "label": "Hijos cursando estudios universitarios",
                "type": "bool",
                "required": False,
            },
        ],
        ...
        "fields": [
            {
                ...
                "label": "Descendiente con discapacidad >= 33%",
                "type": "bool",
                "required": False,
            },
            {
                "key": "ascendiente_discapacidad",
                "label": "Ascendiente con discapacidad >= 33%",
                "type": "bool",
                "required": False,
            },
            {
                "key": "ascendiente_a_cargo",
                "label": "Ascendiente a cargo del contribuyente",
                "type": "bool",
                "required": False,
            },
            {
                "key": "familiar_discapacitado_cargo",
                "label": "Familiar discapacitado a cargo (no descendiente/ascendiente)",
                "type": "bool",
                "required": False,
            },
            {
                "key": "empleada_hogar_cuidado",
                "label": "Empleada del hogar para cuidado de familiar",
                "type": "bool",
                "required": False,
            },
        ],
    },
    {
        ...
        "fields": [
            {
                "key": "aportaciones_plan_pensiones",
                "label": "Aportaciones propias a plan de pensiones (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "aportaciones_plan_pensiones_empresa",
                "label": "Aportaciones empresa a plan de pensiones (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "hipoteca_pre2013",
                "label": "Hipoteca sobre vivienda habitual adquirida antes de 2013",
                "type": "bool",
                "required": False,
            },
            {
                "key": "capital_amortizado_hipoteca",
                "label": "Capital amortizado hipoteca (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "intereses_hipoteca",
                "label": "Intereses hipoteca pagados (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "madre_trabajadora_ss",
                "label": "Madre trabajadora dada de alta en SS",
                "type": "bool",
                "required": False,
            },
            {
                "key": "gastos_guarderia_anual",
                "label": "Gastos guardería o educación infantil (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "donativos_ley_49_2002",
                "label": "Donativos a entidades Ley 49/2002 (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "donativo_recurrente",
                "label": "Donativo recurrente (mismo organismo 3+ años)",
                "type": "bool",
                "required": False,
            },
        ],
        ...
        "fields": [
            {
                ...
                "label": "Paga alquiler por vivienda habitual",
                "type": "bool",
                "required": False,
            },
            {
                "key": "importe_alquiler_anual",
                "label": "Importe anual del alquiler (EUR)",
                "type": "float",
                "required": False,
            },
            {
                "key": "vivienda_habitual_propiedad",
                "label": "Vivienda habitual en propiedad",
                "type": "bool",
                "required": False,
            },
            {
                "key": "rehabilitacion_vivienda",
                "label": "Obras de rehabilitación de vivienda habitual",
                "type": "bool",
                "required": False,
            },
            {
                "key": "vivienda_rural",
                "label": "Vivienda en municipio rural o en riesgo de despoblación",
                "type": "bool",
                "required": False,
            },
            {
                "key": "dacion_pago_alquiler",
                "label": "Dación en pago o alquiler social por impago hipoteca",
                "type": "bool",
                "required": False,
            },
            {
                "key": "arrendador_vivienda_social",
                "label": "Arrendador de vivienda social o a precio reducido",
                "type": "bool",
                "required": False,
            },
        ],
        ...
        "fields": [
            {
                ...
                "label": "Adquisición de vehículo eléctrico nuevo",
                "type": "bool",
                "required": False,
            },
            {
                "key": "obras_mejora_energetica",
                "label": "Obras de mejora de eficiencia energética en vivienda",
                "type": "bool",
                "required": False,
            },
            {
                "key": "instalacion_renovable",
                "label": "Instalación de paneles solares u otras energías renovables",
                "type": "bool",
                "required": False,
            },
        ],
    },
    {
        ...
        "fields": [
            {
                "key": "donativo_entidad_autonomica",
                "label": "Donativo a entidad declarada de interés autonómico",
                "type": "bool",
                "required": False,
            },
            {
                "key": "donativo_investigacion",
                "label": "Donativo a entidades de investigación o innovación",
                "type": "bool",
                "required": False,
            },
            {
                "key": "donativo_patrimonio",
                "label": "Donativo de bienes al patrimonio histórico artístico",
                "type": "bool",
                "required": False,
            },
            {
                "key": "donativo_fundacion_local",
                "label": "Donativo a fundación o asociación local declarada de interés general",
                "type": "bool",
                "required": False,
            },
        ],
        ...
        "fields": [
            {
                ...
                "label": "Reside en municipio en riesgo de despoblación",
                "type": "bool",
                "required": False,
            },
            {
                "key": "inversion_empresa_nueva",
                "label": "Ha invertido en empresa de nueva creación",
                "type": "bool",
                "required": False,
            },
        ],
    },
    {
        ...
        "fields": [
            {
                "key": "tiene_criptomonedas",
                "label": "¿Has transmitido monedas virtuales en el ejercicio?",
                "type": "bool",
                "required": False,
            },
            {
                "key": "cripto_denominaciones",
                "label": "Monedas virtuales transmitidas (BTC, ETH, SOL...)",
                "type": "str",
                "required": False,
                "hint": "Casilla 1802 — Denominación de la moneda virtual",
            },
            {
                "key": "cripto_clave_contraprestacion",
                "label": "Tipo de contraprestación recibida",
                "type": "select",
                "options": ["F", "N", "O", "B"],
                "option_labels": [
                    "Moneda de curso legal (EUR, USD...)",
                    "Otra moneda virtual (cripto a cripto)",
                    "Otro activo virtual (NFT, token)",
                    "Bienes o servicios",
                ],
                "required": False,
                "hint": "Casilla 1803",
            ...
            {
                "key": "cripto_valor_transmision_total",
                "label": "Valor total de transmisión (EUR)",
                "type": "float",
                "required": False,
                "hint": "Suma casilla 1804",
            },
            {
                "key": "cripto_valor_adquisicion_total",
                "label": "Valor total de adquisición (EUR)",
                "type": "float",
                "required": False,
                "hint": "Suma casilla 1806",
            },
            {
                "key": "cripto_ganancia_neta",
                "label": "Ganancia patrimonial neta por criptomonedas (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 1814 — suma ganancias",
            },
            {
                "key": "cripto_perdida_neta",
                "label": "Pérdida patrimonial neta por criptomonedas (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 1813 — suma pérdidas",
            },
            {
                "key": "cripto_en_extranjero_50k",
                "label": "¿Tienes saldo en exchanges extranjeros > 50.000 EUR al 31/dic?",
                "type": "bool",
                "required": False,
                "hint": "Obligación Modelo 721",
            },
            {
                "key": "tiene_staking_defi",
                "label": "¿Tienes ingresos por staking, DeFi, lending o minería?",
                "type": "bool",
                "required": False,
                "hint": "Sin casilla propia — tributa como rendimiento de capital mobiliario o actividad económica",
            },
            {
                "key": "exchanges_utilizados",
                "label": "Exchanges utilizados (Binance, Coinbase...)",
                "type": "str",
                "required": False,
            },
        ],
    },
    {
        ...
        "fields": [
            ...
            {
                "key": "tiene_ganancias_juegos_privados",
                "label": "¿Has tenido premios en juegos, apuestas o concursos?",
                "type": "bool",
                "required": False,
                "hint": "Casillas 0281-0290 — Juegos no organizados por el Estado",
            },
            {
                "key": "premios_metalico_privados",
                "label": "Premios en metálico de juegos/apuestas (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 0282",
            },
            {
                "key": "premios_especie_privados",
                "label": "Premios en especie — valoración (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 0283",
            },
            {
                "key": "perdidas_juegos_privados",
                "label": "Pérdidas patrimoniales en juegos/apuestas (EUR)",
                "type": "float",
                "required": False,
            ...
            {
                "key": "tiene_premios_loterias",
                "label": "¿Has tenido premios de loterías del Estado, ONCE o Cruz Roja?",
                "type": "bool",
                "required": False,
                "hint": "Casillas 0291-0297 — Juegos organizados por organismos públicos",
            },
            {
                "key": "premios_metalico_publicos",
                "label": "Premios en metálico de loterías públicas (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 0292 — exentos los primeros 40.000 EUR",
            },
            {
                "key": "premios_especie_publicos",
                "label": "Premios en especie de loterías públicas — valoración (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 0293",
            },
    ...
    },
    {
        ...
        "fields": [
            ...
            {
                "key": "tiene_fondos_inversion",
                "label": "¿Has reembolsado participaciones en fondos de inversión?",
                "type": "bool",
                "required": False,
                "hint": "Casillas 0316-0320",
            },
            {
                "key": "ganancias_reembolso_fondos",
                "label": "Ganancias por reembolso de fondos (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 0320 — ganancia patrimonial",
            },
            {
                "key": "perdidas_reembolso_fondos",
                "label": "Pérdidas por reembolso de fondos (EUR)",
                "type": "float",
                "required": False,
            },
            ...
            {
                "key": "tiene_acciones",
                "label": "¿Has vendido acciones o participaciones?",
                "type": "bool",
                "required": False,
                "hint": "Casillas 0332-0339",
            },
            {
                "key": "ganancias_acciones",
                "label": "Ganancias por venta de acciones (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 0338",
            },
            {
                "key": "perdidas_acciones",
                "label": "Pérdidas por venta de acciones (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 0339",
            },
            ...
            {
                "key": "tiene_derivados",
                "label": "¿Has operado con derivados, CFDs o Forex?",
                "type": "bool",
                "required": False,
                "hint": "Casillas 0347-0354 — Derechos y participaciones",
            },
            {
                "key": "ganancias_derivados",
                "label": "Ganancias por derivados/CFDs/Forex (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 0353",
            },
            {
                "key": "perdidas_derivados",
                "label": "Pérdidas por derivados/CFDs/Forex (EUR)",
                "type": "float",
                "required": False,
                "hint": "Casilla 0354",
            },
...
def _section_actividad_economica() -> Dict[str, Any]:
    return {
        ...
        "fields": [
            {
                "key": "epigrafe_iae",
                "label": "Epígrafe IAE de la actividad",
                "type": "str",
                "required": False,
            },
            {
            ...
            {
                "key": "fecha_alta_autonomo",
                "label": "Fecha de alta como autónomo",
                "type": "date",
                "required": False,
            },
            {
                "key": "metodo_estimacion_irpf",
                "label": "Método de estimación IRPF",
                "type": "select",
            ...
            {
                "key": "rendimientos_netos_mensuales",
                "label": "Rendimientos netos mensuales estimados (EUR)",
                "type": "float",
                "required": False,
            },
            {
                "key": "base_cotizacion_reta",
                "label": "Base de cotización RETA (EUR/mes)",
                "type": "float",
                "required": False,
            },
            {
                "key": "tipo_retencion_facturas",
                "label": "Tipo de retención en facturas (%)",
                "type": "select",
                "options": ["15", "7", "1", "2"],
                "option_labels": [
                    "15% (general)",
            ...
            {
                "key": "tarifa_plana",
                "label": "Acogido a tarifa plana de autónomos",
                "type": "bool",
                "required": False,
            },
            {
                "key": "pluriactividad",
                "label": "Pluriactividad (autónomo + por cuenta ajena)",
                "type": "bool",
                "required": False,
            },
        ],
...
def _section_foral_vasco() -> Dict[str, Any]:
    return {
        ...
        "fields": [
            {
                "key": "epsv_aportaciones",
                "label": "Aportaciones a EPSV (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
                "key": "pension_viudedad",
                "label": "Percibe pensión de viudedad",
                "type": "bool",
                "required": False,
            },
            {
                "key": "reduccion_jornada_cuidado",
                "label": "Reducción de jornada por cuidado de familiar",
                "type": "bool",
                "required": False,
            },
            {
                "key": "cuenta_vivienda_aportaciones",
                "label": "Aportaciones a cuenta vivienda foral (EUR/año)",
                "type": "float",
                "required": False,
            },
        ],
...
def _section_foral_navarra() -> Dict[str, Any]:
    return {
        ...
        "fields": [
            {
                "key": "epsv_aportaciones",
                "label": "Aportaciones a planes de previsión social navarros (EUR/año)",
                "type": "float",
                "required": False,
            },
            {
            ...
            {
                "key": "reduccion_jornada_cuidado",
                "label": "Reducción de jornada por cuidado (Art. 64 TRIRPFN)",
                "type": "bool",
                "required": False,
            },
        ],
...
def _section_ceuta_melilla() -> Dict[str, Any]:
    return {
        ...
        "fields": [
            {
                "key": "ceuta_melilla",
                "label": "Residente fiscal en Ceuta o Melilla (deducción 60% cuota IRPF)",
                "type": "bool",
                "required": False,
            },
            {
                "key": "regimen_iva",
                "label": "Tipo impositivo IPSI aplicable",
                "type": "select",
...
async def _build_deducciones_section(ccaa: str, db: TursoClient) -> Optional[Dict[str, Any]]:
    ...
    for row in result.rows:
        ...
        if questions_raw:
            try:
                questions = (
                    json.loads(questions_raw) if isinstance(questions_raw, str) else questions_raw
                )
...
async def get_fiscal_profile_fields(
    ...
    situacion_laboral: str = Query(
        default="", description="situacion_laboral del perfil: empleado|autonomo|..."
    ),
