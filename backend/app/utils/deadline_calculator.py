...
class DeadlineCalculator:
    ...
    REGIONAL_HOLIDAYS = {
        ...
        "aragón": {"2024": ["2024-04-23", "2024-10-12"], "2025": ["2025-04-23", "2025-10-12"]},
    ...
    def calculate_calendar_days(self, start_date: str, num_days: int) -> str:
        """
    ...
    def calculate_months(self, start_date: str, num_months: int) -> str:
        """
