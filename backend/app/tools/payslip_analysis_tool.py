...
PAYSLIP_ANALYSIS_TOOL = {
    ...
    "function": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "gross_salary": {"type": "number", "description": "Salario bruto mensual en euros"},
                "net_salary": {"type": "number", "description": "Salario neto mensual en euros"},
                "irpf_withholding": {"type": "number", "description": "Retención de IRPF en euros"},
                "ss_contribution": {
                    "type": "number",
                    "description": "Cotización a la Seguridad Social del trabajador en euros",
                },
                "period_month": {"type": "integer", "description": "Mes de la nómina (1-12)"},
                "period_year": {"type": "integer", "description": "Año de la nómina"},
            },
            "required": [
                "gross_salary",
                "net_salary",
