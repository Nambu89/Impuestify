...
INVOICES = {
    ...
    "factura_emitida_005_marzo.pdf": {
        ...
        "emisor_nombre": "Carlos Martinez Lopez",
        "emisor_nif": "12345678A",
        "receptor_nombre": "StartupFlow SL",
        "receptor_nif": "B99887766",
        "concepto": "Desarrollo MVP aplicacion movil",
        "base_imponible": 6000.00,
        "tipo_iva": 21,
        "cuota_iva": 1260.00,
        "retencion_irpf_pct": 15,
        "retencion_irpf": 900.00,
        "total": 6360.00,
        "cuenta_pgc": "705",
        "cuenta_pgc_nombre": "Prestaciones de servicios",
    },
    ...
    "factura_recibida_001_coworking.pdf": {
        ...
        "numero": "CW-2025-0142",
        "fecha": "2025-01-01",
        "emisor_nombre": "CoWork Madrid SL",
        "emisor_nif": "B11223344",
        "receptor_nombre": "Carlos Martinez Lopez",
        ...
        "total": 574.75,
        "cuenta_pgc": "621",
        "cuenta_pgc_nombre": "Arrendamientos y canones",
    },
    "factura_recibida_002_hosting.pdf": {
        "tipo": "recibida",
        "numero": "AWS-ES-2025-001",
        "fecha": "2025-01-31",
        "emisor_nombre": "Amazon Web Services EMEA SARL",
        "emisor_nif": "N0013649J",
        "receptor_nombre": "Carlos Martinez Lopez",
        "receptor_nif": "12345678A",
    ...
    "factura_recibida_003_software.pdf": {
        ...
        "fecha": "2025-02-15",
        "emisor_nombre": "JetBrains s.r.o.",
        "emisor_nif": "EU826000337",
        "receptor_nombre": "Carlos Martinez Lopez",
        "receptor_nif": "12345678A",
    ...
    "factura_recibida_004_telefono.pdf": {
        ...
        "fecha": "2025-02-28",
        "emisor_nombre": "Telefonica Moviles Espana SA",
        "emisor_nif": "A78923125",
        "receptor_nombre": "Carlos Martinez Lopez",
        "receptor_nif": "12345678A",
    ...
    "factura_recibida_005_seguro_rc.pdf": {
        ...
        "fecha": "2025-03-01",
        "emisor_nombre": "Mapfre Seguros SA",
        "emisor_nif": "A28141935",
        "receptor_nombre": "Carlos Martinez Lopez",
        "receptor_nif": "12345678A",
        ...
        "total": 180.00,
        "cuenta_pgc": "625",
        "cuenta_pgc_nombre": "Primas de seguros",
    },
    "factura_recibida_006_material.pdf": {
        "tipo": "recibida",
        "numero": "PC-2025-0089",
        "fecha": "2025-03-20",
        "emisor_nombre": "PcComponentes y Multimedia SLU",
        "emisor_nif": "B73347494",
        "receptor_nombre": "Carlos Martinez Lopez",
        "receptor_nif": "12345678A",
        ...
        "total": 794.97,
        "cuenta_pgc": "217",
        "cuenta_pgc_nombre": "Equipos para procesos de informacion",
    },
}
...
async def main():
    ...
    for row in rows:
        ...
        next_num = (
            max_rows[0].get("max_num", 0) if hasattr(max_rows[0], "get") else max_rows[0][0]
        ) + 1
        ...
        print(
            f"  {tipo_label}: {fname} > {inv['cuenta_pgc']} {inv['cuenta_pgc_nombre']} - {inv['base_imponible']:.2f} EUR"
        )
        created += 1
