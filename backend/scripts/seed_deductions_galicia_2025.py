...
GALICIA_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_adopcion_galicia",
                    "label": "Ha tenido o adoptado hijos en 2025 (o en 2023/2024)?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijo_orden_galicia",
                    "label": "Que numero de hijo es (1o, 2o, 3o...)?",
                    "type": "number",
                },
                {
                    "key": "municipio_pequeno_galicia",
                    "label": "Reside en un municipio de menos de 5.000 habitantes?",
                    "type": "boolean",
                },
                {
                    "key": "hijo_discapacidad_33_galicia",
                    "label": "El hijo tiene discapacidad >= 33%?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_2_hijos_galicia",
                    "label": "Tiene exactamente 2 hijos que generen minimo por descendientes?",
                    "type": "boolean",
                },
                {
                    "key": "discapacidad_65_familia_galicia",
                    "label": "Usted o algun hijo tiene discapacidad >= 65%?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_galicia",
                    "label": "Tiene titulo de familia numerosa?",
                    "type": "boolean",
                },
                {
                    "key": "categoria_fn_galicia",
                ...
                {
                    "key": "discapacidad_65_fn_galicia",
                    "label": "Usted o algun descendiente tiene discapacidad >= 65%?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "acogimiento_menores_galicia",
                    "label": "Tiene menores en acogimiento familiar en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "num_menores_acogidos_galicia",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "cuidado_hijos_menores_galicia",
                    "label": "Tiene hijos de 3 anos o menos en guarderia o con empleado de hogar?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_3_galicia",
                    "label": "Cuantos hijos de 3 anos o menos tiene?",
                    "type": "number",
                },
                {
                    "key": "gasto_cuidado_hijos",
                    "label": "Importe pagado por cuidado de hijos menores",
                    "type": "number",
                },
                {
                    "key": "ambos_trabajan_galicia",
                    "label": "Ambos progenitores trabajan y estan dados de alta en SS?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_65_mayor65_galicia",
                    "label": "Tiene >= 65 anos y discapacidad >= 65% que requiera ayuda de terceros?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_ayuda_terceros",
                    "label": "Importe pagado a terceras personas por ayuda",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_vivienda_galicia",
                    "label": "Vive de alquiler en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_galicia",
                    "label": "Importe anual del alquiler",
                    "type": "number",
                },
                {"key": "menor_35_galicia", "label": "Tiene 35 anos o menos?", "type": "boolean"},
                {
                    "key": "hijos_menores_2_galicia",
                    "label": "Tiene 2 o mas hijos menores dependientes?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "internet_alta_velocidad_galicia",
                    "label": "Ha contratado internet de alta velocidad en su hogar gallego en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_internet_galicia",
                    "label": "Importe de gastos de conexion y cuotas de internet",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_empresa_nueva_galicia",
                    "label": "Ha invertido en empresas nuevas o de reciente creacion en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_galicia",
                    "label": "Importe total invertido",
                    "type": "number",
                },
                {
                    "key": "empresa_innovadora_galicia",
                    "label": "Es PYME innovadora, empresa de base tecnologica o con participacion universitaria?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_financiacion_galicia",
                    "label": "Ha invertido o financiado empresas nuevas en Galicia (adquisicion + prestamos)?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_financiacion",
                    "label": "Importe total invertido y/o financiado",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_mab_galicia",
                    "label": "Ha invertido en empresas cotizadas en el MAB con sede en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_mab",
                    "label": "Importe invertido en acciones del MAB",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_investigacion_galicia",
                    "label": "Ha donado a centros de investigacion o entidades de I+D en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_investigacion",
                    "label": "Importe total donado para investigacion",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "renovables_climatizacion_galicia",
                    "label": "Ha instalado sistemas de climatizacion o ACS con renovables en su vivienda?",
                    "type": "boolean",
                },
                {
                    "key": "importe_renovables",
                    "label": "Importe de la instalacion de renovables",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "rehabilitacion_centro_historico_galicia",
                    "label": "Ha rehabilitado un inmueble en un centro historico de Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_rehabilitacion_ch",
                    "label": "Importe invertido en la rehabilitacion",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_agraria_galicia",
                    "label": "Ha invertido en empresas agrarias en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_agraria",
                    "label": "Importe invertido en empresa agraria",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ayuda_incendio_forestal_galicia",
                    "label": "Ha recibido ayudas por danos de incendios forestales en Galicia en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "importe_ayuda_forestal",
                    "label": "Importe de la subvencion/ayuda recibida",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "eficiencia_energetica_galicia",
                    "label": "Ha realizado obras de mejora de eficiencia energetica en su vivienda en Galicia?",
                    "type": "boolean",
                },
                {
                ...
                {
                    "key": "mejora_letra_energetica",
                    "label": "Las obras mejoran al menos una letra en la calificacion energetica?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "deportista_alto_nivel_galicia",
                    "label": "Es deportista de alto nivel reconocido en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "ayuda_deportiva_galicia",
                    "label": "Importe de ayudas deportivas recibidas de la Xunta",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "aldea_modelo_galicia",
                    "label": "Ha adquirido o rehabilitado vivienda en una aldea modelo de Galicia?",
                    "type": "boolean",
                },
                {"key": "importe_aldea_modelo", "label": "Importe invertido", "type": "number"},
                {
                    "key": "vivienda_habitual_aldea",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_interes_publico_galicia",
                    "label": "Ha invertido en entidades con proyectos de especial interes publico en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_publico",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "adecuacion_inmueble_vacio_galicia",
                    "label": "Ha adecuado un inmueble vacio para alquiler como vivienda en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_adecuacion_vacio",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_vivienda_vacia_galicia",
                    "label": "Ha puesto en alquiler una vivienda vacia en Galicia por primera vez?",
                    "type": "boolean",
                },
                {
                    "key": "num_viviendas_vacias_alquiler",
                    "label": "Cuantas viviendas vacias ha puesto en alquiler?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ayuda_ela_galicia",
                    "label": "Ha recibido ayudas publicas por diagnostico de ELA?",
                    "type": "boolean",
                },
                {
                    "key": "importe_ayuda_ela",
                    "label": "Importe de la ayuda recibida",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "libros_texto_galicia",
                    "label": "Ha comprado libros de texto o material escolar en Galicia?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_material_escolar",
                    "label": "Cuantos hijos tienen gastos de material escolar?",
                    "type": "number",
                },
                {
                    "key": "importe_material_escolar",
                    "label": "Importe total de libros y material escolar",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ayuda_talidomida_galicia",
                    "label": "Ha recibido ayudas publicas como afectado por talidomida?",
                    "type": "boolean",
                },
                {
                    "key": "importe_ayuda_talidomida",
                    "label": "Importe de la ayuda recibida",
                    "type": "number",
                },
            ]
...
async def seed_galicia(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(GALICIA_2025)} Galicia deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Galicia deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(GALICIA_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
