...
async def populate_quotas():
    ...
    for tramo_data in TRAMOS_2025:
        ...
        await db.execute(
            ...
            [
                ...
                0,  # No bonificación
                None,
                None,  # No cuota bonificada
            ],
        )

        print(
            f"  ✓ Tramo {tramo_num}: {rend_min}€ - {rend_max or '∞'}€ → Cuota: {cuota_min}€ - {cuota_max}€"
        )
    ...
    for tramo_data in TRAMOS_2025:
        ...
        print(
            f"  ✓ Tramo {tramo_num}: {rend_min}€ - {rend_max or '∞'}€ → Cuota bonificada: {cuota_min_bonificada}€ - {cuota_max_bonificada}€"
        )
