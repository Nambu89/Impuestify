...
LARIOJA_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_primer_hijo_larioja",
                    "label": "Ha tenido su primer hijo (nacimiento o adopcion) en 2025?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_segundo_hijo_larioja",
                    "label": "Ha tenido su segundo hijo (nacimiento o adopcion) en 2025?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_tercer_hijo_larioja",
                    "label": "Ha tenido un tercer hijo o sucesivo en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_tercero_larioja",
                    "label": "Cuantos hijos nacidos/adoptados (3ro y siguientes)?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "escuela_infantil_larioja",
                    "label": "Tiene hijos menores de 3 anos en escuela infantil autorizada?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_escuela_infantil_larioja",
                    "label": "Importe total de gastos en escuela infantil",
                    "type": "number",
                },
                {
                    "key": "num_hijos_escuela_larioja",
                    "label": "Cuantos hijos asisten a escuela infantil?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_general_larioja",
                    "label": "Tiene titulo de familia numerosa general?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_especial_larioja",
                    "label": "Tiene titulo de familia numerosa especial?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_larioja",
                    "label": "Tiene reconocido un grado de discapacidad >= 33%?",
                    "type": "boolean",
                },
                {
                    "key": "grado_discapacidad_larioja",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_familiar_larioja",
                    "label": "Convive con ascendientes o descendientes con discapacidad >= 33%?",
                    "type": "boolean",
                },
                {
                    "key": "num_familiares_discapacidad_larioja",
                    "label": "Cuantos familiares con discapacidad conviven con usted?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "joven_emancipado_larioja",
                    "label": "Es menor de 36 anos y vive emancipado de forma independiente?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_vivienda_larioja",
                    "label": "Paga alquiler por su vivienda habitual en La Rioja?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_larioja",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vehiculo_electrico_larioja",
                    "label": "Ha comprado un vehiculo electrico o hibrido enchufable nuevo en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "precio_vehiculo_electrico_larioja",
                    "label": "Precio de adquisicion del vehiculo",
                    "type": "number",
                },
                {
                    "key": "tipo_vehiculo_larioja",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "deporte_hijos_larioja",
                    "label": "Tiene hijos menores de 18 anos que practican deporte organizado?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_deporte_larioja",
                    "label": "Importe total de gastos deportivos",
                    "type": "number",
                },
                {
                    "key": "num_hijos_deporte_larioja",
                    "label": "Cuantos hijos practican deporte organizado?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "celiaca_larioja",
                    "label": "Tiene usted o algun familiar conviviente diagnosticado de enfermedad celiaca?",
                    "type": "boolean",
                },
                {
                    "key": "num_celiacos_larioja",
                    "label": "Numero de personas celiacas",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donaciones_entidades_larioja",
                    "label": "Ha realizado donaciones a entidades sin animo de lucro en La Rioja?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donaciones_larioja",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donaciones_patrimonio_larioja",
                    "label": "Ha donado bienes del patrimonio cultural de La Rioja?",
                    "type": "boolean",
                },
                {
                    "key": "valor_donacion_patrimonio_larioja",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vivienda_joven_larioja",
                    "label": "Ha adquirido vivienda habitual en La Rioja siendo menor de 36 anos?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_vivienda_larioja",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "despoblacion_larioja",
                    "label": "Reside en un municipio de La Rioja en riesgo de despoblacion?",
                    "type": "boolean",
                },
                {
                    "key": "traslado_despoblacion_larioja",
                    "label": "Se ha trasladado a dicho municipio en 2025?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "acogimiento_familiar_larioja",
                    "label": "Tiene menores en acogimiento familiar?",
                    "type": "boolean",
                },
                {
                    "key": "num_menores_acogidos_larioja",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_startups_larioja",
                    "label": "Ha invertido en entidades nuevas o de reciente creacion en La Rioja?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_startups_larioja",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "material_escolar_larioja",
                    "label": "Tiene hijos en educacion basica (Primaria/ESO)?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_material_escolar_larioja",
                    "label": "Importe total de gastos de material escolar",
                    "type": "number",
                },
                {
                    "key": "num_hijos_escolar_larioja",
                    "label": "Cuantos hijos cursan educacion basica?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "suministros_larioja",
                    "label": "Quiere deducir gastos de luz y gas de su vivienda habitual?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_suministros_larioja",
                    "label": "Importe total anual de luz y gas",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_despoblacion_larioja",
                    "label": "Ha tenido un nacimiento/adopcion residiendo en municipio en riesgo de despoblacion?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_despoblacion_larioja",
                    "label": "Numero de hijos nacidos/adoptados en zona de despoblacion",
                    "type": "number",
                },
            ]
        ),
...
async def seed_larioja(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(LARIOJA_2025)} La Rioja deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing La Rioja deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(LARIOJA_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
