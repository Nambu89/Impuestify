...
ARABA_2025 = [
    {
        ...
        "description": "734,80€ por el 1º hijo, 909,70€ el 2º, 1.532,30€ el 3º, 1.811,70€ el 4º, 2.366,10€ del 5º en adelante. Complemento +424,60€ por menor de 6 años y +68,20€ por 6-15 años.",
    ...
    },
    {
        ...
        "description": "888€ (33-65%), 1.268€ (≥65% o Grado I), 1.521€ (Grado II), 1.897€ (Grado III). Aplica al contribuyente y/o cónyuge.",
        "requirements_json": json.dumps({
...
ANDALUCIA_2025 = [
    ...
    },
    {
        ...
        "percentage": 15.0,
        "max_amount": 500.0,
        "legal_reference": "Art. 19 Ley 5/2021 Andalucía",
        "description": "15% del coste del empleado/a del hogar, máx. 500€.",
        "requirements_json": json.dumps({
            "empleada_hogar_cuidado": True,
        }),
        "questions_json": json.dumps([
...
VALENCIA_2025 = [
    ...
    },
    {
        ...
        "description": "20-25% del alquiler, máx. 950€ (1.150€ con discapacidad). BL ≤30.000€ indiv. / 47.000€ conjunta. El porcentaje varía según edad, discapacidad y familia numerosa.",
        "requirements_json": json.dumps({
            "alquiler_vivienda_habitual": True,
        }),
        "questions_json": json.dumps([
