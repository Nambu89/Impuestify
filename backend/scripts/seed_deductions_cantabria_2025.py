...
CANTABRIA_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_adopcion_ctb",
                    "label": "Ha tenido un hijo o adoptado en 2025 en Cantabria?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijo_orden_ctb",
                    "label": "Numero de orden del hijo (1o, 2o, 3o...)",
                    "type": "number",
                },
                {
                    "key": "hijo_discapacidad_33_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "cuidado_menores_3_ctb",
                    "label": "Tiene gastos de guarderia o empleada de hogar para hijos < 3 anos?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_cuidado_menores_ctb",
                    "label": "Importe total de gastos",
                    "type": "number",
                },
                {
                    "key": "num_hijos_menores_3_ctb",
                    "label": "Cuantos hijos menores de 3 anos?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_ctb",
                    "label": "Tiene titulo de familia numerosa vigente?",
                    "type": "boolean",
                },
                {
                    "key": "tipo_familia_numerosa_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familiar_discapacidad_ctb",
                    "label": "Tiene familiares con discapacidad >= 65% a su cargo?",
                    "type": "boolean",
                },
                {
                    "key": "num_familiares_discap_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_ctb",
                    "label": "Paga alquiler de vivienda habitual en Cantabria?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vivienda_despoblacion_ctb",
                    "label": "Ha adquirido vivienda en zona rural despoblada de Cantabria?",
                    "type": "boolean",
                },
                {
                    "key": "importe_vivienda_despoblacion_ctb",
                    "label": "Importe invertido en vivienda",
                    "type": "number",
                },
                {
                    "key": "municipio_despoblacion_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_fundaciones_ctb",
                    "label": "Ha donado a fundaciones o asociaciones de utilidad publica de Cantabria?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_fundaciones_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_deportiva_ctb",
                    "label": "Ha donado a entidades deportivas de Cantabria?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_deportiva_ctb",
                    "label": "Importe total donado",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_cultural_ctb",
                    "label": "Ha donado para fines culturales en Cantabria?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_cultural_ctb",
                    "label": "Importe total donado",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "gastos_educacion_ctb",
                    "label": "Ha comprado material escolar/libros para hijos en ESO?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_educacion_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vehiculo_electrico_ctb",
                    "label": "Ha comprado un vehiculo electrico en Cantabria?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "despoblacion_ctb",
                    "label": "Reside en un municipio de Cantabria en riesgo de despoblacion?",
                    "type": "boolean",
                },
                {
                    "key": "municipio_despoblacion_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "obras_accesibilidad_ctb",
                    "label": "Ha realizado obras de accesibilidad en su vivienda?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "gastos_enfermedad_ctb",
                    "label": "Tiene gastos por enfermedad no cubiertos por la Seguridad Social?",
                    "type": "boolean",
                },
                {
                    "key": "importe_enfermedad_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "energia_renovable_ctb",
                    "label": "Ha instalado sistemas de energia renovable en su vivienda en Cantabria?",
                    "type": "boolean",
                },
                {
                    "key": "importe_renovable_ctb",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "traslado_despoblacion_ctb",
                    "label": "Se ha trasladado a un municipio en riesgo de despoblacion en Cantabria?",
                    "type": "boolean",
                },
                {
                    "key": "municipio_traslado_ctb",
                    "label": "Nombre del municipio de destino",
                    "type": "text",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_startup_ctb",
                    "label": "Ha invertido en empresas de nueva creacion en Cantabria?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_startup_ctb",
...
async def seed_cantabria(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(CANTABRIA_2025)} Cantabria deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Cantabria deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(CANTABRIA_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
