...
MURCIA_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_vivienda_joven_murcia",
                    "label": "Ha invertido en vivienda habitual en Murcia siendo menor de 40 anos?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_vivienda_murcia",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_cultural_murcia",
                    "label": "Ha donado para proteccion del patrimonio cultural o actividades sociales en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_cultural",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_biosanitario_murcia",
                    "label": "Ha donado para investigacion biosanitaria en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_biosanitario",
                    "label": "Importe total donado",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_patrimonio_cultural_murcia",
                    "label": "Ha donado bienes inscritos en el Inventario del Patrimonio Cultural de Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "valor_donacion_patrimonio",
                    "label": "Valor de mercado de los bienes donados",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "guarderia_murcia",
                    "label": "Tiene hijos en guarderia (primer ciclo infantil) en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_guarderia_murcia",
                    "label": "Importe total pagado en guarderia",
                    "type": "number",
                },
                {
                    "key": "num_hijos_guarderia_murcia",
                    "label": "Cuantos hijos asisten a guarderia?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ahorro_agua_murcia",
                    "label": "Ha instalado dispositivos de ahorro de agua en su vivienda habitual en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_ahorro_agua",
                    "label": "Importe invertido en dispositivos de ahorro de agua",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "renovables_murcia",
                    "label": "Ha invertido en instalacion de energias renovables en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_renovables_murcia",
                    "label": "Importe de la inversion en renovables",
                    "type": "number",
                },
                {
                    "key": "tipo_inmueble_renovables",
                    "label": "Tipo de inmueble",
                    "type": "select",
                    "options": ["vivienda_habitual", "arrendamiento"],
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_empresa_nueva_murcia",
                    "label": "Ha invertido en empresas nuevas o de reciente creacion en Murcia?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_mab_murcia",
                    "label": "Ha invertido en empresas del MAB con sede en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_mab_murcia",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "material_escolar_murcia",
                    "label": "Ha comprado material escolar o libros de texto para sus hijos en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_material_escolar_murcia",
                    "label": "Cuantos hijos tienen gastos de material escolar?",
                    "type": "number",
                },
                {
                    "key": "familia_numerosa_murcia_escolar",
                    "label": "Es familia numerosa?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_adopcion_murcia",
                    "label": "Ha tenido o adoptado hijos en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijo_orden_murcia",
                    "label": "Que numero de hijo es?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_33_murcia",
                    "label": "Tiene discapacidad reconocida >= 33%?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "conciliacion_descendientes_murcia",
                    "label": "Tiene empleado de hogar para cuidado de hijos menores de 12 anos?",
                    "type": "boolean",
                },
                {
                    "key": "cuotas_ss_cuidado_hijos",
                    "label": "Importe de cuotas SS pagadas por el cuidado",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "conciliacion_ascendientes_murcia",
                    "label": "Tiene empleado de hogar para cuidado de ascendientes mayores de 65 anos?",
                    "type": "boolean",
                },
                {
                    "key": "cuotas_ss_cuidado_ascendientes",
                    "label": "Importe de cuotas SS pagadas por cuidado de ascendientes",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "acogimiento_65_discapacidad_murcia",
                    "label": "Acoge sin remuneracion a personas mayores de 65 o con discapacidad >= 33%?",
                    "type": "boolean",
                },
                {
                    "key": "num_acogidos_murcia",
                    "label": "Cuantas personas tiene acogidas?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_vivienda_murcia",
                    "label": "Vive de alquiler en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_murcia",
                    "label": "Importe anual del alquiler",
                    "type": "number",
                },
                {
                    "key": "menor_40_murcia_alquiler",
                    "label": "Tiene 40 anos o menos, es familia numerosa o tiene discapacidad >= 65%?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "mujer_trabajadora_murcia",
                    "label": "Es mujer trabajadora dada de alta en Seguridad Social?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_menores_18_murcia",
                    "label": "Cuantos hijos menores de 18 anos tiene?",
                    "type": "number",
                },
                {
                    "key": "dependientes_cargo_murcia",
                    "label": "Tiene ascendientes > 75 anos o con discapacidad >= 65% a su cargo?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vivienda_familia_numerosa_murcia",
                    "label": "Ha adquirido o ampliado vivienda siendo familia numerosa en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "categoria_fn_murcia",
                    "label": "Categoria de familia numerosa",
                    "type": "select",
                    "options": ["general", "especial"],
                },
                {
                    "key": "importe_inversion_fn_murcia",
                    "label": "Importe invertido en vivienda",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_monoparental_murcia",
                    "label": "Es familia monoparental?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "idiomas_hijos_murcia",
                    "label": "Tiene hijos que reciben clases extraescolares de idiomas?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_idiomas_murcia",
                    "label": "Importe total de gastos en idiomas",
                    "type": "number",
                },
                {
                    "key": "num_hijos_idiomas",
                    "label": "Cuantos hijos reciben clases de idiomas?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "internet_murcia",
                    "label": "Ha contratado internet de alta velocidad en un municipio < 15.000 hab. de Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_internet_murcia",
                    "label": "Importe de gastos de conexion y cuotas",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vehiculo_electrico_murcia",
                    "label": "Ha comprado un vehiculo electrico en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "precio_vehiculo_electrico",
                    "label": "Precio del vehiculo electrico",
                    "type": "number",
                },
                {
                    "key": "tipo_vehiculo_electrico",
                    "label": "Tipo de vehiculo",
                    "type": "select",
                    "options": ["turismo", "moto", "ciclomotor"],
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "recarga_ve_murcia",
                    "label": "Ha instalado infraestructura de recarga de vehiculo electrico?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "lentes_menores_murcia",
                    "label": "Ha comprado cristales graduados o lentes de contacto para hijos menores de 12 anos?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_lentes_murcia",
                    "label": "Importe total de gastos en lentes/cristales",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "deporte_murcia",
                    "label": "Ha tenido gastos de gimnasio, deporte o actividades saludables?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_deporte_murcia",
                    "label": "Importe total de gastos deportivos",
                    "type": "number",
                },
                {
                    "key": "mayor_65_deporte_murcia",
                    "label": "Tiene mas de 65 anos?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "enfermedad_rara_murcia",
                    "label": "Tiene gastos por tratamiento de enfermedades raras?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_enfermedad_rara",
                    "label": "Importe de gastos por enfermedades raras",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_economia_social_murcia",
                    "label": "Ha invertido en entidades de economia social en Murcia?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_eco_social",
                    "label": "Importe invertido",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "gastos_veterinarios_murcia",
                    "label": "Ha tenido gastos veterinarios para animales domesticos?",
                    "type": "boolean",
                },
                {
                    "key": "importe_veterinario_murcia",
                    "label": "Importe total de gastos veterinarios",
                    "type": "number",
                },
            ]
        ),
...
async def seed_murcia(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(MURCIA_2025)} Murcia deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Murcia deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(MURCIA_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
