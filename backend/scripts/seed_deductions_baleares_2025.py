...
BALEARES_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_adopcion_baleares",
                    "label": "Ha tenido un nacimiento o adopcion en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_nacidos_baleares",
                    "label": "Numero de hijos nacidos/adoptados",
                    "type": "number",
                },
                {
                    "key": "municipio_menor_10000_baleares",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "adopcion_internacional_baleares",
                    "label": "Ha realizado una adopcion internacional en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "num_adopciones_internacionales",
                    "label": "Numero de adopciones internacionales",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_fisica_baleares",
                    "label": "Tiene discapacidad fisica o sensorial reconocida >= 33%?",
                    "type": "boolean",
                },
                {
                    "key": "grado_discapacidad_fisica_baleares",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_psiquica_baleares",
                    "label": "Tiene discapacidad psiquica reconocida >= 33%?",
                    "type": "boolean",
                },
                {
                    "key": "grado_discapacidad_psiquica_baleares",
                    "label": "Grado de discapacidad psiquica (%)",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_baleares",
                    "label": "Tiene titulo de familia numerosa?",
                    "type": "boolean",
                },
                {
                    "key": "tipo_familia_numerosa_baleares",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "estudios_grado_baleares",
                    "label": "Tiene hijos cursando estudios de grado universitario?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_grado_baleares",
                    "label": "Importe total de gastos de grado",
                    "type": "number",
                },
                {
                    "key": "num_hijos_grado_baleares",
                    "label": "Cuantos hijos cursan grado?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "master_fuera_isla_baleares",
                    "label": "Tiene hijos cursando master fuera de su isla de residencia?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_master_fuera_baleares",
                    "label": "Importe total de gastos de master fuera de isla",
                    "type": "number",
                },
                {
                    "key": "num_hijos_master_fuera",
                    "label": "Cuantos hijos cursan master fuera de isla?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "sostenibilidad_vivienda_baleares",
                    "label": "Ha realizado inversiones en sostenibilidad en su vivienda habitual?",
                    "type": "boolean",
                },
                {
                    "key": "importe_sostenibilidad_baleares",
                    "label": "Importe total invertido en sostenibilidad",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_vivienda_baleares",
                    "label": "Paga alquiler por su vivienda habitual en Baleares?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_baleares",
                    "label": "Importe anual de alquiler",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_colectivo_especial_baleares",
                    "label": "Pertenece a colectivo especial (discapacidad >= 65%, familia numerosa, monoparental, < 36 anos)?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_especial_baleares",
                    "label": "Importe anual de alquiler",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donaciones_entidades_baleares",
                    "label": "Ha realizado donaciones a entidades sin animo de lucro en Baleares?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donaciones_baleares",
                    "label": "Importe total de donaciones",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donaciones_idi_baleares",
                    "label": "Ha realizado donaciones para I+D+i en Baleares?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donaciones_idi_baleares",
                    "label": "Importe total donado a I+D+i",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donaciones_patrimonio_baleares",
                    "label": "Ha donado bienes del patrimonio cultural o artistico?",
                    "type": "boolean",
                },
                {
                    "key": "valor_donacion_patrimonio_baleares",
                    "label": "Valor de las donaciones al patrimonio cultural",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ela_baleares",
                    "label": "Tiene usted o algun familiar conviviente diagnosticado de ELA?",
                    "type": "boolean",
                },
                {
                    "key": "num_afectados_ela_baleares",
                    "label": "Numero de personas afectadas por ELA",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ascendientes_mayores_baleares",
                    "label": "Convive con ascendientes mayores de 65 anos o discapacitados?",
                    "type": "boolean",
                },
                {
                    "key": "num_ascendientes_65_baleares",
                    "label": "Numero de ascendientes mayores de 65 anos",
                    "type": "number",
                },
                {
                    "key": "num_ascendientes_75_baleares",
                    "label": "De ellos, cuantos son mayores de 75 anos?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vehiculo_electrico_baleares",
                    "label": "Ha comprado un vehiculo electrico nuevo en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "precio_vehiculo_electrico_baleares",
                    "label": "Precio de adquisicion del vehiculo electrico",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "emprendimiento_baleares",
                    "label": "Ha iniciado una actividad economica como emprendedor en 2025?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "eficiencia_energetica_baleares",
                    "label": "Ha realizado obras de mejora de eficiencia energetica en su vivienda?",
                    "type": "boolean",
                },
                {
                    "key": "importe_eficiencia_energetica_baleares",
                    "label": "Importe total invertido en eficiencia energetica",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "seguro_impago_baleares",
                    "label": "Es arrendador con seguro de impago de alquileres?",
                    "type": "boolean",
                },
                {
                    "key": "prima_seguro_impago_baleares",
                    "label": "Importe de la prima del seguro",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "idiomas_hijos_baleares",
                    "label": "Tiene hijos que reciben clases de idiomas extranjeros?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_idiomas_baleares",
                    "label": "Importe total de gastos en idiomas",
                    "type": "number",
                },
                {
                    "key": "num_hijos_idiomas_baleares",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "acogimiento_familiar_baleares",
                    "label": "Tiene menores en regimen de acogimiento familiar?",
                    "type": "boolean",
                },
                {
                    "key": "num_menores_acogidos_baleares",
                    "label": "Numero de menores acogidos",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_startups_baleares",
                    "label": "Ha invertido en entidades nuevas o de reciente creacion en Baleares?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_startups_baleares",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donaciones_deportivas_baleares",
                    "label": "Ha donado a entidades deportivas sin animo de lucro en Baleares?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donaciones_deportivas_baleares",
                    "label": "Importe total donado a entidades deportivas",
                    "type": "number",
                },
            ]
        ),
...
async def seed_baleares(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(BALEARES_2025)} Baleares deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Baleares deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(BALEARES_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
