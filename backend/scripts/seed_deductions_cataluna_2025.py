...
CATALUNA_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_hijo_cataluna",
                    "label": "Ha tenido o adoptado un hijo en Cataluna?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_vivienda_cataluna",
                    "label": "Alquila su vivienda habitual en Cataluna?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_cataluna",
                    "label": "Importe anual del alquiler",
                    "type": "number",
                },
                {
                    "key": "cumple_requisitos_alquiler_cat",
                    "label": "Cumple alguno: menor 32 anos, parado > 183 dias, discapacidad >= 65%, viudo/a >= 65?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "rehabilitacion_vivienda_cataluna",
                    "label": "Ha realizado obras de rehabilitacion de su vivienda habitual en Cataluna?",
                    "type": "boolean",
                },
                {
                    "key": "importe_rehabilitacion_cataluna",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_lengua_catalana",
                    "label": "Ha donado a entidades de fomento de la lengua catalana?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_lengua_cat",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_investigacion_cataluna",
                    "label": "Ha donado a entidades de investigacion o I+D en Cataluna?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_investigacion_cat",
                    "label": "Importe total de las donaciones",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_medioambiente_cataluna",
                    "label": "Ha donado a entidades medioambientales en Cataluna?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_medioambiente_cat",
                    "label": "Importe total de las donaciones",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_fundaciones_cataluna",
                    "label": "Ha donado a fundaciones o asociaciones culturales/asistenciales en Cataluna?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_fundaciones_cat",
                    "label": "Importe total de las donaciones",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_mab_cataluna",
                    "label": "Ha invertido en entidades del Mercado Alternativo Bursatil con sede en Cataluna?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_mab_cataluna",
                    "label": "Importe total invertido en acciones MAB/BME Growth",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_contribuyente_cataluna",
                    "label": "Tiene usted o algun familiar a cargo discapacidad >= 33%?",
                    "type": "boolean",
                },
                {
                    "key": "grado_discapacidad_cataluna",
                    "label": "Grado de discapacidad (%)",
                    "type": "number",
                },
                {
                    "key": "persona_discapacitada_cataluna",
                    "label": "Quien tiene la discapacidad?",
                    "type": "select",
                    "options": ["contribuyente", "conyuge", "descendiente"],
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "prestamo_estudios_cataluna",
                    "label": "Ha pagado intereses de prestamos para master o doctorado?",
                    "type": "boolean",
                },
                {
                    "key": "importe_intereses_estudios_cat",
                    "label": "Importe de intereses pagados",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "viudedad_cataluna",
                    "label": "Ha enviudado y tiene hijos a cargo?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_startups_cataluna",
                    "label": "Ha invertido en entidades de nueva creacion en Cataluna?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_startups_cat",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_custodia_territorio_cat",
                    "label": "Ha donado a entidades de custodia del territorio o conservacion del patrimonio natural catalan?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_custodia_cat",
                    "label": "Importe total de las donaciones",
                    "type": "number",
                },
            ]
...
async def seed_cataluna(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(CATALUNA_2025)} Cataluna deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Cataluna deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(CATALUNA_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
