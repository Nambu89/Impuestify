...
EXTREMADURA_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_adopcion_extremadura",
                    "label": "Ha tenido un nacimiento o adopcion en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_nacidos_extremadura",
                    "label": "Numero de hijos nacidos/adoptados",
                    "type": "number",
                },
                {
                    "key": "parto_multiple_extremadura",
                    "label": "Ha sido parto o adopcion multiple?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_extremadura",
                    "label": "Tiene reconocido un grado de discapacidad >= 33%?",
                    "type": "boolean",
                },
                {
                    "key": "grado_discapacidad_extremadura",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_extremadura",
                    "label": "Tiene titulo de familia numerosa?",
                    "type": "boolean",
                },
                {
                    "key": "tipo_familia_numerosa_extremadura",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "hijos_menores_6_extremadura",
                    "label": "Tiene hijos menores de 6 anos?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_menores_6_extremadura",
                    "label": "Cuantos hijos menores de 6 anos?",
                    "type": "number",
                },
                {
                    "key": "ambos_trabajan_extremadura",
                    "label": "Trabajan ambos progenitores?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "acogimiento_familiar_extremadura",
                    "label": "Tiene menores en acogimiento familiar?",
                    "type": "boolean",
                },
                {
                    "key": "num_menores_acogidos_extremadura",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vivienda_joven_extremadura",
                    "label": "Ha adquirido vivienda habitual siendo menor de 36 anos o victima del terrorismo?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_vivienda_extremadura",
                    "label": "Importe invertido en vivienda",
                    "type": "number",
                },
                {
                    "key": "menor_36_extremadura",
                    "label": "Tiene menos de 36 anos?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_joven_extremadura",
                    "label": "Es menor de 36 anos y paga alquiler por su vivienda habitual?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_extremadura",
                    "label": "Importe anual de alquiler",
                    "type": "number",
                },
                {
                    "key": "menor_36_alquiler_extremadura",
                    "label": "Tiene menos de 36 anos?",
                    "type": "boolean",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donaciones_entidades_extremadura",
                    "label": "Ha realizado donaciones a entidades sociales/culturales/deportivas en Extremadura?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donaciones_extremadura",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                ...
                {
                    "key": "num_afectados_ela_extremadura",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vivienda_vacia_extremadura",
                    "label": "Ha arrendado una vivienda que llevaba vacia mas de un ano?",
                    "type": "boolean",
                },
                {
                    "key": "renta_alquiler_vivienda_vacia_extremadura",
                    "label": "Importe anual del alquiler obtenido",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "despoblacion_extremadura",
                    "label": "Reside en un municipio de Extremadura con menos de 3.000 habitantes?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "emprendimiento_extremadura",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "trabajo_dependiente_extremadura",
                    "label": "Son sus rendimientos del trabajo su unica fuente de renta significativa?",
                    "type": "boolean",
                },
                {
                    "key": "base_imponible_extremadura",
                    "label": "Base imponible general estimada",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "guarderia_extremadura",
                    "label": "Tiene hijos menores de 4 anos en guarderia?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_guarderia_extremadura",
                    "label": "Importe total de gastos de guarderia",
                    "type": "number",
                },
                {
                    "key": "num_hijos_guarderia_extremadura",
                    "label": "Cuantos hijos menores de 4 anos asisten a guarderia?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donaciones_patrimonio_natural_extremadura",
                    "label": "Ha donado para la conservacion del patrimonio natural de Extremadura?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donaciones_natural_extremadura",
                    "label": "Importe total donado al patrimonio natural",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "material_escolar_extremadura",
                    "label": "Tiene hijos en Educacion Primaria o ESO?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_material_escolar_extremadura",
                    "label": "Importe total de gastos de material escolar",
                    "type": "number",
                },
                {
                    "key": "num_hijos_escolar_extremadura",
                    "label": "Cuantos hijos cursan Primaria/ESO?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_economia_social_extremadura",
                    "label": "Ha invertido en entidades de economia social en Extremadura?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_eco_social_extremadura",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_rural_extremadura",
                    "label": "Paga alquiler en un municipio de menos de 3.000 habitantes?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_rural_extremadura",
                    "label": "Importe anual de alquiler",
                    "type": "number",
                },
            ]
...
async def seed_extremadura(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(EXTREMADURA_2025)} Extremadura deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Extremadura deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(EXTREMADURA_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
