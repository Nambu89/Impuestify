...
CYL_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_hijo_cyl",
                    "label": "Ha tenido o adoptado hijos en Castilla y Leon?",
                    "type": "boolean",
                },
                {
                    "key": "num_orden_hijo_cyl",
                    "label": "Numero de orden del hijo (1o, 2o, 3o...)",
                    "type": "number",
                },
                {
                    "key": "municipio_pequeno_cyl",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "parto_multiple_cyl",
                    "label": "Ha tenido un parto multiple o adopcion simultanea?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_cyl",
                    "label": "Tiene titulo de familia numerosa?",
                    "type": "boolean",
                },
                {
                    "key": "tipo_familia_numerosa_cyl",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "cuidado_menores_cyl",
                    "label": "Tiene gastos de cuidado de hijos menores de 4 anos?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_cuidado_menores_cyl",
                    "label": "Importe total de gastos de cuidado",
                    "type": "number",
                },
                {
                    "key": "num_hijos_menores4_cyl",
                    "label": "Numero de hijos menores de 4 anos",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "joven_emancipado_cyl",
                    "label": "Es menor de 36 anos y esta emancipado en Castilla y Leon?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_contribuyente_cyl",
                    "label": "Tiene un grado de discapacidad >= 33%?",
                    "type": "boolean",
                },
                {
                    "key": "grado_discapacidad_cyl",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_joven_cyl",
                    "label": "Alquila vivienda habitual en Castilla y Leon siendo menor de 36 anos?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_cyl",
                    "label": "Importe anual del alquiler",
                    "type": "number",
                },
                {
                    "key": "menor_36_cyl_alquiler",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "rehabilitacion_vivienda_cyl",
                    "label": "Ha realizado obras de rehabilitacion en su vivienda habitual en Castilla y Leon?",
                    "type": "boolean",
                },
                {
                    "key": "importe_rehabilitacion_cyl",
                    "label": "Importe de las obras de rehabilitacion",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_fundaciones_cyl",
                    "label": "Ha donado a fundaciones de Castilla y Leon?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_fundaciones_cyl",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_patrimonio_cyl",
                    "label": "Ha donado para la recuperacion del patrimonio cultural o natural de Castilla y Leon?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_patrimonio_cyl",
                    "label": "Importe total de las donaciones",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "residencia_rural_cyl",
                    "label": "Reside en un municipio de menos de 5.000 habitantes de Castilla y Leon?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "autoempleo_joven_cyl",
                    "label": "Se ha dado de alta como autonomo siendo menor de 36 anos en Castilla y Leon?",
                    "type": "boolean",
                },
                {
                    "key": "menor_36_cyl_autoempleo",
                    "label": "Tiene menos de 36 anos?",
                    "type": "boolean",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_emprendimiento_cyl",
                    "label": "Ha invertido en entidades de nueva creacion en Castilla y Leon?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_emprendimiento_cyl",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "eficiencia_energetica_cyl",
                    "label": "Ha realizado obras de eficiencia energetica en su vivienda habitual en Castilla y Leon?",
                    "type": "boolean",
                },
                {
                    "key": "importe_eficiencia_cyl",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vehiculo_electrico_cyl",
                    "label": "Ha comprado un vehiculo electrico nuevo en Castilla y Leon?",
                    "type": "boolean",
                },
                {
                    "key": "precio_vehiculo_electrico_cyl",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "traslado_rural_cyl",
                    "label": "Se ha trasladado a un municipio < 5.000 hab. de Castilla y Leon?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "acogimiento_menores_cyl",
                    "label": "Tiene menores en acogimiento familiar en Castilla y Leon?",
                    "type": "boolean",
                },
                {
                    "key": "num_menores_acogidos_cyl",
                    "label": "Numero de menores acogidos",
                    "type": "number",
                },
                {
                    "key": "dias_acogimiento_cyl",
                    "label": "Dias de convivencia durante el periodo impositivo",
                    "type": "number",
                },
            ]
        ),
...
async def seed_cyl(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(CYL_2025)} Castilla y Leon deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Castilla y Leon deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(CYL_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
...
def main():
    parser = argparse.ArgumentParser(
        description="Seed all 17 Castilla y Leon IRPF deductions for 2025"
    )
    parser.add_argument(
