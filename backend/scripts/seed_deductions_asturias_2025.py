...
ASTURIAS_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_adopcion_ast",
                    "label": "Ha tenido un hijo o adoptado en 2025 en Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijo_orden_ast",
                    "label": "Numero de orden del hijo (1o, 2o, 3o...)",
                    "type": "number",
                },
                {
                    "key": "concejo_3000_ast",
                    "label": "Reside en un concejo de < 3.000 habitantes?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "adopcion_internacional_ast",
                    "label": "Ha realizado una adopcion internacional en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "num_adopciones_int_ast",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "parto_multiple_ast",
                    "label": "Ha tenido un parto multiple o 2+ adopciones en el mismo ejercicio?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_ast",
                    "label": "Tiene titulo de familia numerosa vigente?",
                    "type": "boolean",
                },
                {
                    "key": "tipo_familia_numerosa_ast",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "guarderia_ast",
                    "label": "Tiene hijos en centros 0-3 anos en Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_guarderia_ast",
                    "label": "Importe total pagado en centros 0-3",
                    "type": "number",
                },
                {
                    "key": "num_hijos_guarderia_ast",
                    "label": "Cuantos hijos asisten a centros 0-3?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_ast",
                    "label": "Paga alquiler de vivienda habitual en Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_ast",
                    "label": "Importe anual de alquiler",
                    "type": "number",
                },
                {
                    "key": "concejo_3000_alquiler_ast",
                    "label": "El concejo tiene < 3.000 habitantes?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vivienda_concejo_3000_ast",
                    "label": "Ha adquirido vivienda habitual en concejo de Asturias con < 3.000 hab.?",
                    "type": "boolean",
                },
                {
                    "key": "importe_vivienda_concejo_ast",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vehiculo_electrico_ast",
                    "label": "Ha comprado un vehiculo electrico/hibrido enchufable en Asturias?",
                    "type": "boolean",
                },
                {"key": "importe_vehiculo_ast", "label": "Precio del vehiculo", "type": "number"},
                {
                    "key": "tipo_vehiculo_ast",
                    "label": "Tipo de vehiculo",
                    "type": "select",
                    "options": [
                        "electrico_bev",
                        "hibrido_enchufable_phev",
                        "pila_combustible_fcev",
                    ],
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "enfermedad_rara_ast",
                    "label": "Tiene usted o un familiar a cargo diagnostico de ELA o enfermedad rara?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "eficiencia_energetica_ast",
                    "label": "Ha realizado obras de mejora energetica en su vivienda habitual en Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_eficiencia_ast",
                    "label": "Importe invertido en las obras",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vivienda_vacia_ast",
                    "label": "Ha arrendado una vivienda que llevaba mas de 6 meses vacia?",
                    "type": "boolean",
                },
                {
                    "key": "num_viviendas_vacias_ast",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_fundaciones_ast",
                    "label": "Ha donado a fundaciones del Principado de Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_fundaciones_ast",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_cultural_ast",
                    "label": "Ha donado para fines culturales, investigacion o deporte en Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_cultural_ast",
                    "label": "Importe total donado",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_eco_social_ast",
                    "label": "Ha donado a cooperativas o sociedades laborales de Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_eco_social_ast",
                    "label": "Importe total donado",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "emprendimiento_ast",
                    "label": "Se ha dado de alta como autonomo por primera vez en Asturias?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "transporte_publico_ast",
                    "label": "Ha pagado abono o titulo de transporte publico en Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_transporte_ast",
                    "label": "Importe total en transporte publico",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "despoblacion_ast",
                    "label": "Reside en un concejo de Asturias en riesgo de despoblacion?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "seguro_salud_ast",
                    "label": "Paga un seguro de salud privado?",
                    "type": "boolean",
                },
                {
                    "key": "prima_seguro_salud_ast",
                    "label": "Importe anual de las primas",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "material_escolar_ast",
                    "label": "Ha comprado material escolar para hijos en Primaria o ESO?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_material_escolar_ast",
                    "label": "Importe total en material escolar",
                    "type": "number",
                },
                {
                    "key": "num_hijos_edu_ast",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "energia_renovable_ast",
                    "label": "Ha instalado sistemas de energia renovable en su vivienda en Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_renovable_ast",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "internet_rural_ast",
                    "label": "Ha contratado internet en un concejo de < 5.000 hab. de Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_internet_ast",
                    "label": "Importe de gastos de internet",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "dependientes_ast",
                    "label": "Tiene a cargo personas dependientes reconocidas?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_dependientes_ast",
                    "label": "Importe total de gastos en cuidado de dependientes",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_startup_ast",
                    "label": "Ha invertido en empresas de nueva creacion en Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_startup_ast",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "traslado_despoblacion_ast",
                    "label": "Se ha trasladado a un concejo en riesgo de despoblacion en Asturias?",
                    "type": "boolean",
                },
                {
                    "key": "concejo_traslado_ast",
                    "label": "Nombre del concejo de destino",
                    "type": "text",
                },
            ]
        ),
...
async def seed_asturias(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(ASTURIAS_2025)} Asturias deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Asturias deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(ASTURIAS_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
