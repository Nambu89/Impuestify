...
def create_invoice_pdf(filename: str, data: dict):
    ...
    small_style = ParagraphStyle(
        "Small", parent=styles["Normal"], fontSize=7, textColor=colors.gray
    )
    ...
    elements.append(
        Paragraph(
            f"<b>Fecha:</b> {data['fecha']}    <b>Vencimiento:</b> {data.get('vencimiento', 'A 30 dias')}",
            header_style,
        )
    )
    elements.append(Spacer(1, 5 * mm))
    ...
    elements.append(
        Paragraph(
            "Este documento sirve como factura a efectos del Real Decreto 1619/2012.", small_style
        )
    )
...
EMITTED = [
    {
        ...
        "lineas": [
            {
                "concepto": "Consultoria desarrollo web - Enero 2025",
                "cantidad": 1,
                "precio": 3500.00,
            },
    ...
    },
    {
        ...
        "lineas": [
            {
                "concepto": "Consultoria desarrollo web - Febrero 2025",
                "cantidad": 1,
                "precio": 3500.00,
            },
    ...
    },
    {
        ...
        "lineas": [
            {
                "concepto": "Consultoria desarrollo web - Marzo 2025",
                "cantidad": 1,
                "precio": 3500.00,
            },
...
RECEIVED = [
    {
        ...
        "lineas": [
            {
                "concepto": "Alquiler puesto fijo coworking - Enero 2025",
                "cantidad": 1,
                "precio": 350.00,
            },
    ...
    },
    {
        ...
        "lineas": [
            {
                "concepto": "Seguro Responsabilidad Civil Profesional - Trimestre Q1 2025",
                "cantidad": 1,
                "precio": 180.00,
            },
        ],
