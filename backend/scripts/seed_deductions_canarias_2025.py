...
CANARIAS_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_ecologica_canarias",
                    "label": "Ha realizado donaciones a entidades medioambientales en Canarias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_ecologica",
                    "label": "Importe total de las donaciones ecologicas",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_patrimonio_canarias",
                    "label": "Ha donado para rehabilitacion del patrimonio historico de Canarias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_patrimonio",
                    "label": "Importe total de las donaciones al patrimonio",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_cultural_canarias",
                    "label": "Ha realizado donaciones culturales, deportivas o de investigacion en Canarias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_cultural",
                    "label": "Importe total de las donaciones culturales/deportivas",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_ong_canarias",
                    "label": "Ha donado a entidades sin animo de lucro acogidas a Ley 49/2002?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_ong",
                    "label": "Importe total donado a entidades sin animo de lucro",
                    "type": "number",
                },
                {
                    "key": "donacion_recurrente",
                    "label": "Ha donado a la misma entidad en los 2 ejercicios anteriores?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "restauracion_cultural_canarias",
                    "label": "Ha realizado obras de restauracion en inmuebles de interes cultural en Canarias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_restauracion_cultural",
                    "label": "Importe de las obras de restauracion",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "hijos_universidad_canarias",
                    "label": "Tiene hijos estudiando educacion superior fuera de su isla de residencia?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_universidad",
                    "label": "Cuantos hijos estudian fuera de la isla?",
                    "type": "number",
                },
                {
                    "key": "base_imponible_baja",
                    "label": "Su base imponible es inferior a 37.062 EUR?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "gastos_estudios_no_superiores",
                    "label": "Ha pagado gastos de estudios no superiores de sus hijos?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_estudios_no_sup",
                    "label": "Cuantos hijos tienen gastos de estudios no superiores?",
                    "type": "number",
                },
                {
                    "key": "importe_gastos_estudios",
                    "label": "Importe total de gastos de estudios",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "traslado_isla_canarias",
                    "label": "Se ha trasladado a otra isla de Canarias por motivos laborales?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_empresa_nueva_canarias",
                    "label": "Ha invertido en acciones o participaciones de empresas nuevas en Canarias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_empresa",
                    "label": "Importe total invertido",
                    "type": "number",
                },
                {
                    "key": "empresa_vinculada_universidad",
                    "label": "La empresa esta vinculada a universidad o investigacion?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_adopcion_canarias",
                    "label": "Ha tenido o adoptado hijos en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijo_orden",
                ...
                {
                    "key": "hijo_discapacidad_65",
                    "label": "El hijo tiene discapacidad reconocida >= 65%?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_33_canarias",
                    "label": "Tiene una discapacidad reconocida >= 33%?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "acogimiento_menores_canarias",
                    "label": "Tiene menores en regimen de acogimiento familiar?",
                    "type": "boolean",
                },
                {
                    "key": "num_menores_acogidos",
                    "label": "Cuantos menores tiene en acogimiento?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_monoparental_canarias",
                    "label": "Es familia monoparental (vive solo con sus hijos)?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "guarderia_canarias",
                    "label": "Tiene hijos menores de 3 anos en guarderia?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_guarderia_canarias",
                    "label": "Importe total pagado en guarderia",
                    "type": "number",
                },
                {
                    "key": "num_hijos_guarderia",
                    "label": "Cuantos hijos menores de 3 anos asisten a guarderia?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_canarias",
                    "label": "Tiene titulo de familia numerosa?",
                    "type": "boolean",
                },
                {
                    "key": "categoria_familia_numerosa",
                    "label": "Categoria de familia numerosa",
                    "type": "select",
                    "options": ["general", "especial"],
                },
                {
                    "key": "discapacidad_familia_65",
                    "label": "Algun miembro de la unidad familiar tiene discapacidad >= 65%?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_vivienda_canarias",
                    "label": "Ha invertido en adquisicion o rehabilitacion de vivienda habitual en Canarias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_vivienda",
                    "label": "Importe invertido en vivienda habitual",
                    "type": "number",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "rehabilitacion_energetica_canarias",
                    "label": "Ha realizado obras de rehabilitacion energetica en su vivienda habitual en Canarias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_rehabilitacion_energetica",
                    "label": "Importe de las obras de rehabilitacion energetica",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "adecuacion_discapacidad_canarias",
                    "label": "Ha realizado obras de adecuacion de vivienda por discapacidad >= 65%?",
                    "type": "boolean",
                },
                {
                    "key": "importe_adecuacion_discapacidad",
                    "label": "Importe de las obras de adecuacion",
                    "type": "number",
                },
                {
                    "key": "discapacitado_mayor_65",
                    "label": "La persona con discapacidad es mayor de 65 anos?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_vivienda_canarias",
                    "label": "Vive de alquiler en Canarias?",
                    "type": "boolean",
                },
                {
                ...
                {
                    "key": "menor_40_o_mayor_75",
                    "label": "Tiene menos de 40 o mas de 75 anos?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "dacion_pago_canarias",
                    "label": "Vive en alquiler tras una dacion en pago de su vivienda?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_dacion",
                    "label": "Importe anual del alquiler vinculado a dacion en pago",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "adecuacion_arrendamiento_canarias",
                    "label": "Ha adecuado un inmueble para destinarlo al alquiler como vivienda en Canarias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_adecuacion_arrendamiento",
                    "label": "Importe de los gastos de adecuacion",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "seguro_impago_canarias",
                    "label": "Ha contratado un seguro de impago de alquiler para un inmueble en Canarias?",
                    "type": "boolean",
                },
                {
                    "key": "importe_prima_seguro",
                    "label": "Importe de la prima del seguro de impago",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "puesta_alquiler_canarias",
                    "label": "Ha puesto alguna vivienda en el mercado de alquiler por primera vez en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "num_viviendas_alquiler",
                    "label": "Cuantas viviendas ha puesto en alquiler por primera vez?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "requirements": json.dumps(
            {
                ...
                "limites_renta": {
                    "rendimientos_trabajo_min": 15876,
                    "rendimientos_trabajo_max": 22000,
                },
                "condiciones": [
        ...
        "questions": json.dumps(
            [
                {
                    "key": "desempleado_canarias",
                    "label": "Ha estado desempleado mas de 6 meses en 2025 cobrando prestacion?",
                    "type": "boolean",
                },
                {
                    "key": "rendimientos_trabajo",
                    "label": "Rendimientos del trabajo en 2025",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "gastos_medicos_canarias",
                    "label": "Ha tenido gastos medicos o sanitarios en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "importe_gastos_medicos",
                    "label": "Importe total de gastos medicos",
                    "type": "number",
                },
                {
                    "key": "mayor_65_o_discapacidad_65",
                    "label": "Es mayor de 65 anos o tiene discapacidad >= 65%?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familiar_dependiente_discapacidad",
                    "label": "Tiene familiares dependientes (ascendientes/descendientes) con discapacidad >= 65%?",
                    "type": "boolean",
                },
                {
                    "key": "num_familiares_discapacidad",
                    "label": "Cuantos familiares dependientes con discapacidad >= 65%?",
                    "type": "number",
                },
                {
                    "key": "empleado_hogar_cuidador",
                    "label": "Tiene empleado de hogar como cuidador del familiar dependiente?",
                    "type": "boolean",
                },
                {
                    "key": "cuotas_ss_empleado_hogar",
                    "label": "Importe de cuotas SS pagadas por el empleado cuidador",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "empleado_hogar_canarias",
                    "label": "Tiene empleado del hogar dado de alta en Seguridad Social?",
                    "type": "boolean",
                },
                {
                    "key": "cuotas_ss_hogar",
                    "label": "Importe total de cuotas SS pagadas por empleado del hogar",
                    "type": "number",
                },
            ]
        ),
...
async def seed_canarias(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(CANARIAS_2025)} Canarias deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Canarias deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(CANARIAS_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
