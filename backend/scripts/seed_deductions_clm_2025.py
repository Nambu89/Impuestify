...
CLM_2025 = [
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "nacimiento_adopcion_clm",
                    "label": "Ha tenido un hijo o adoptado en 2025 en Castilla-La Mancha?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijo_orden_clm",
                    "label": "Numero de orden del hijo (1o, 2o, 3o...)",
                    "type": "number",
                },
                {
                    "key": "hijo_discapacidad_33_clm",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familia_numerosa_clm",
                    "label": "Tiene titulo de familia numerosa vigente?",
                    "type": "boolean",
                },
                {
                    "key": "tipo_familia_numerosa_clm",
                    "label": "Categoria de familia numerosa",
                    "type": "select",
                    "options": ["general", "especial", "6_o_mas"],
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_65_clm",
                    "label": "Tiene discapacidad reconocida >= 65%?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "familiar_discapacidad_65_clm",
                    "label": "Tiene ascendientes o descendientes con discapacidad >= 65% conviviendo con usted?",
                    "type": "boolean",
                },
                {
                    "key": "num_familiares_discap_clm",
                    "label": "Cuantos familiares con discapacidad >= 65%?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "acogimiento_clm",
                    "label": "Tiene menores en acogimiento familiar no remunerado?",
                    "type": "boolean",
                },
                {
                    "key": "num_menores_acogidos_clm",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "guarderia_clm",
                    "label": "Tiene hijos en guarderia (0-3 anos) en Castilla-La Mancha?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_guarderia_clm",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ascendiente_75_clm",
                    "label": "Convive con ascendientes mayores de 75 anos?",
                    "type": "boolean",
                },
                {
                    "key": "num_ascendientes_75_clm",
                    "label": "Cuantos ascendientes mayores de 75 anos conviven con usted?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_joven_clm",
                    "label": "Paga alquiler de vivienda habitual en CLM siendo menor de 36 anos?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_clm",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_rural_clm",
                    "label": "Paga alquiler en un municipio de CLM con <= 5.000 habitantes?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_rural_clm",
                    "label": "Importe anual de alquiler",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_vivienda_rural_clm",
                    "label": "Ha adquirido vivienda habitual en municipio < 5.000 hab. de CLM?",
                    "type": "boolean",
                },
                {
                    "key": "importe_inversion_vivienda_clm",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_ecologica_clm",
                    "label": "Ha realizado donaciones ecologicas a la JCCM?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_ecologica_clm",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_cooperacion_clm",
                    "label": "Ha donado a ONGs de cooperacion internacional inscritas en CLM?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_cooperacion_clm",
                    "label": "Importe total donado",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_investigacion_clm",
                    "label": "Ha donado a centros de investigacion de CLM?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_investigacion_clm",
                    "label": "Importe total donado",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_deportivo_clm",
                    "label": "Ha donado a clubes o federaciones deportivas de CLM?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_deportivo_clm",
                    "label": "Importe total donado",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "libros_texto_clm",
                    "label": "Ha comprado libros de texto o pagado clases de idiomas para sus hijos?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_libros_clm",
                    "label": "Importe en libros de texto y material escolar",
                    "type": "number",
                },
                {
                    "key": "gasto_idiomas_clm",
                    "label": "Importe en ensenanza extraescolar de idiomas",
                    "type": "number",
                },
                {
                    "key": "num_hijos_edu_clm",
                    "label": "Cuantos hijos en Primaria o ESO?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "despoblacion_clm",
                    "label": "Reside en un municipio de CLM con <= 2.000 habitantes o en zona de despoblacion?",
                    "type": "boolean",
                },
                {
                    "key": "municipio_despoblacion_clm",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "traslado_rural_clm",
                    "label": "Se ha trasladado a un municipio rural de CLM (<= 5.000 hab.) por motivos laborales?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vehiculo_electrico_clm",
                    "label": "Ha adquirido un vehiculo electrico o punto de recarga en CLM?",
                    "type": "boolean",
                },
                {
                    "key": "importe_vehiculo_electrico_clm",
                    "label": "Importe de la adquisicion",
                    "type": "number",
                },
                {
                    "key": "tipo_adquisicion_clm",
                    "label": "Tipo de adquisicion",
                    "type": "select",
                    "options": ["vehiculo_electrico", "punto_recarga"],
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "autonomo_rural_clm",
                    "label": "Se ha dado de alta como autonomo en un municipio rural de CLM (<= 5.000 hab.)?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "gastos_enfermedad_clm",
                    "label": "Tiene gastos por enfermedad cronica no cubiertos por la Seguridad Social?",
                    "type": "boolean",
                },
                {
                    "key": "importe_enfermedad_clm",
                    "label": "Importe total de los gastos medicos",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_fundaciones_clm",
                    "label": "Ha donado a fundaciones o asociaciones de utilidad publica de CLM?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_fundaciones_clm",
                    "label": "Importe total donado",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vivienda_vacia_clm",
                    "label": "Ha arrendado una vivienda que llevaba mas de 1 ano vacia?",
                    "type": "boolean",
                },
                {
                    "key": "num_viviendas_vacias_clm",
                    "label": "Cuantas viviendas ha arrendado en estas condiciones?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "energia_renovable_clm",
                    "label": "Ha instalado sistemas de energia renovable en su vivienda habitual en CLM?",
                    "type": "boolean",
                },
                {
                    "key": "importe_renovable_clm",
                    "label": "Importe invertido en la instalacion",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "dacion_pago_clm",
                    "label": "Perdio su vivienda por dacion en pago o ejecucion hipotecaria y ahora alquila?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_dacion_clm",
                    "label": "Importe anual de alquiler",
                    "type": "number",
                },
            ]
...
async def seed_clm(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(CLM_2025)} Castilla-La Mancha deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing CLM deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(CLM_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
...
def main():
    parser = argparse.ArgumentParser(
        description="Seed all 25 Castilla-La Mancha IRPF deductions for 2025"
    )
    parser.add_argument(
