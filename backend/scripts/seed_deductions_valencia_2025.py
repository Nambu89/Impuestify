...
VALENCIA_2025 = [
            ...
            [
                {
                    ...
                    "label": "Ha tenido hijos nacidos, adoptados o acogidos en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_recientes",
                    "label": "Cuantos hijos ha tenido, adoptado o acogido?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "parto_multiple",
                    "label": "Ha tenido un parto multiple o dos o mas adopciones en la misma fecha en 2025?",
                    "type": "boolean",
                }
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "hijo_discapacidad",
                    "label": "Tiene hijos nacidos/adoptados en 2025 con discapacidad reconocida?",
                    "type": "boolean",
                },
                {
                    "key": "grado_discapacidad_hijo",
                    "label": "Que grado de discapacidad tiene el hijo?",
                    "type": "number",
                },
            ]
        ),
            ...
            [
                {
                    ...
                    "label": "Tiene titulo de familia numerosa o monoparental?",
                    "type": "boolean",
                },
                {
                    "key": "familia_numerosa_especial",
                    "label": "Es de categoria especial?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "hijo_menor_3",
                    "label": "Tiene hijos menores de 3 anos?",
                    "type": "boolean",
                },
                {
                    "key": "guarderia_autorizada",
                    "label": "Estan en una guarderia o centro de educacion infantil autorizado?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_guarderia",
                    "label": "Cuanto ha pagado de guarderia este ano?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                ...
                {
                    "key": "alta_seguridad_social",
                    "label": "Esta dada de alta en la Seguridad Social o mutualidad?",
                    "type": "boolean",
                },
            ]
        ),
            ...
            [
                {
                    ...
                    "label": "Tiene un grado de discapacidad reconocido >= 33%?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ascendiente_75_o_mas",
                    "label": "Convive con ascendientes mayores de 75 anos o mayores de 65 con discapacidad?",
                    "type": "boolean",
                },
                {
                    "key": "num_ascendientes",
                    "label": "Cuantos ascendientes cumplen este requisito?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "empleada_hogar_contratada",
                    "label": "Tiene contratada de forma indefinida a una persona empleada de hogar?",
                    "type": "boolean",
                },
                {
                    "key": "cotizaciones_patronales",
                    "label": "Cuanto ha pagado en cotizaciones patronales a la Seguridad Social por la empleada?",
                    "type": "number",
                },
            ]
        ),
            ...
            [
                {
                    ...
                    "label": "Ha arrendado una vivienda como propietario en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "rendimiento_alquiler",
                    "label": "Cual es el rendimiento integro anual del alquiler?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                ...
                {
                    "key": "primera_vivienda",
                    "label": "Es su primera vivienda habitual?",
                    "type": "boolean",
                },
                {
                    "key": "importe_adquisicion_vivienda",
                    "label": "Cuanto ha pagado por la adquisicion de la vivienda en 2025 (sin intereses)?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "discapacidad_reconocida",
                    "label": "Tiene discapacidad reconocida >= 65% (fisica) o >= 33% (psiquica)?",
                    "type": "boolean",
                },
                {
                    "key": "importe_adquisicion_vivienda",
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ayuda_publica_vivienda",
                    "label": "Ha recibido una ayuda publica de la Generalitat para adquisicion o rehabilitacion de vivienda?",
                    "type": "boolean",
                },
                {
                    "key": "importe_ayuda_publica",
                    "label": "Cual es el importe de la ayuda publica recibida?",
                    "type": "number",
                },
            ]
        ),
            ...
            [
                {
                    ...
                    "label": "Vive de alquiler en su vivienda habitual?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_anual",
                    "label": "Cuanto paga de alquiler al ano?",
                    "type": "number",
                },
                {"key": "menor_35_anos", "label": "Tiene 35 anos o menos?", "type": "boolean"},
                {
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "alquiler_por_trabajo",
                    "label": "Ha alquilado una vivienda en otro municipio por motivos laborales?",
                    "type": "boolean",
                },
                {
                    "key": "importe_alquiler_trabajo",
                    "label": "Cuanto ha pagado de alquiler por esa vivienda al ano?",
                    "type": "number",
                },
            ]
        ),
            ...
            [
                {
                    ...
                    "label": "Ha instalado paneles solares u otra energia renovable para autoconsumo?",
                    "type": "boolean",
                },
                {
                    "key": "importe_instalacion",
                    "label": "Cuanto ha costado la instalacion?",
                    "type": "number",
                },
                {
                    "key": "tipo_instalacion",
                    "label": "Que tipo de instalacion? (fotovoltaica, termica, con bateria, colectiva)",
                    "type": "text",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "requirements": json.dumps(
            {
                ...
                "limites_renta": None,
                "porcentajes_escalonados": {"primeros_250": 20, "exceso_250": 25},
                "condiciones": [
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_ecologica",
                    "label": "Ha realizado donaciones con fines ecologicos a entidades valencianas?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_ecologica",
                    "label": "Cuanto ha donado?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_patrimonio_cultural",
                    "label": "Ha donado bienes del Patrimonio Cultural Valenciano?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_patrimonio",
                    "label": "Cual es el valor de los bienes donados?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donativo_restauracion_patrimonio",
                    "label": "Ha donado dinero para conservacion o restauracion del Patrimonio Cultural Valenciano?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donativo_restauracion",
                    "label": "Cuanto ha donado?",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "titular_patrimonio_cultural",
                    "label": "Es propietario de un bien del Patrimonio Cultural Valenciano?",
                    "type": "boolean",
                },
                {
                    "key": "gasto_restauracion_propio",
                    "label": "Cuanto ha gastado en conservacion, reparacion o restauracion?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_lengua_valenciana",
                    "label": "Ha donado dinero para el fomento de la Lengua Valenciana?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_cultural_cientifica",
                    "label": "Ha donado para fines culturales, cientificos o deportivos en la CV?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_cultural",
                    "label": "Cuanto ha donado o cual es el valor de la cesion?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "tiene_certificado_donacion",
                    "label": "Dispone de certificacion de la entidad receptora del donativo?",
                    "type": "boolean",
                }
            ]
        ),
            ...
            [
                {
                    ...
                    "label": "Tiene dos o mas descendientes que generen minimo por descendientes?",
                    "type": "boolean",
                },
                {
                    "key": "num_descendientes",
                    "label": "Cuantos descendientes tiene?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "hipoteca_vivienda_habitual",
                    "label": "Tiene hipoteca para vivienda habitual?",
                    "type": "boolean",
                },
                {
                    "key": "intereses_2025",
                    "label": "Cuanto ha pagado de intereses hipotecarios en 2025?",
                    "type": "number",
                },
                {
                    "key": "intereses_2024",
                    "label": "Cuanto pago de intereses hipotecarios en 2024?",
                    "type": "number",
                },
            ]
        ),
            ...
            [
                {
                    ...
                    "label": "Tiene hijos en Educacion Primaria, ESO o educacion especial?",
                    "type": "boolean",
                },
                {
                    "key": "num_hijos_escolarizados",
                    "label": "Cuantos hijos escolarizados tiene?",
                    "type": "number",
                },
                {
                    "key": "situacion_desempleo",
                    "label": "Ha estado en situacion de desempleo en 2025?",
                    "type": "boolean",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "obras_conservacion_vivienda",
                    "label": "Ha realizado obras de conservacion, mejora o accesibilidad en su vivienda habitual?",
                    "type": "boolean",
                },
                {
                    "key": "importe_obras",
                    "label": "Cuanto ha pagado por las obras?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "obras_2014_2015_pendientes",
                    "label": "Tiene cantidades pendientes de deduccion por obras de vivienda realizadas en 2014-2015?",
                    "type": "boolean",
                },
                {
                    "key": "importe_pendiente",
                    "label": "Cuanto le queda pendiente de deducir?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "abono_cultural",
                    "label": "Ha adquirido abonos culturales del programa de Abonos Culturales Valencianos?",
                    "type": "boolean",
                },
                {
                    "key": "importe_abono_cultural",
                    "label": "Cuanto ha pagado por los abonos culturales?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "vehiculo_electrico",
                    "label": "Ha adquirido un vehiculo nuevo electrico o hibrido enchufable en 2025?",
                    "type": "boolean",
                },
                {
                    "key": "importe_vehiculo",
                    "label": "Cual es el precio del vehiculo?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "inversion_startup",
                    "label": "Ha invertido en acciones o participaciones de empresas nuevas o de reciente creacion en la CV?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "municipio_despoblamiento",
                    "label": "Reside habitualmente en un municipio en riesgo de despoblamiento de la CV?",
                    "type": "boolean",
                },
                {
                    "key": "num_descendientes",
                    "label": "Cuantos descendientes tiene con derecho a minimo por descendientes?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "tratamiento_fertilidad",
                    "label": "Ha pagado por tratamientos de fertilidad en clinicas autorizadas de la CV?",
                    "type": "boolean",
                },
                {
                    "key": "importe_fertilidad",
                    "label": "Cuanto ha pagado en tratamientos de fertilidad?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "gastos_salud",
                    "label": "Ha tenido gastos de salud dental, mental, optica o por enfermedades cronicas/raras?",
                    "type": "boolean",
                },
                {
                    "key": "importe_gastos_salud",
                    "label": "Cuanto ha pagado en total en gastos de salud deducibles?",
                    "type": "number",
                },
                {
                    "key": "tipo_gasto_salud",
                    "label": "Que tipo de gasto? (dental, mental, optica, enfermedad cronica/rara)",
                    "type": "text",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "gastos_deporte",
                    "label": "Ha pagado cuotas de gimnasio, federaciones deportivas u otras actividades saludables?",
                    "type": "boolean",
                },
                {
                    "key": "importe_gastos_deporte",
                    "label": "Cuanto ha pagado en total?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "ayuda_covid_erte",
                    "label": "Ha recibido ayudas de la Generalitat por ERTE o COVID-19 (DL 3/2020)?",
                    "type": "boolean",
                },
                {
                    "key": "importe_ayuda_covid",
                    "label": "Cual es el importe de las ayudas recibidas?",
                    "type": "number",
                },
            ]
        ),
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_investigacion_covid",
                    "label": "Ha donado para investigacion sobre COVID-19 en la CV?",
                    "type": "boolean",
                },
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "donacion_gastos_covid",
                    "label": "Ha donado para financiar gastos de la crisis sanitaria COVID-19 en la CV?",
                    "type": "boolean",
                },
                {
                    "key": "importe_donacion_gastos_covid",
                    "label": "Cuanto ha donado?",
                    "type": "number",
                },
            ]
    ...
    # =========================================================================
    {
        ...
        "questions": json.dumps(
            [
                {
                    "key": "afectado_dana_2024",
                    "label": "Ha sido afectado por las inundaciones de la DANA de octubre de 2024?",
                    "type": "boolean",
                },
                {
                    "key": "municipio_zona_catastrofica",
                    "label": "Reside en un municipio declarado zona catastrofica?",
                    "type": "boolean",
                },
                {
                    "key": "tipo_dano_dana",
                    "label": "Que tipo de danos ha sufrido? (vivienda, vehiculo, enseres, actividad economica)",
                    "type": "text",
                },
                {
                    "key": "importe_danos_no_cubiertos",
                    "label": "Cual es el importe de los danos no cubiertos por seguros?",
                    "type": "number",
                },
            ]
        ),
...
async def seed_valencia(dry_run: bool = False):
    ...
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Seeding {len(VALENCIA_2025)} Valencia deductions for IRPF {TAX_YEAR}"
    )
    print("=" * 70)
        ...
        for col_name in ("ccaa", "territory"):
            try:
                ...
                if hasattr(result, "rows_affected") and result.rows_affected:
                    print(
                        f"  Deleted {result.rows_affected} existing Valencia deductions (column: {col_name})"
                    )
                else:
    ...
    print("=" * 70)
    print(
        f"{'[DRY RUN] ' if dry_run else ''}Total: {inserted}/{len(VALENCIA_2025)} deductions {'would be ' if dry_run else ''}inserted"
    )
    print()
